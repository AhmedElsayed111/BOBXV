...
xname =  (Redis:get(Fast.."Name:Bot") or "اباظة") 
...
{text = '- ѕᴏᴜʀᴄᴇ ᴀʟᴘʜᴀ .',url="t.me/SORALPHA"}, 
}
}
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*← معتز معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id, "• حوالة صادرة من بنك معتز\n\n← المرسل : "..news.."\n← الحساب رقم : `"..cccc.."`\n← نوع البطاقة : "..uuuu.."\n← المستلم : "..newss.."\n← الحساب رقم : `"..text.."`\n← نوع البطاقة : "..fsvhh.."\n← خصمت 10% رسوم تحويل\n← المبلغ : "..convert_mony.." جنيه 💵","md",true)
bot.sendText(fsvhhh,0, "• حوالة واردة من بنك معتز\n\n← المرسل : "..news.."\n← الحساب رقم : `"..cccc.."`\n← نوع البطاقة : "..uuuu.."\n← المبلغ : "..convert_mony.." جنيه 💵","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
else
bot.sendText(msg.chat_id,msg.id, "← مافيه حساب بنكي كذا","md",true)
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@SORALPHA")
sleep(1)
