...
devsource = Redis:get(Fast..'devsource') or "xUV9c"
devsource2 = Redis:get(Fast..'devsource') or "B100Q"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5956755822,656329268,1918968211}
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5956755822) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5956755822) then
...
if tonumber(senderr) == 5956755822 then
msg.Name_Controller = 'مـلـك الـتـلـجـرام 𓋖'
msg.The_Controller = 1
elseif tonumber(senderr) == 656329268 then
...
elseif tonumber(msg.sender_id.user_id) == tonumber(5956755822)  then 
Redis:set(Fast.."AddSudosNew"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"≭ ارسل معرف المطور الاساسي مع @........","md",true)
else
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5956755822) then
...
if text == 'جوكر' or text == 'محمد' or text == 'جوجو'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'JOKER', url = 't.me/xUV9c'}, 
},
}
}
return send(msg_chat_id,msg_id,"[JOKER](tg://user?id=5956755822)","md",true, false, false, true, reply_markup)
end

if text == 'البوب' or text == 'بوب' or text == 'احمد'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '𝙳𝙴𝚅', url = 't.me/UU_0B'}, 
},
}
}
return send(msg_chat_id,msg_id,"[JOKER](tg://user?id=1918968211)","md",true, false, false, true, reply_markup)
end

if text == 'باسل' or text == 'اباظه'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'ABAZA', url = 't.me/B100Q'}, 
},
}
}
return send(msg_chat_id,msg_id,"[𝙴𝙻𝙱𝙾𝙱](tg://user?id=656329268)","md",true, false, false, true, reply_markup)
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5956755822) then
local txx = "\n"
...
data = {
{
{text = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ', url = 'https://t.me/JJXXH/699'},
},
{
