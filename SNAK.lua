...
Status = 'مبرمج السورس'
elseif tonumber(UserId) ==  2123332060  then
Status = 'مبرمج السورس'
...
if text == 'مبرمج السورس ' or text == 'زوز' or text == 'معتز' then  
...
keyboardd.inline_keyboard = {
{
{text = '< 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝘽𝙍𝙊  >', url = "https://t.me/XB0BB"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'مبرمج السورس ' or text == 'معتز' or text == 'زوز' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
data = {
{
{text = 'موافق', data = Message_Reply.sender.user_id..'/zog1'},{text = 'مش موافق', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,baniusername,"md",false, false, false, false, reply_markup)
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الاغبياء مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الاغبياء ").Reply,"md",true)  
end
end
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الحمير مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الحمير ").Reply,"md",true)  
end
end
if TextMsg == 'سمب' then
if ChannelJoin(msg) == false then
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الحكاكين مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه الي قائمه الحكاكين ").Reply,"md",true)  
end
end
if TextMsg == 'مزه' then
if ChannelJoin(msg) == false then
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعها مزه مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعها مزه الجامده بنت الجامده ").Reply,"md",true)  
end
end
if TextMsg == 'زواج' then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(SNAK..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✘︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم زواجه مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم زواجكم بنجاح لو مبيعرفش انا سداد ").Reply,"md",true)  
end
end
if TextMsg == 'خول' then
if ChannelJoin(msg) == false then
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه خول مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه خول واصبح ضمن قائمه الخولات  ").Reply,"md",true)  
end
end
if TextMsg == 'عره' then
if ChannelJoin(msg) == false then
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعها عره مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعها عره واصبحت ضمن قائمه العرر  ").Reply,"md",true)  
end
end
if TextMsg == 'كلب' then
if ChannelJoin(msg) == false then
...
if Redis:sismember(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه كلب مسبقآ ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم رفعه كلب واصبح ضمن قائمه الكلاب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الخولات مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الخولات  ").Reply,"md",true)  
end
end
if TextMsg == "حمار" then
if ChannelJoin(msg) == false then
...
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الحمير مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الحمير ").Reply,"md",true)  
end
end
if TextMsg == "كلب" then
if ChannelJoin(msg) == false then
...
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الكلاب مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الكلاب ").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الاغبياء مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من قائمه الاغبياء ").Reply,"md",true)  
end
end
if TextMsg == "مزه" then
if ChannelJoin(msg) == false then
...
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيلها من قائمه المزز مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيلها قائمه المزز   ").Reply,"md",true)  
end
end
if TextMsg == "سميب" then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(SNAK..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✘︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(SNAK.."SNAK:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيلها من قائمه السمبين مسبقآ ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيلها قائمه السمبين ").Reply,"md",true)  
end
end
...
local RinkBot = msg.Name_Controller
photo = "https://t.me/UU_SNAKVX/1546"
local Name = '*𝙒𝙀𝙇𝘾𝙊𝙈𝙀 * ['..RinkBot..'](tg://user?id='..user_info.id..')\n*◉ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝘽𝙍𝙊 . *\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '◉ 𝘿𝙀𝙑', url = "https://t.me/UU_0B"},{text = '◉ 𝘿𝙀𝙑', url = "https://t.me/XB0BB"}
},
{
{text = '-  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .', url = "https://t.me/UU_SNAK"}
},
...
{
{text = 'المبرمج معتز ',type = 'text'},{text = 'المبرمج بوب',type = 'text'},
},
{
...
if text == 'المبرمج معتز ' or text == 'معتز' or text == 'المبرمج' or text == 'زوز' then  
local UserId_Info = LuaTele.searchPublicChat("XB0BB")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
keyboardd.inline_keyboard = {
{
{text = '< Developers SNAK  >', url = "https://t.me/XB0BB"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج بوب' or text == 'بوب' or text == 'احمد' or text == 'البوب' then  
local UserId_Info = LuaTele.searchPublicChat("UU_0B")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
