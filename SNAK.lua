...
ControllerAll = false
local ListSudos ={ Sudo_Id,1918968211,1918968211}  
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• هذا الامر يخص *'..Controller_Num(6)..'فقط',"md",true)  
end
...
if text == "جوزني" or text == "جوزيني" then
...
return LuaTele.sendText(msg_chat_id,msg_id,"اخترتلك وتكه "..mem_tag.." 💕","md",true)
end
...
elseif msg.sender.user_id == tonumber(1918968211) then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SNAKb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
u , res = https.request('https://SNAK-source.xyz/SNAKTeAM/Calculateage.php?age='..Textage)
...
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
KlamSNAK = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","سناك","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بوب","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSNAK[math.random(#KlamSNAK)]
Redis:set(SNAK.."Game:Monotonous"..msg.chat_id,name)
name = string.gsub(name,"سحور","س ر و ح")
name = string.gsub(name,"بوب","ا ج ف ا")
...
local bank_users = Redis:smembers(SNAK.."zrfffidtf")
...
local mony = Redis:get(SNAK.."zrffdcf"..v) or 0
...
if num <= 20 then
fne = Redis:get(SNAK..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(SNAK.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(SNAK.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(SNAK.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(SNAK.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(SNAK..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(SNAK..':toob:Name:'..zwga_id)
fnte = Redis:get(SNAK..':toob:Name:'..v[2])
...
if Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(SNAK..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(SNAK..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(SNAK..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(SNAK..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(SNAK.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(SNAK.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(SNAK.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(SNAK.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(SNAK..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(SNAK..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(SNAK..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." بتكوين ","md")
end
if Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(SNAK..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(SNAK..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(SNAK..':toob:Name:'..zoog2)
...
if text == "خلع" then
if not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(SNAK.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(SNAK.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(SNAK.."mznom"..msg_chat_id..zwga_id)
Redis:srem(SNAK.."almtzog"..msg_chat_id,zwga_id)
Redis:del(SNAK.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(SNAK.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(SNAK..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(SNAK..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(SNAK..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." بتكوين","md")
end
if text == "طلاق"  then
if not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(SNAK.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(SNAK.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "الاهلي" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "فيزا"
flossst = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(SNAK.."nonna"..msg.sender.user_id,news)
Redis:set(SNAK.."noolb"..msg.sender.user_id,creditcc)
Redis:set(SNAK.."nnonb"..msg.sender.user_id,text)
Redis:set(SNAK.."nnonbn"..msg.sender.user_id,gg)
Redis:set(SNAK.."nonallname"..creditcc,news)
Redis:set(SNAK.."nonallbalc"..creditcc,balas)
Redis:set(SNAK.."nonallcc"..creditcc,creditcc)
Redis:set(SNAK.."nonallban"..creditcc,text)
Redis:set(SNAK.."nonallid"..creditcc,banid)
Redis:sadd(SNAK.."noooybgy",msg.sender.user_id)
Redis:del(SNAK.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(SNAK.."nonna"..msg.sender.user_id,news)
Redis:set(SNAK.."noolb"..msg.sender.user_id,creditvi)
Redis:set(SNAK.."nnonb"..msg.sender.user_id,text)
Redis:set(SNAK.."nnonbn"..msg.sender.user_id,gg)
Redis:set(SNAK.."nonallname"..creditvi,news)
Redis:set(SNAK.."nonallbalc"..creditvi,balas)
Redis:set(SNAK.."nonallcc"..creditvi,creditvi)
Redis:set(SNAK.."nonallban"..creditvi,text)
Redis:set(SNAK.."nonallid"..creditvi,banid)
Redis:sadd(SNAK.."noooybgy",msg.sender.user_id)
Redis:del(SNAK.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(SNAK.."nonna"..msg.sender.user_id,news)
Redis:set(SNAK.."noolb"..msg.sender.user_id,creditex)
Redis:set(SNAK.."nnonb"..msg.sender.user_id,text)
Redis:set(SNAK.."nnonbn"..msg.sender.user_id,gg)
Redis:set(SNAK.."nonallname"..creditex,news)
Redis:set(SNAK.."nonallbalc"..creditex,balas)
Redis:set(SNAK.."nonallcc"..creditex,creditex)
Redis:set(SNAK.."nonallban"..creditex,text)
Redis:set(SNAK.."nonallid"..creditex,banid)
Redis:sadd(SNAK.."noooybgy",msg.sender.user_id)
Redis:del(SNAK.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
Redis:srem(SNAK.."noooybgy", msg.sender.user_id)
Redis:del(SNAK.."noolb"..msg.sender.user_id)
Redis:del(SNAK.."zrffdcf"..msg.sender.user_id)
Redis:srem(SNAK.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(SNAK.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(SNAK.."nool:flotysb"..v)
Redis:del(SNAK.."zrffdcf"..v)
Redis:del(SNAK.."innoo"..v)
Redis:del(SNAK.."nnooooo"..v)
Redis:del(SNAK.."nnoooo"..v)
Redis:del(SNAK.."nnooo"..v)
Redis:del(SNAK.."nnoo"..v)
Redis:del(SNAK.."polic"..v)
Redis:del(SNAK.."ashmvm"..v)
Redis:del(SNAK.."hrame"..v)
Redis:del(SNAK.."test:mmtlkat6"..v)
Redis:del(SNAK.."zahbmm2"..v)
end
Redis:del(SNAK.."ttpppi")
...
ballanceed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(SNAK.."noolb"..msg.sender.user_id)
gg = Redis:get(SNAK.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(SNAK.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(SNAK.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
...
if text == 'مضاربه' then
if Redis:get(SNAK.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(SNAK.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(SNAK.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(SNAK.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(SNAK.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(SNAK.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
Redis:setex(SNAK.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(SNAK.."nool:flotysb"..msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id, "تم تصفير فلوسك","md",true)
end

if text == 'حظ' then
if Redis:get(SNAK.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(SNAK.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id, "• مبروك فزت بالحظ \n• فلوسك قبل ↢ ( "..ballancee.." بتكوين 💸 )\n• الربح ↢ ( "..ballanceek.." بتكوين 💸 )\n• فلوسك الحين ↢ ( "..ff.." بتكوين 💸 )\n-","md",true)
elseif haddd == 5 or haddd == 6 then
Redis:decrby(SNAK.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(SNAK.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if tonumber(coniss) < 100 then
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح به هو 100 بتكوين \n-","md",true)
end
ballancee = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set(SNAK.."transn"..msg.sender.user_id,coniss)
Redis:setex(SNAK.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(SNAK.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(SNAK.."noolb"..msg.sender.user_id)
gg = Redis:get(SNAK.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(SNAK.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(SNAK.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(SNAK.."transn" .. msg.sender.user_id)
...
if Redis:get(SNAK.."nonallcc"..text) then
local UserNamey = Redis:get(SNAK.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(SNAK.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(SNAK.."nnonb"..fsvhhh)
nouu = Redis:get(SNAK.."nnonbn"..fsvhhh)
...
Redis:incrby(SNAK.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(SNAK.."nool:flotysb"..msg.sender.user_id ,UserNamey)
...
if Redis:sismember(SNAK.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(SNAK.."noolb"..yemsg.sender.user_id)
gg = Redis:get(SNAK.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(SNAK.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(SNAK.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(SNAK.."nool:flotysb"..yemsg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "•* الاسم ↢ *"..news.."\n*• الحساب ↢ *`"..cccc.."`\n*• بنك ↢ ( *"..gg.."* )\n• نوع ↢ ( *"..uuuu.."* )\n• الرصيد ↢ ( *"..ballancee.."* بتكوين 💸 )\n• الزرف ( *"..pppp.."* بتكوين 💸 )\n-*","md",true)
else
...
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
if Redis:get(SNAK.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(SNAK.."xxxr" .. msg.sender.user_id) then
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000 بتكوين 💸","md",true)
end
local jjjo = math.random(1,2000);
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 💸","md",true)
Redis:setex(SNAK.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(SNAK.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(SNAK.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." بتكوين 💸","md",true)
else
...
if Redis:get(SNAK.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(SNAK.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(SNAK.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(SNAK.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
Redis:setex(SNAK.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(SNAK.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(SNAK.."zrfffidtf",msg.sender.user_id)
Redis:setex(SNAK.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
if Redis:get(SNAK.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
K = 'محظوظ 2x' 
F = '15000'
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
local teex = 
Redis:setex(SNAK.."innoo" .. msg.sender.user_id,600, true)
return LuaTele.sendText(msg.chat_id, msg.id,"اشعار ايداع "..neews.."\nالمبلغ : "..F.." بتكوين 💸\nوظيفتك : "..K.."\nنوع العملية : اضافة راتب\nرصيدك الحين : "..ballancee.." بتكوين 💸","md",true) 
end 
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
...
local bank_users = Redis:smembers(SNAK.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(SNAK.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(SNAK..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(SNAK.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(SNAK.."zrfffidtf")
top_mony = "توب اكثر 20 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if text == "هجوم" then
LuaTele.sendText(msg.chat_id,msg.id,"استخدم الامر كذا\nبالرد !! هجوم 10000")
end

if text and text:match("^هجوم (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
local Remsg = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Remsg.sender.user_id)
local tkt = text:match("^هجوم (.*)$")
local bed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
if tonumber(ballanceed) < 10000000  then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتكدر تهجم عليه فلوسه اقل من 10000000  بتكوين 💸","md",true)
end
local allanceed = Redis:get(SNAK.."nool:flotysb"..msg.sender.user_id) or 0
if tonumber(allanceed) > 100000000  then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتكدر تهجم عليه فلوسك اكثر من 10000000  بتكوين 💸","md",true)
end
if tonumber(allanceed) < 100000000  then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتكدر تهجم عليه فلوسك اقل من 10000000  بتكوين 💸","md",true)
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
LuaTele.sendText(msg.chat_id,msg.id,"\nيا غبي ذا بوتتتت","md",true)  
return false
...
if Remsg.sender.user_id == msg.sender.user_id then
LuaTele.sendText(msg.chat_id,msg.id,"\nيا غبي تبي تهجم على نفسك ؟!","md",true)  
return false
end
if Redis:get(SNAK.."policc" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."policc" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• ي ظالم توك هاجم \n• تعال بعد "..rr.." دقيقة") 
end 
if Redis:get(SNAK.."hramee" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."hramee" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• هاجمين عليه قبلك \n• يمديك تهجم بعد "..rr.." دقيقة") 
end 
if Redis:sismember(SNAK.."noooybgy",Remsg.sender.user_id) then
...
local ballanceed = Redis:get(SNAK.."nool:flotysb"..Remsg.sender.user_id) or 0
local af = math.floor(tkt - ballanceed)
local hrame = math.floor(tkt * 1)
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(SNAK.."nool:flotysb"..Remsg.sender.user_id , af)
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
Redis:setex(SNAK.."hramee" .. Remsg.sender.user_id,2000, true)
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id,hrame)
Redis:sadd(SNAK.."zrfffidtf",msg.sender.user_id)
Redis:setex(SNAK.."policc" .. msg.sender.user_id,2000, true)
LuaTele.sendText(msg.chat_id,msg.id, "• مبروك فزت بالمعركة! واخذت منه  "..hrame.." بتكوين 💸\nفلوس العدو هسه "..af,"md",true)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local NameGroup = Get_Chat.title
local id = tostring(msg.chat_id)
gt = string.upper(id:gsub('-100',''))
...
if Redis:sismember(SNAK.."noooybgy",msg.sender.user_id) then
if Redis:get(SNAK.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(SNAK.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(SNAK.."xxxr" .. msg.sender.user_id) then
Redis:incrby(SNAK.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
...
Redis:sadd(SNAK.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 💸","md",true)
Redis:setex(SNAK.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
ballancee = Redis:get(SNAK.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(SNAK.."ttpppi")
top_mony = "توب اغنى 20 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
