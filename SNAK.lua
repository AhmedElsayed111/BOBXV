...
UU_0B = Redis:sismember(SNAK.."UU_0B:Groups",UserId) 
...
elseif DevelopersQ then
Status = Redis:get(SNAK.."DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
...
return{
JabwaAll = Redis:sismember(SNAK.."Jabwa:Groups",UserId) ,
ktmall = Redis:sismember(SNAK.."ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(SNAK.."Jabwa:Group"..ChatId,UserId) ,
...
if data.sender.chat_id ~= Redis:get(SNAK.."chadmin"..msg_chat_id) then
...
msg.Name_Controller = 'المطور شارون'
msg.The_Controller = 1
...
elseif Redis:sismember(SNAK.."UU_0B:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'مساعد'
...
local Num_Msg_SNAK = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_SNAK = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
if Redis:get(SNAK.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(SNAK.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(SNAK.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(SNAK.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(SNAK.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(SNAK.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
{
{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url='https://t.me/UU_SNAK'},
},
}
}
...
if Redis:get(SNAK.."Game:Jabwa"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Jabwa"..msg.chat_id) then
Redis:del(SNAK.."Game:Jabwa"..msg.chat_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SNAK.."Gamection"..msg.chat_id) then
if text == Redis:get(SNAK.."Gamection"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Gamection"..msg.chat_id)
...
Redis:del(SNAK.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)
...
Redis:incrby(SNAK.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(SNAK.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(SNAK.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)
Redis:del(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if text == 'رفع نسخه سناك' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص{ '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'• تم استرجاع المجموعات من نسخه سناك')
else
...
download('https://raw.githubusercontent.com/AhmedElsayed111/1998/master/SNAK.lua','SNAK.lua')
...
Redis:set(SNAK.."Sen:Jabwa:Bot",true) 
...
Redis:set(SNAK.."Left:Jabwa:Bot",true) 
...
local StatusMember = LuaTele.getChatMember(Jabwaa.id,SNAK).status.luatele
...
local Jabwa = LuaTele.getUser(SNAK)
for Name_User in string.gmatch(Jabwa.first_name, "[^%s]+" ) do
Jabwa.first_name = Name_User
break
end 
NamesBot = (Redis:get(SNAK.."Name:Bot") or "سناك")
Groups = (Redis:scard(SNAK..'ChekBotAdd') or 0)
Users = (Redis:scard(SNAK..'Num:User:Pv') or 0)
if photo.total_count > 0 then
...
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(SNAK..'Num:Add:Bot'),"md",true)  
end
...
if not Redis:sismember(SNAK.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*• تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(SNAK.."DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(SNAK.."UU_0B:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم تنزيله انتيمي مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."UU_0B:Groups")
Redis:del(SNAK.."UU_0B:Groups", Jabwaa.id)
Redis:del(SNAK.."id:UU_0B:Groups", Jabwaa.id)
...
if not Redis:sismember(SNAK.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."UU_0B:Groups",Message_Reply.sender.user_id) then
...
Redis:del(SNAK.."UU_0B:Groups")
Redis:del(SNAK.."UU_0B:Groups", Message_Reply.sender.user_id)
Redis:del(SNAK.."id:UU_0B:Groups", Message_Reply.sender.user_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "كلب" then
if not Redis:sismember(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(SNAK.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "قلبي" then
if not Redis:sismember(SNAK.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").SNAK,"md",true)  
end
end
if TextMsg == "بقره" then
if not Redis:sismember(SNAK.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "ارمله" then
if not Redis:sismember(SNAK.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "حمار" then
if not Redis:sismember(SNAK.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "خول" then
if not Redis:sismember(SNAK.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "مزه" then
if not Redis:sismember(SNAK.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(SNAK.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "ابني" then
if not Redis:sismember(SNAK.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "بنتي" then
if not Redis:sismember(SNAK.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "خاين" then
if not Redis:sismember(SNAK.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").SNAK,"md",true)  
else
Redis:srem(SNAK.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").SNAK,"md",true)  
end
end
end
...
if not Redis:sismember(SNAK.."UU_0B:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله انتيمي مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."UU_0B:Groups")
Redis:del(SNAK.."UU_0B:Groups", UserId)
Redis:del(SNAK.."id:UU_0B:Groups", UserId)
...
if Redis:sismember(SNAK.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(SNAK.."UU_0B:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."UU_0B:Groups")
Redis:sadd(SNAK.."UU_0B:Groups", UserId)
Redis:set(SNAK.."id:UU_0B:Groups", UserId)
...
if Redis:sismember(SNAK.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."UU_0B:Groups",Message_Reply.sender.user_id) then
...
Redis:del(SNAK.."UU_0B:Groups")
Redis:sadd(SNAK.."UU_0B:Groups", Message_Reply.sender.user_id)
Redis:set(SNAK.."id:UU_0B:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(SNAK.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "قلبي" then
...
if Redis:sismember(SNAK.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").SNAK,"md",true)  
end
end
if TextMsg == "بقره" then
...
if Redis:sismember(SNAK.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "ارمله" then
...
if Redis:sismember(SNAK.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "حمار" then
...
if Redis:sismember(SNAK.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "خول" then
...
if Redis:sismember(SNAK.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "مزه" then
...
if Redis:sismember(SNAK.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "وتكه" then
...
if Redis:sismember(SNAK.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "ابني" then
...
if Redis:sismember(SNAK.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "بنتي" then
...
if Redis:sismember(SNAK.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").SNAK,"md",true)  
end
end
if TextMsg == "خاين" then
...
if Redis:sismember(SNAK.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").SNAK,"md",true)  
else
Redis:sadd(SNAK.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه فلاتي خاين في الجروب ").SNAK,"md",true)  
end
end
end
...
if Redis:sismember(SNAK.."UU_0B:Groups",UserId) then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = "http://t.me/UU_SNAK"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(SNAK.."Monkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Myheart:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."acow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."widow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."let:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."donkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Beautiful:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."tick:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."myson:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."daughter:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."betray:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Jabwa:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Jabwa:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(SNAK.."Jabwa:Jeka"..msg_chat_id,true) 
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(SNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(SNAK..'AddRd:Sudo:Text'..text..msg.chat_id)
Redis:del(SNAK..'AddRd:Sudo:Text1'..text..msg.chat_id)
Redis:del(SNAK..'AddRd:Sudo:Text2'..text..msg.chat_id)
Redis:del(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id)
...
for k,v in pairs(list) do  
Redis:del(SNAK.."AddRd:Sudo:Text"..v..msg.chat_id) 
Redis:del(SNAK.."AddRd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(SNAK.."AddRd:Sudo:Text2"..v..msg.chat_id) 
...
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."AddRd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."AddRd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."AddRd:Sudo:Text2"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(SNAK.."AddRd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(SNAK.."AddRd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(SNAK.."AddRd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(SNAK.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(SNAK.."SNAK11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."SetOn"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(SNAK..'Add:Rd:Sudo:Text'..text)
Redis:del(SNAK..'Add:Rd:Sudo:Text1'..text)
Redis:del(SNAK..'Add:Rd:Sudo:Text2'..text)
Redis:del(SNAK.."SetOn"..msg.sender.user_id..":"..msg.chat_id)
...
Redis:del(SNAK.."Add:Rd:Sudo:Text1"..v) 
Redis:del(SNAK.."Add:Rd:Sudo:Text2"..v)   
...
Redis:set(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(SNAK.."SetOn"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(SNAK.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(SNAK.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(SNAK.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(SNAK.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(SNAK.."Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(SNAK.."Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(SNAK.."Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(SNAK.."Almayu"..msg.chat_id, msg.id)
if Redis:get(SNAK.."Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(SNAK.."Almayu"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(SNAK.."Almayu"..msg.chat_id)
...
Redis:del(SNAK.."Almayu"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(SNAK.."Almayu"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(SNAK.."Almayu"..msg.chat_id)  
...
if TextMsg == 'ردود السورس' then
Redis:del(SNAK.."Jabwa:Jeka"..msg_chat_id) 
...
if not msg.Originators and not Redis:get(SNAK.."Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(SNAK.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'Jabwaned',0)
...
if not Redis:sismember(SNAK.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(SNAK.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(SNAK.."Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local bain = LuaTele.getUser(msg.sender.user_id)
...
if Redis:sismember(SNAK.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
if Jabwa.first_name then
...
if not Redis:sismember(SNAK.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع استخدام الامر على المطور شارون *","md",true)  
end
if UserId == "5077394172" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع استخدام الامر على المطور بلال *","md",true)  
end
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @UU_SNAK"..Creator.."\n"
else
...
if text == 'مساعد' or text == 'انتيمي' then   
local id = Redis:get(SNAK.."id:UU_0B:Groups")
...
local abnj = " \n*•مساعد * "..Jabwayt.result.first_name.." \n"
keyJabwayt = {} 
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(SNAK.."chadmin"..msg_chat_id),"md",true)  
end
...
Redis:set(SNAK..'close'..lock..msg_chat_id,"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(SNAK..'Open'..lock..msg_chat_id)    
end
...
if Redis:get(SNAK.."Status:Jabwa"..msg.chat_id)  then
...
data = {
{
{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = 't.me/UU_SNAK'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد جهاتك يبشا ← '..(Redis:get(SNAK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:del(SNAK.."Jabwa:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(SNAK.."MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(SNAK.."MosTafa:Ahmed"..msg_chat_id) 
...
Redis:setex(SNAK.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(SNAK.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(SNAK.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(SNAK.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(SNAK.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
if text and Redis:get(SNAK..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(SNAK..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(SNAK..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
JabwaAll = '• محظور عام'
Redis:srem(SNAK.."Jabwa:Groups",Message_Reply.sender.user_id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).JabwaGroup == true then
JabwaGroup = '• محظور'
Redis:srem(SNAK.."Jabwa:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
JabwaAll = '• محظور عام'
Redis:srem(SNAK.."Jabwa:Groups",UserId_Info.id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).JabwaGroup == true then
JabwaGroup = '• محظور'
Redis:srem(SNAK.."Jabwa:Group"..msg_chat_id,UserId_Info.id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
...
local Name = 'المطور شارون للتواصل معاه بالاسفل ✅'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بلال' or text == 'احمد اااالمصري' or text == 'مطور السورس' then
...
return LuaTele.sendText(msg_chat_id,msg_id,'• اليك قسم الالعاب من سورس سناك ',"md",false, false, false, false, reply_markup)
end
---زخرفة ----
...
Redis:set(SNAK.."brgi"..msg.sender.user_id,"sendbr") 
end
...
if text == (Redis:get(SNAK.."Name:Bot") or 'سناك').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(SNAK.."Left:Jabwa:Bot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• امر المغادره معطل من قبل الاساسي *',"md",true)  
end
local Mostafa = (Redis:get(SNAK.."Name:Bot") or "سناك")
local Jabwa = LuaTele.getUser(SNAK)
local bain = LuaTele.getUser(msg.sender.user_id)
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(SNAK..'Channel:Join')}, },}}
...
if Redis:get(SNAK.."tast"..msg.sender.user_id) == "botttt" then
...
Redis:del(SNAK.."tast"..msg.sender.user_id) 
end
if text == "صراحه" or text == "صرحه" then
Redis:set(SNAK.."tast"..msg.sender.user_id,"botttt") 
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
...
Redis:set(SNAK.."Game:Jabwa"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
Redis:del(SNAK.."SetAks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(SNAK.."Gamection"..msg.chat_id,name)
...
if not msg.ControllerBot then
if Redis:get(SNAK.."TwaslBot") and not Redis:sismember(SNAK.."Jabwa:In:Tuasl",msg.sender.user_id) then
...
if text == 'حظر' then
Redis:sadd(SNAK..'Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(SNAK.."ChekBot",'-100'..data.supergroup.id)
...
Redis:del(SNAK.."Redis:Id:Group"..ChatId..""..IdUser) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(SNAK.."Set:array"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(SNAK.."Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
{
{text = 'العاب الاحترافيه •', data = IdUser..'/degm'}, 
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Jabwa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Jabwa"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Jabwa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Jabwa"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SNAK..'close'..lock..UserId[2],"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SNAK..'Open'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Jabwa:Group"..ChatId) 
