...
data = {
{
{text = '◉ ᴍɪʟᴀɴ ѕᴏᴜʀᴄᴇ .', url = 't.me/UU_SNAK'}, 
},
{
{text = '◉ 𝘽𝙊𝙏 𝙎𝙉𝘼𝙆  .', url = 't.me/DD5TBOT'}, 
},
{
{text = '◉ 𝘿𝙀𝙑  .', url = 't.me/UU_0P'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == "بوت" then
local NamesBot = (Redis:get(SNAK.."SNAK:Name:Bot") or "ميلآن")
local BotName = {
"اسمي"..NamesBot,
...
local CmdStart = '*\n•أهلآ بك في بوت '..(Redis:get(SNAK.."SNAK:Name:Bot") or "ميلآن")..
...
{
{text = '• قناة السورس.', url = 't.me/UU_SNAK'},{text = '•شراء بوت.', url = 't.me/DD5TBOT'}, 
},
}
}
