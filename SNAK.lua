...
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/uu/main/SNAK.lua?token=yEgPVU2dC9bLikjgJXncL6Wwz3BDNQ3oN5wO')
...
local Fun = {'بضان اووي','يخي سبحان الله محدش بيطيقه','قمر اووي', 'بتناك','بتاع نسوان وخول','اموت عليه','محبوب وانا ايضا احبه','مش سالك','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
if not DevHmD:get(SNAK..'HmD:Nsba:HmD'..msg.chat_id_) then
if text and (text == "نسبه الجمال" or text == "نسبة الجمال" or text == "× نسبة الجمال ×") and ChCheck(msg) then
DevHmD:set(SNAK..'JNsba:HmD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_HmD(msg.chat_id_, msg.id_, 1, '•قم بأرسال اسمك لتقييم جمالك بـ% :', 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "× نسبة الجمال ×" and DevHmD:get(SNAK..'JNsba:HmD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_HmD(msg.chat_id_, msg.id_, 1, '•تم الغاء امر نسبة الجمال ', 1, 'md')
DevHmD:del(SNAK..'JNsba:HmD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..sendubmj..'' ,url="https://t.me/UU_SNAK"}},
...
if not Redis:get(TheEVAN.."knele"..msg.chat_id) then
Abs = math.random(6,641); 
local Text ='*•ستـوريات آنمـي قصيـرة ➧ 🖤🧧*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '-  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .',url="t.me/UU_SNAK"}}} 
local msg_id = msg.id/2097152/0.5 
...
{
{text = '- لتنصيب بوتك .', url = 't.me/UU_0B'},
},
{
{text = '➕ اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
if text == 'المساعد' or text == 'مساعد' then   
local id = Redis:get(FIRE.."id:HELPBEVQ:Groups")
