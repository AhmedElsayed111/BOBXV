...
if text == "غنيلي" then
if not Redis:get(Thespeed.."speed:Status:distraction1"..msg_chat_id) then
...
if text == "متحركه" then
if not Redis:get(Thespeed.."speed:Status:distraction2"..msg_chat_id) then
...
if text == "شعر" then
if not Redis:get(Thespeed.."speed:Status:distraction3"..msg_chat_id) then
...
if text == "ميمز" then
if not Redis:get(Thespeed.."speed:Status:distraction9"..msg_chat_id) then
