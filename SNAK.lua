...
local TheSNAK = io.open("TheSNAK", 'w')
TheSNAK:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
...
screen -S ]]..Redis:get(SshId.."Info:Redis:Token:User")..[[ ./TheSNAK
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheSNAK;chmod +x Run;./Run') end
Information = dofile('./Information.lua')
Sudo_Id = Information.SudoId
UserSudo = Information.UserSudo
Token = Information.Token
UserBot = Information.UserBot
TheSNAK = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheSNAK)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheSNAK,token=Token}
function var(value)  
...
Status = 0
DevelopersAS = Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) 
DevelopersQ = Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) 
if UserId == 1918968211 then Status = true elseif UserId == 1918968211 then Status = true elseif UserId == Sudo_Id then Status = true elseif UserId == TheSNAK then Status = true elseif DevelopersAS then Status = true elseif DevelopersQ then Status = true else Status = false end return Status end
function Controller(ChatId,UserId) Status = 0
Developers = Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId) 
DevelopersAS = Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) 
DevelopersQ = Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..ChatId,UserId) 
TheBas = Redis:sismember(TheSNAK.."SNAK:TheBas:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheSNAK.."SNAK:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheSNAK.."SNAK:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..ChatId,UserId)
Cleaner = Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1918968211 then Status = 'مبرمج السورس' elseif UserId == 1918968211 then Status = 'مبرمج السورس' elseif UserId == Sudo_Id then Status = 'المطور الاساسي' elseif UserId == TheSNAK then Status = 'البوت' elseif DevelopersAS then Status = 'المطور الاساسي' elseif DevelopersQ then Status = 'المطور الاساسي²' elseif Developers then Status = Redis:get(TheSNAK.."SNAK:Developer:Bot:Reply"..ChatId) or 'المطور' elseif TheBas then Status = Redis:get(TheSNAK.."SNAK:TheBas:Group:Reply"..ChatId) or 'المالك' elseif TheBasicsQ then Status = Redis:get(TheSNAK.."SNAK:PresidentQ:Group:Reply"..ChatId) or 'المالك' elseif TheBasics then Status = Redis:get(TheSNAK.."SNAK:President:Group:Reply"..ChatId) or 'المنشئ الاساسي' elseif Originators then Status = Redis:get(TheSNAK.."SNAK:Constructor:Group:Reply"..ChatId) or 'المنشئ' elseif Managers then Status = Redis:get(TheSNAK.."SNAK:Manager:Group:Reply"..ChatId) or 'المدير' elseif Addictive then Status = Redis:get(TheSNAK.."SNAK:Admin:Group:Reply"..ChatId) or 'الادمن' elseif StatusMember == "chatMemberStatusCreator" then Status = 'مالك المجموعة' elseif StatusMember == "chatMemberStatusAdministrator" then Status = 'ادمن المجموعة' elseif Distinguished then Status = Redis:get(TheSNAK.."SNAK:Vip:Group:Reply"..ChatId) or 'المميز' elseif Cleaner then Status = Redis:get(TheSNAK.."SNAK:Cle:Group:Reply"..ChatId) or 'المنظف' else Status = Redis:get(TheSNAK.."SNAK:Mempar:Group:Reply"..ChatId) or 'العضو' end return Status end 
...
if Redis:get(TheSNAK.."SNAK:lockpin"..ChatId) then lock_pin = "✓" else lock_pin = "✗" end
if Redis:get(TheSNAK.."SNAK:Lock:tagservr"..ChatId) then lock_tagservr = "✓" else lock_tagservr = "✗" end
if Redis:get(TheSNAK.."SNAK:Lock:text"..ChatId) then lock_text = "✓" else lock_text = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:AddMempar"..ChatId) == "kick" then lock_add = "✓" else lock_add = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Join"..ChatId) == "kick" then lock_join = "✓" else lock_join = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:edit"..ChatId) then lock_edit = "✓" else lock_edit = "✗ " end
if Redis:get(TheSNAK.."SNAK:Chek:Welcome"..ChatId) then welcome = "✓" else welcome = "✗ " end
if Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId, "Spam:User") == "kick" then flood = "بالطرد "     
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "keed" then flood = "بالتقيد "     
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "mute" then flood = "بالكتم "           
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "del" then flood = "✓" else flood = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "del" then lock_photo = "✓" 
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "ked" then lock_photo = "بالتقيد "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "ktm" then lock_photo = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "kick" then lock_photo = "بالطرد " else lock_photo = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "del" then lock_phon = "✓" 
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "ked" then lock_phon = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "ktm" then lock_phon = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "kick" then lock_phon = "بالطرد " else lock_phon = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "del" then lock_links = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "ked" then lock_links = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "ktm" then lock_links = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "kick" then lock_links = "بالطرد " else lock_links = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "del" then lock_cmds = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "ked" then lock_cmds = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "ktm" then lock_cmds = "بالكتم "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "kick" then lock_cmds = "بالطرد " else lock_cmds = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "del" then lock_user = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "ked" then lock_user = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "ktm" then lock_user = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "kick" then lock_user = "بالطرد " else lock_user = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "del" then lock_hash = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "ked" then lock_hash = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "ktm" then lock_hash = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "kick" then lock_hash = "بالطرد " else lock_hash = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "del" then lock_muse = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ked" then lock_muse = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ktm" then lock_muse = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "kick" then lock_muse = "بالطرد " else lock_muse = "✗ " end 
if Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "del" then lock_ved = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "ked" then lock_ved = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "ktm" then lock_ved = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "kick" then lock_ved = "بالطرد " else lock_ved = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "del" then lock_gif = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "ked" then lock_gif = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "ktm" then lock_gif = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "kick" then lock_gif = "بالطرد " else lock_gif = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "del" then lock_ste = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "ked" then lock_ste = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "ktm" then lock_ste = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "kick" then lock_ste = "بالطرد " else lock_ste = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "del" then lock_geam = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "ked" then lock_geam = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "ktm" then lock_geam = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "kick" then lock_geam = "بالطرد " else lock_geam = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "del" then lock_vico = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ked" then lock_vico = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ktm" then lock_vico = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "kick" then lock_vico = "بالطرد " else lock_vico = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "del" then lock_inlin = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "ked" then lock_inlin = "بالتقيد "
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "ktm" then lock_inlin = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "kick" then lock_inlin = "بالطرد " else lock_inlin = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "del" then lock_fwd = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "ked" then lock_fwd = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "ktm" then lock_fwd = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "kick" then lock_fwd = "بالطرد " else lock_fwd = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "del" then lock_file = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "ked" then lock_file = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "ktm" then lock_file = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "kick" then lock_file = "بالطرد " else lock_file = "✗ " end    
if Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "del" then lock_self = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "ked" then lock_self = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "ktm" then lock_self = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "kick" then lock_self = "بالطرد " else lock_self = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "del" then lock_bots = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "ked" then lock_bots = "بالتقيد "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "kick" then lock_bots = "بالطرد " else lock_bots = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "del" then lock_mark = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "ked" then lock_mark = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "ktm" then lock_mark = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "kick" then lock_mark = "بالطرد " else lock_mark = "✗ " end
if Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "del" then lock_spam = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "ked" then lock_spam = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "ktm" then lock_spam = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "kick" then lock_spam = "بالطرد " else lock_spam = "✗ " end        
...
return{ BanAll = Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) , ktmAll = Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) , BanGroup = Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..ChatId,UserId) , SilentGroup = Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..ChatId,UserId) } end
...
function GetInfoBot(msg) local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheSNAK).status
...
local Channel = Redis:get(TheSNAK..'SNAK:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheSNAK) then print('This is reply for Bot') return false end
...
if tonumber(msg.sender.user_id) == 1918968211 then msg.Name_Controller = 'مبرمج السورس' msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1918968211 then msg.Name_Controller = 'مبرمج السورس' msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then msg.The_Controller = 1 msg.Name_Controller = 'المطور الاساسي'
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",msg.sender.user_id) == true then msg.The_Controller = 100 msg.Name_Controller = 'المطور الاساسي'
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",msg.sender.user_id) == true then msg.The_Controller = 2 msg.Name_Controller = 'المطور الاساسي²'
elseif Redis:sismember(TheSNAK.."SNAK:Developers:Groups",msg.sender.user_id) == true then msg.The_Controller = 3 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Developer:Bot:Reply"..msg.chat_id) or 'المطور'
elseif Redis:sismember(TheSNAK.."SNAK:TheBas:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 99 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:TheBas:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 44 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 4 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 5 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 6 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 7 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 8 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Vip:Group:Reply"..msg.chat_id) or 'المميز'
elseif Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 88 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Cle:Group:Reply"..msg.chat_id) or 'المنظف'
elseif tonumber(msg.sender.user_id) == tonumber(TheSNAK) then msg.The_Controller = 9 else msg.The_Controller = 10 msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Mempar:Group:Reply"..msg.chat_id) or 'العضو' end  
...
if Redis:get(TheSNAK.."SNAK:Lock:Fshar"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع الفشار في المجموعة").Replylar,"md",true)
...
if Redis:get(TheSNAK.."SNAK:Lock:Taf"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع التكلم بالطائفيه هنا").Replylar,"md",true)
return false end end
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if Redis:get(TheSNAK.."SNAK:Lock:Kfr"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع الكفر في المجموعة").Replylar,"md",true)
return false end end
...
if Redis:get(TheSNAK.."SNAK:Lock:Farsi"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع التكلم باللغه الفارسيه").Replylar,"md",true)
return false end end
if Redis:get(TheSNAK.."SNAK:Lock:text"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheSNAK.."SNAK:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheSNAK.."SNAK:Welcome:Group"..msg_chat_id)
if Welcome then 
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheSNAK) then return false end
local floods = Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheSNAK.."SNAK:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheSNAK.."SNAK:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheSNAK.."SNAK:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Num:Spam")  end end 
if text and not msg.Distinguished then
local _nl, ctrl_ = string.gsub(text, "%c", "")  
local _nl, real_ = string.gsub(text, "%d", "")   
sens = 400  
if Redis:get(TheSNAK.."SNAK:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheSNAK.."SNAK:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) end end
if msg.forward_info and not msg.TheBasics then -- التوجيه
local Fwd_Group = Redis:get(TheSNAK.."SNAK:Lock:forward"..msg_chat_id)
if Fwd_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع توجيه الرسائل هنا").Replylar,"md",true)
...
local Keyboard_Group = Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheSNAK.."SNAK:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheSNAK.."SNAK:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheSNAK.."SNAK:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false end end
if msg.content.luatele == "messageChatAddMembers" then -- اضافه اشخاص
print('This is Add Membeers ')
Redis:incr(TheSNAK.."SNAK:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheSNAK.."SNAK:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheSNAK.."SNAK:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id)
if Videonote_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال الفيديوهات هنا").Replylar,"md",true)
...
local Document_Group = Redis:get(TheSNAK.."SNAK:Lock:Document"..msg_chat_id)
if Document_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال الملفات هنا").Replylar,"md",true)
...
local Audio_Group = Redis:get(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id)
if Audio_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال الاغاني هنا").Replylar,"md",true)
...
local Video_Grouo = Redis:get(TheSNAK.."SNAK:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheSNAK.."SNAK:Lock:vico"..msg_chat_id)
if Voice_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال البصمات هنا").Replylar,"md",true)
...
local Sticker_Group = Redis:get(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id)
if Sticker_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال الملصقات هنا").Replylar,"md",true)
...
local Inlen_Group = Redis:get(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id)
if Gif_group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال المتحركات هنا").Replylar,"md",true)
...
local Photo_Group = Redis:get(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id)
if Photo_Group == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : ممنوع ارسال الصور هنا").Replylar,"md",true)
...
if msg.content.photo and Redis:get(TheSNAK.."SNAK:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheSNAK.."SNAK:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheSNAK.."SNAK:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then Filters = 'صوره'
Redis:sadd(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then Filters = 'متحركه'
Redis:sadd(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then Filters = 'ملصق'
Redis:sadd(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'رسالة' end
Redis:set(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true) end end
if text and (Redis:get(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheSNAK.."SNAK:Filter:Group:"..Text_Filter..msg_chat_id,text)  end  
Redis:del(TheSNAK.."SNAK:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : تم اضافة رد التحذير","md",true)  end
if (Redis:get(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then Filters = 'الصوره'
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheSNAK.."SNAK:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then Filters = 'المتحركه'
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheSNAK.."SNAK:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then Filters = 'الملصق'
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheSNAK.."SNAK:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheSNAK.."SNAK:Filter:Group:"..text..msg_chat_id)  
Filters = 'الرسالة' end
Redis:del(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheSNAK.."SNAK:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheSNAK.."SNAK:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheSNAK.."SNAK:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheSNAK.."SNAK:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheSNAK.."SNAK:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false end
if text and Redis:get(TheSNAK.."SNAK:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheSNAK.."SNAK:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheSNAK.."SNAK:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheSNAK.."SNAK:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الامر الجديد","md",true)  end
if text and Redis:get(TheSNAK.."SNAK:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheSNAK.."SNAK:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheSNAK.."SNAK:Command:List:Group"..msg_chat_id,text)
Redis:del(TheSNAK.."SNAK:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ الامر باسم ↫ ‹ "..text..' ›',"md",true) end
if Redis:get(TheSNAK.."SNAK:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
...
Redis:set(TheSNAK.."SNAK:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheSNAK.."SNAK:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ الرابط بنجاح","md",true)        end end 
if Redis:get(TheSNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
Redis:del(TheSNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheSNAK.."SNAK:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ ترحيب المجموعة","md",true) end
if Redis:get(TheSNAK.."SNAK:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
Redis:set(TheSNAK.."SNAK:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheSNAK.."SNAK:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ قوانين المجموعة","md",true)  end  
if Redis:get(TheSNAK.."SNAK:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
LuaTele.setChatDescription(msg_chat_id,text) 
Redis:del(TheSNAK.."SNAK:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ وصف المجموعة","md",true)  end  
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheSNAK.."SNAK:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/closerD'},},}}
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then  
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Text"..test..msg_chat_id, text)  end  
if msg.content.audio then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  end
if msg.content.document then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  end
if msg.content.animation then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  end
if msg.content.video_note then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.video then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  end
...
print(idPhoto)
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  end
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ رد المدير الجديد","md",false ,false, false, false, reply_markup) end end
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd'},},}}
Redis:set(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheSNAK.."SNAK:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : الكلمة ↫ ‹ '..text..' › تم حذفها',"md",true)  
return false end end
if text and Redis:get(TheSNAK.."SNAK:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
if UserInfo.username then UserInfousername = '@'..UserInfo.username..'' else UserInfousername = 'لا يوجد' end
local NumMessageEdit = Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheSNAK.."SNAK:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if audio then LuaTele.sendAudio(msg_chat_id, msg.id, audio, '', "md")  end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheSNAK.."SNAK:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then Redis:del(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  end   
if msg.content.animation then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Text"..test, text)  end  
if msg.content.audio then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  end
if msg.content.document then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  end
if msg.content.video then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  end
if msg.content.video_note then Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.photo then
...
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Photo"..test, idPhoto) end
LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ رد للمطور \n‹ : ارسل ( "..test.." ) لرؤية الرد","md",true)  
return false end end
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheSNAK.."SNAK:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheSNAK.."SNAK:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي الرد سواء كان :
‹ ملف • ملصق • متحركه • صوره
...
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheSNAK..'SNAK:'..v..text) end
Redis:del(TheSNAK.."SNAK:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheSNAK.."SNAK:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المطور","md",true) end end
if Redis:get(TheSNAK.."SNAK:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  end 
local list = Redis:smembers(TheSNAK.."SNAK:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.video_note.video.remote.id) end
...
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,idPhoto) end
elseif msg.content.sticker then 
for k,v in pairs(list) do LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.sticker.sticker.remote.id) end
elseif msg.content.voice_note then 
for k,v in pairs(list) do LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.voice_note.voice.remote.id) end
elseif msg.content.video then 
for k,v in pairs(list) do LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.video.video.remote.id) end
elseif msg.content.animation then 
for k,v in pairs(list) do LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.animation.animation.remote.id) end
elseif msg.content.document then
for k,v in pairs(list) do LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.document.document.remote.id) end
elseif msg.content.audio then
for k,v in pairs(list) do LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.audio.audio.remote.id) end
elseif text then
for k,v in pairs(list) do LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,text) end end
LuaTele.sendText(msg_chat_id,msg_id,"‹ : تمت الاذاعه الى *- "..#list.." * مجموعة في البوت ","md",true)      
Redis:del(TheSNAK.."SNAK:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheSNAK.."SNAK:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه خاص","md",true)  end 
local list = Redis:smembers(TheSNAK..'SNAK:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
...
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheSNAK.."SNAK:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  end 
local list = Redis:smembers(TheSNAK.."SNAK:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
...
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheSNAK.."SNAK:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheSNAK.."SNAK:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheSNAK..'SNAK:GetOwner:OwnerTheSNAK'..msg_chat_id..':'..msg.sender.user_id) then
Redis:set(TheSNAK..'SNAK:Owner:OwnerTheSNAK'..msg_chat_id,text)
Redis:del(TheSNAK..'SNAK:GetOwner:OwnerTheSNAK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المنشئ') end
if text and Redis:get(TheSNAK..'SNAK:GetTexting:DevTheSNAK'..msg_chat_id..':'..msg.sender.user_id) then
Redis:set(TheSNAK..'SNAK:Texting:DevTheSNAK',text)
Redis:del(TheSNAK..'SNAK:GetTexting:DevTheSNAK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المطور') end
if Redis:get(TheSNAK.."SNAK:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheSNAK.."SNAK:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false end 
Redis:del(TheSNAK.."SNAK:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعين الايدي عام',"md",true)  end
if Redis:get(TheSNAK.."SNAK:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheSNAK.."SNAK:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false end 
Redis:del(TheSNAK.."SNAK:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعين الايدي الجديد',"md",true)  end
-- LaR
if Redis:get(TheSNAK.."SNAK:Change:CH:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Change:CH:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير اسم القناة","md",true)  end 
Redis:del(TheSNAK.."SNAK:Change:CH:Bot"..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:CH:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغير اسم القتاة الى ↫ ❨ "..text.." ❩","md",true) end 
--
if Redis:get(TheSNAK.."SNAK:Change:CHlink:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheSNAK.."SNAK:Change:CHlink:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير كليشة الاشتراك","md",true)  end 
Redis:del(TheSNAK.."SNAK:Change:CHlink:Bot"..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:CHlink:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغير الكليشة الى ↫ ⤈\n ❨ "..text.." ❩","md",true) end 
-- LaR
if Redis:get(TheSNAK.."SNAK:Change:Name:Bot"..msg.sender.user_id) then 
Redis:del(TheSNAK.."SNAK:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغير اسم البوت الى ↫ ‹ "..text.." ›","md",true) end 
if Redis:get(TheSNAK.."SNAK:Change:Start:Bot"..msg.sender.user_id) then  
Redis:del(TheSNAK.."SNAK:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheSNAK.."SNAK:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغيير كليشة الترحيب الى ↫ ⤈\n"..text,"md",true) end 
if Redis:get(TheSNAK.."SNAK:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Smile"..msg.chat_id) then
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSNAK.."SNAK:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true) end end 
if Redis:get(TheSNAK.."SNAK:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Monotonous"..msg.chat_id) then
Redis:del(TheSNAK.."SNAK:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true) end end 
if Redis:get(TheSNAK.."SNAK:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSNAK.."SNAK:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - حزوره","md",true) end end
if Redis:get(TheSNAK.."SNAK:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSNAK.."SNAK:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - معاني","md",true) end end
if Redis:get(TheSNAK.."SNAK:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSNAK.."SNAK:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - العكس","md",true) end end
if Redis:get(TheSNAK.."SNAK:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
...
local GETNUM = Redis:get(TheSNAK.."SNAK:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheSNAK.."SNAK:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheSNAK.."SNAK:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : مبروك فزت ويانه وخمنت الرقم الصحيح\n‹ : تم اضافة {5} من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheSNAK.."SNAK:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheSNAK.."SNAK:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheSNAK.."SNAK:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheSNAK.."SNAK:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheSNAK.."SNAK:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Difference"..msg.chat_id) then 
Redis:del(TheSNAK.."SNAK:Game:Difference"..msg.chat_id)
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - المختلف","md",true)  
else
Redis:del(TheSNAK.."SNAK:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد خسرت حضا اوفر في المره القادمه\n‹ : اللعب مره اخره وارسل - المختلف","md",true) end end
if Redis:get(TheSNAK.."SNAK:Game:Example"..msg.chat_id) then
if text == Redis:get(TheSNAK.."SNAK:Game:Example"..msg.chat_id) then 
Redis:del(TheSNAK.."SNAK:Game:Example"..msg.chat_id)
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local Get_Chat = LuaTele.getChat(Redis:get(TheSNAK..'SNAK:ChanneliD:Join'))
local NcH = (Redis:get(TheSNAK.."SNAK:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(TheSNAK.."SNAK:CHlink:Bot") or "‹ : عذراً لاتستطيع استخدام البوت !\n‹ : عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
...
if tonumber(TheSNAK) ~= tonumber(FilesJson.BotId) then return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه') end -- end botid
LuaTele.sendText(msg_chat_id,msg_id,'‹ : جاري استرجاع المشتركين والكروبات ...')
Y = 0
for k,v in pairs(FilesJson.UsersBot) do
Y = Y + 1
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',v)  end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheSNAK.."SNAK:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..GroupId,v) end end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..GroupId,v) end end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..GroupId,v) end end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..GroupId,v) end end
if ListGroup.Cleaner then
for k,v in pairs(ListGroup.Cleaner) do
Redis:sadd(TheSNAK.."SNAK:Cleaner:Group"..GroupId,v) end end 
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheSNAK.."SNAK:Distinguished:Group"..GroupId,v) end end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheSNAK) then 
...
Redis:sadd(TheSNAK.."SNAK:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..idg,idmsh) end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..idg,idmder)  end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..idg,idmod) end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..idg,idASAS) end;end
end
...
if (Redis:get(TheSNAK..'SNAK:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
Redis:del(TheSNAK..'SNAK:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheSNAK).status.luatele
...
Redis:set(TheSNAK..'SNAK:Channel:Join',ChannelUser) 
Redis:set(TheSNAK..'SNAK:ChanneliD:Join',UserId_Info.id) 
...
if not msg.DevelopersAS then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطور الاساسي واعلى فقط',"md",true)  end
Redis:set(TheSNAK..'SNAK:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل الي الان قناة الاشتراك ","md",true)  end
if text == 'تعطيل الاشتراك الاجباري' or text == '‹ تعطيل الاشتراك الاجباري ›' then
if not msg.DevelopersAS then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطور الاساسي واعلى فقط',"md",true)  end
Redis:del(TheSNAK..'SNAK:Channel:Join')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Change:CH:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Change:CHlink:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:CHlink:Bot") 
...
local tt =[[
‹ : [𝖲𝗈𝗎𝗋𝖼𝖾 SNAK](https://t.me/ivviv) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel .', url = "https://t.me/ivviv"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Exp Source .', url = "https://t.me/ivviv"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/ivviv&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
if text == "‹ اسم البوت ›" then
local NamesBot = (Redis:get(TheSNAK.."SNAK:Name:Bot") or "ليفانا")
local BotName = {
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:SendBcBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:SendBcBot",true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:LeftBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*‹ : تم تفعيل مغادرة البوت *").unLock,"md",true) end
if (Redis:get(TheSNAK.."SNAK:AddSudosNew"..msg_chat_id) == 'true') then
Redis:del(TheSNAK.."SNAK:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
...
Redis:set(TheSNAK.."SNAK:AddSudosNew"..msg_chat_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Groups = Redis:smembers(TheSNAK..'SNAK:ChekBotAdd')  
local UsersBot = Redis:smembers(TheSNAK..'SNAK:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheSNAK..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheSNAK.."SNAK:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheSNAK.."SNAK:Originators:Group"..v)
local Manager = Redis:smembers(TheSNAK.."SNAK:Managers:Group"..v)
local Admin = Redis:smembers(TheSNAK.."SNAK:Addictive:Group"..v)
local Cleaner = Redis:smembers(TheSNAK.."SNAK:Cleaner:Group"..v)
local Vips = Redis:smembers(TheSNAK.."SNAK:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheSNAK.."SNAK:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..ide) end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheSNAK.."SNAK:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') ) end end end end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK..'SNAK:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
LuaTele.sendText(msg_chat_id,msg_id,'*‹ : احصائيات البوت ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n‹ : عدد المجموعات ↫ '..(Redis:scard(TheSNAK..'SNAK:ChekBotAdd') or 0)..'\n‹ : عدد المشتركين ↫ '..(Redis:scard(TheSNAK..'SNAK:Num:User:Pv') or 0)..'*',"md",true)  end
...
if Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheSNAK..'SNAK:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(TheSNAK..'SNAK:Num:Add:Bot'),"md",true)  end
...
Redis:sadd(TheSNAK.."SNAK:TheBas:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1 end end
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رفع الادمنيه ›', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},{text = '‹ تفعيل الحمايه ›', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},},{{text = '‹ الاوامر ›', data = msg.sender.user_id..'/'.. 'helpall'},},{{text = '‹ غادر ›', data = msg.sender.user_id..'/Yesbot'},{text = '‹ تعطيل ›', data =msg.sender.user_id..'/disable'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
LaR = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')'
else
LaR = '['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')'
end
...
Redis:sadd(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id)
Redis:set(TheSNAK.."SNAK:Status:BanId"..msg_chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:SetId"..msg_chat_id,true) 
...
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if not Redis:get(TheSNAK.."SNAK:BotFree") then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : الوضع الخدمي تم تعطيله من قبل مطور البوت *","md",true)  end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheSNAK..'SNAK:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(TheSNAK..'SNAK:Num:Add:Bot'),"md",true)  end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id, '\n‹ : المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ غادر ›', data = msg.sender.user_id..'/Yesbott'},{text = '‹ تفعيل ›', data =msg.sender.user_id..'/activation'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
Redis:srem(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id)
...
Redis:srem(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,'*‹ : تم تعطيل المجموعة ↫ ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* ›*').unLock,'md',true, false, false, false, reply_markup) end end
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id) then
Redis:incr(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
if not Redis:get(TheSNAK.."SNAK:Status:Id"..msg_chat_id) then return false end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheSNAK.."SNAK:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheSNAK.."SNAK:Set:Id:Group"..msg_chat_id)
if Redis:get(TheSNAK.."SNAK:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local NumberGame = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
...
local TotalMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local NumberGame = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
...
local TotalMsg = Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..UserInfo.id) or 0
local TotalEdit = Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg_chat_id..UserInfo.id) or 0
local NumberGame = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..UserInfo.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if UserInfo.username then
LaR = '@'..UserInfo.username..''
else
LaR = 'لا يوجد'
end
return LuaTele.sendText(msg_chat_id,msg_id, '‹ : معرفه ↫ '..LaR..'\n‹ : ايديه ↫ ❨ `'..UserId..'` ❩\n‹ : رتبته ↫ '..RinkBot..'\n‹ : رسائله ↫ ❨ '..TotalMsg..' ❩\n‹ : سحكاته ↫ ❨ '..TotalEdit..' ❩\n‹ : تفاعله ↫ '..TotalMsgT..'\n‹ : نقاطه ↫ ❨ '..NumberGame..' ❩ ' ,"md",true) 
end
...
Redis:set(TheSNAK.."SNAK:Set:Id:Group"..msg.chat_id,Text_Rand)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheSNAK).status.luatele
...
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheSNAK).status
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*‹ : تم تنزيله مطور اساسي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*‹ : تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) 
...
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطورين واعلى فقط',"md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*‹ : تم تنزيله مطور اساسي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*‹ : تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور ").Reply,"md",true) end end
if UserId[1] == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطورين واعلى فقط',"md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه مطور ").Reply,"md",true) end end
if UserName[1] == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطورين واعلى فقط',"md",true)  end
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه منظف بالتأكيد").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId_Info.id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه مطور ").Reply,"md",true) end end
if TextMsg == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطورين واعلى فقط',"md",true)  end
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه منظف بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Developers:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه منظف بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if not msg.Managers then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمدراء واعلى فقط',"md",true)  end
Redis:set(TheSNAK.."SNAK:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheSNAK.."SNAK:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheSNAK.."SNAK:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheSNAK.."SNAK:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheSNAK.."SNAK:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheSNAK.."SNAK:Vip:Group:Reply"..msg.chat_id,Teext)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:DevelopersAS:Groups") 
local LaR = Redis:scard(TheSNAK.."SNAK:DevelopersAS:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسيين : '..LaR..' ›', data = msg.sender.user_id..'/DevelopersAS'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:DevelopersQ:Groups") 
local LaR = Redis:scard(TheSNAK.."SNAK:DevelopersQ:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الثانويين : '..LaR..' ›', data = msg.sender.user_id..'/DevelopersQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Developers:Groups") 
local LaR = Redis:scard(TheSNAK.."SNAK:Developers:Groups")  
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المطورين : '..LaR..' ›', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المالكين : '..LaR..' ›', data = msg.sender.user_id..'/TheBasicsQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسيين : '..LaR..' ›', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Originators:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:Originators:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المنشئين : '..LaR..' ›', data = msg.sender.user_id..'/Originators'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Managers:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:Managers:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المدراء : '..LaR..' ›', data = msg.sender.user_id..'/Managers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الادمنيه : '..LaR..' ›', data = msg.sender.user_id..'/Addictive'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المنظفين : '..LaR..' ›', data = msg.sender.user_id..'/Cleaner'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المميزين : '..LaR..' ›', data = msg.sender.user_id..'/DelDistinguished'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:BanAll:Groups") 
...
local Info_Memberss = Redis:smembers(TheSNAK.."SNAK:ktmAll:Groups") 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:BanAll:Groups") 
local LaR = Redis:scard(TheSNAK.."SNAK:BanAll:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المحظورين عام : '..LaR..' ›', data = msg.sender.user_id..'/BanAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:ktmAll:Groups") 
local LaR = Redis:scard(TheSNAK.."SNAK:ktmAll:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المكتومين عام : '..LaR..' ›', data = msg.sender.user_id..'/ktmAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المحظورين : '..LaR..' ›', data = msg.sender.user_id..'/BanGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id) 
local LaR = Redis:scard(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المكتومين : '..LaR..' ›', data = msg.sender.user_id..'/SilentGroupGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
-- LaR
...
Redis:set(TheSNAK.."SNAK:Status:distraction10"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction9"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction8"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction7"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction6"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction5"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction4"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction3"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction2"..msg_chat_id,true) 
Redis:set(TheSNAK.."SNAK:Status:distraction1"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:Id"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:IdPhoto"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:Reply"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:ReplySudo"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:BanId"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Status:SetId"..msg_chat_id,true) 
...
Redis:set(TheSNAK.."SNAK:Status:Games"..msg_chat_id,true) 
...
Redis:set(TheSNAK.."SNAK:Status:KickMe"..msg_chat_id,true) 
...
Redis:set(TheSNAK.."SNAK:Status:gamle"..msg_chat_id,true) 
...
Redis:set(TheSNAK.."SNAK:Status:remMe"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:BotFree",true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:TwaslBot",true) 
...
-- LaR
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd0'},},}}
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id, text)
return LuaTele.sendText(msg_chat_id,msg_id, '\n‹ : تم حفظ الكلمة \n‹ : الان ارسل الرد رقم ↫ ‹ 1 ›', "md", false, false, false, false, reply_markup) end end
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text3'..text..msg.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text4'..text..msg.chat_id)
Redis:del(TheSNAK.."SNAK1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id, text)
...
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheSNAK.."SNAK1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الان الكلمه لحذفها ", "md", false, false, false, false, reply_markup) end
if text then  
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text3"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(TheSNAK.."SNAK1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text4"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdLARR'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ ‹ 5 › من الردود للكلمة ↫ ‹ '..test..' ›', "md", false, false, false, false, reply_markup)
return false  
end  
end
if text then
local Text = Redis:get(TheSNAK.."SNAK1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheSNAK.."SNAK1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheSNAK.."SNAK1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
local Text3 = Redis:get(TheSNAK.."SNAK1:Add:Rd:Sudo:Text3"..text..msg.chat_id)   
local Text4 = Redis:get(TheSNAK.."SNAK1:Add:Rd:Sudo:Text4"..text..msg.chat_id)   
...
-- LaR
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd0bot'},},}}
LuaTele.sendText(msg_chat_id,msg_id, '\n‹ : تم حفظ الكلمة \n‹ : الان ارسل الرد رقم ↫ ‹ 1 ›', "md", false, false, false, false, reply_markup)
Redis:set(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheSNAK.."SNAK11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheSNAK.."SNAK11:List:Rd:Sudo", text)
return false end end
if text and text:match("^(.*)$") then
if Redis:get(TheSNAK.."SNAK11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المتعدده")
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text'..text)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheSNAK.."SNAK11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheSNAK.."SNAK11:List:Rd:Sudo", text)
return false end end
...
Redis:set(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheSNAK.."SNAK11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الان الكلمه لحذفها ", "md", false, false, false, false, reply_markup) end
if text then  
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text1"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheSNAK.."SNAK11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text2"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdLARRbot'},},}}
 LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ ‹ 3 › من الردود للكلمة ↫ ‹ '..test..' ›', "md", false, false, false, false, reply_markup)
return false  
end  
end
if text then
local Text = Redis:get(TheSNAK.."SNAK11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheSNAK.."SNAK11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheSNAK.."SNAK11:Add:Rd:Sudo:Text2"..text)   
...
Redis:set(TheSNAK..'SNAK:Num:Add:Bot'..msg_chat_id,text:match("عدد المسح (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد المسح الحالي ↫ ‹ *'..(Redis:get(TheSNAK..'SNAK:Num:Add:Bot'..msg_chat_id) or 150)..'* › ',"md",true)  end
-- 
...
Redis:sadd(TheSNAK.."SNAK:allM"..msg.chat_id, msg.id)
if Redis:get(TheSNAK.."SNAK:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheSNAK.."SNAK:allM"..msg.chat_id)  
if gmedia >= tonumber((Redis:get(TheSNAK..'SNAK:Num:Add:Bot'..msg_chat_id) or 150)) then
local liste = Redis:smembers(TheSNAK.."SNAK:allM"..msg.chat_id)
...
Redis:del(TheSNAK.."SNAK:allM"..msg.chat_id) end end
end
if text == ("امسح") and msg.Cleaner then  
local list = Redis:smembers(TheSNAK.."SNAK:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheSNAK.."SNAK:allM"..msg.chat_id)  
if gmria == 0 then
LuaTele.sendText(msg_chat_id,msg_id,"*‹ : عدد الميديا ↫ *‹* "..gmria.." *›","md")
else
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ امسح ›', data = msg.sender.user_id..'/MsHLaR'},},}}
...
Redis:del(TheSNAK.."SNAK:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheSNAK.."SNAK:Status:Del:Media"..msg.chat_id,true)
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if TextMsg == 'اوامر التسليه' then
Redis:del(TheSNAK.."SNAK:Status:distraction10"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction9"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction8"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction7"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction6"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction5"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction4"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction3"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction2"..msg_chat_id,true) 
Redis:del(TheSNAK.."SNAK:Status:distraction1"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Status:Id"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Status:IdPhoto"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Status:Reply"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Status:ReplySudo"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Status:BanId"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:BotFree") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:TwaslBot") 
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",UserId) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) 
...
local NcH = (Redis:get(TheSNAK.."SNAK:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(TheSNAK.."SNAK:CHlink:Bot") or "‹ : عذراً لاتستطيع استخدام البوت !\n‹ : عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا لا يوجد حساب بهذا المعرف ","md",true)  end
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
...
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",UserId) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:BanId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل ( الحظر • الطرد • التقييد ) من قبل المدراء","md",true) end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا يوجد حساب بهذا المعرف ","md",true)  end
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,UserId_Info.id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,UserId_Info.id).." › ","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) 
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if ban.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if ban and ban.type and ban.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذرا لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." › ","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanAll:Groups",UserId) 
...
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:ktmAll:Groups",UserId) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",UserId) 
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) 
Redis:srem(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1 end end
end
...
local OwnText = Redis:get(TheSNAK..'SNAK:Owner:OwnerTheSNAK'..msg_chat_id)
if not msg.ControllerBot then
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
LaR = '['..User_Info.first_name..'](t.me/'..User_Info.username..')'
else
LaR = '['..User_Info.first_name..'](tg://user?id='..msg.sender.user_id..')'
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Fshar"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Taf"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Kfr"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Farsi"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:text"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheSNAK.."SNAK:Lock:AddMempar"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheSNAK.."SNAK:Lock:Join"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheSNAK.."SNAK:Lock:Bot:kick"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheSNAK.."SNAK:Lock:Bot:kick"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheSNAK.."SNAK:Lock:tagservr"..msg_chat_id,true)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheSNAK.."SNAK:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheSNAK.."SNAK:Lock:edit"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheSNAK.."SNAK:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheSNAK..'SNAK:'..lock..msg_chat_id,"del")    
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:AddMempar"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Fshar"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Taf"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Kfr"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Farsi"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:text"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Join"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:Bot:kick"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:del(TheSNAK.."SNAK:Lock:tagservr"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:lockpin"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:edit"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheSNAK.."SNAK:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheSNAK..'SNAK:'..lock..msg_chat_id)    
end
...
if text == "غنيلي" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction1"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر غنيلي معطل","md",true) end 
Abs = math.random(4,2824); 
local Text ='‹ : تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Song'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "متحركه" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction2"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر متحركه معطل","md",true) end 
Abs = math.random(4,1075); 
local Text ='‹ : تم اختيار المتحركه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/animation'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "شعر" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction3"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر شعر معطل","md",true) end 
Abs = math.random(4,140); 
local Text ='‹ : تم اختيار الشعر لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/voice'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "ميمز" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction9"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر ميمز معطل","md",true) end 
Abs = math.random(4,1201); 
local Text ='‹ : تم اختيار الميمز لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Memz'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction8"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر ريمكس معطل","md",true) end 
Abs = math.random(4,612); 
local Text ='‹ : تم اختيار ريمكس لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Remix'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction4"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر فلم معطل","md",true) end 
Abs = math.random(4,125); 
local Text ='‹ : تم اختيار الفلم لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Movies'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction7"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر انمي معطل","md",true) end 
Abs = math.random(4,1002); 
local Text ='‹ : تم اختيار الانمي لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Anime'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction6"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر اغنيه معطل","md",true) end 
Abs = math.random(4,1167); 
local Text ='‹ : تم اختيار الاغنيه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Mp'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction5"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر صوره معطل","md",true) end 
Abs = math.random(4,1171); 
local Text ='‹ : تم اختيار الصوره لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Photos'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if text == "مسلسل" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction10"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذراً امر مسلسل معطل","md",true) end 
Abs = math.random(4,54); 
local Text ='‹ : تم اختيار المسلسل لك'
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Series'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}
}
}
local msg_id = msg.id/2097152/0.5
...
if not Redis:get(TheSNAK.."SNAK:Sasa:Jeka"..msg_chat_id) then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hdel(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Link"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Link"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Link"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Link"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Link"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:User:Name"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:hashtak"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Cmd"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Photo"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Video"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Video"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Video"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Video"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Video"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Animation"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:geam"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:geam"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:geam"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:geam"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:geam"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Audio"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:vico"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:vico"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:vico"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:vico"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:vico"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Keyboard"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Sticker"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:forward"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:forward"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:forward"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:forward"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:forward"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Document"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Document"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Document"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Document"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Document"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Unsupported"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Markdaun"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Contact"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Spam"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Spam"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Spam"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Spam"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Spam"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheSNAK.."SNAK:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not not Redis:get(TheSNAK.."SNAK:Status:Link"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل جلب الرابط من قبل الادمنيه","md",true) end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheSNAK.."SNAK:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text =Get_Chat.title, url = GetLink },},}}
...
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا استطيع جلب الرابط بسبب ليس لدي صلاحيه دعوه مستخدمين من خلال الرابط ","md",true) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = Get_Chat.title, url = LinkGroup.invite_link },},}}
return LuaTele.sendText(msg_chat_id, msg_id, '‹ : Link Group ↬ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n❨ '..LinkGroup.invite_link..' ❩', 'md', true, false, false, false, reply_markup) end end
-- LaR --
if text == 'غادر' then
if not msg.DevelopersAS then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للمطور الاساسي واعلى فقط',"md",true)  end
...
--
if text == 'نزلني' then
if not Redis:get(TheSNAK.."SNAK:Status:remMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*‹ : امر نزلني تم تعطيله من قبل المدراء *","md",true)  end
...
if not Redis:get(TheSNAK.."SNAK:Status:KickMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*‹ : امر اطردني تم تعطيله من قبل المدراء *","md",true)  end
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if GetInfoBot(msg).BanUser == false then return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  end
...
Redis:setex(TheSNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:get(TheSNAK.."SNAK:Status:Welcome"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الترحيب من قبل الادمنيه","md",true) end 
local Welcome = Redis:get(TheSNAK.."SNAK:Welcome:Group"..msg_chat_id)
if Welcome then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheSNAK.."SNAK:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم ازالة قوانين المجموعة","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheSNAK.."SNAK:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheSNAK.."SNAK:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if GetInfoBot(msg).Info == false then return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : البوت ليس لديه صلاحيه تغيير المعلومات* ',"md",true)  end
Redis:set(TheSNAK.."SNAK:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheSNAK.."SNAK:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheSNAK.."SNAK:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,v)  end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheSNAK.."SNAK:Filter:Group:"..v..msg_chat_id)   
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : ارسل الان ( ملصق ,متحركه ,صوره ,رساله ) *',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheSNAK.."SNAK:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheSNAK.."SNAK:Command:List:Group"..msg_chat_id) end
...
for k,v in pairs(list) do
Commands = Redis:get(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:get(TheSNAK.."SNAK:Status:Link"..msg.chat_id) then
Statuslink = '‹ ✓ ›' else Statuslink = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:Welcome"..msg.chat_id) then
StatusWelcome = '‹ ✓ ›' else StatusWelcome = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:Id"..msg.chat_id) then
StatusId = '‹ ✓ ›' else StatusId = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '‹ ✓ ›' else StatusIdPhoto = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:Reply"..msg.chat_id) then
StatusReply = '‹ ✓ ›' else StatusReply = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '‹ ✓ ›' else StatusReplySudo = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:BanId"..msg.chat_id)  then
StatusBanId = '‹ ✓ ›' else StatusBanId = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:SetId"..msg.chat_id) then
StatusSetId = '‹ ✓ ›' else StatusSetId = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:Games"..msg.chat_id) then
StatusGames = '‹ ✓ ›' else StatusGames = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:KickMe"..msg.chat_id) then
Statuskickme = '‹ ✓ ›' else Statuskickme = '‹ ✗ ›'
end
if Redis:get(TheSNAK.."SNAK:Status:AddMe"..msg.chat_id) then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) then
d = "المطورين الاساسيين • " else d = "" end
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) then
de = "المطورين الثانويين • " else de = "" end
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) then
dev = "المطورين • " else dev = "" end
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
mk = "المالكين • " else mk = "" end
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
crr = "المنشئين الاساسيين • " else crr = "" end
if Redis:sismember(TheSNAK..'SNAK:Originators:Group'..msg_chat_id, Message_Reply.sender.user_id) then
cr = "المنشئين • " else cr = "" end
if Redis:sismember(TheSNAK..'SNAK:Managers:Group'..msg_chat_id, Message_Reply.sender.user_id) then
own = "المدراء • " else own = "" end
if Redis:sismember(TheSNAK..'SNAK:Addictive:Group'..msg_chat_id, Message_Reply.sender.user_id) then
mod = "الادمنيه • " else mod = "" end
if Redis:sismember(TheSNAK..'SNAK:Cleaner:Group'..msg_chat_id, Message_Reply.sender.user_id) then
Cle = "المنظفين • " else Cle = "" end
if Redis:sismember(TheSNAK..'SNAK:Distinguished:Group'..msg_chat_id, Message_Reply.sender.user_id) then
vip = "المميزين • " else vip = ""
end
if The_ControllerAll(Message_Reply.sender.user_id) == true then
Rink = 1
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 4
elseif Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
elseif Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 10
elseif Redis:sismember(TheSNAK.."SNAK:TheBas:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 11
elseif Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(TheSNAK.."SNAK:Cleaner:Group",Message_Reply.sender.user_id)
...
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : لا يمكنك تنزيل مالك المجموعة*","md",true)  end
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) end
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) then
d = "المطورين الاساسيين • " else d = "" end
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) then
de = "المطورين الثانويين • " else de = "" end
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) then
dev = "المطورين • " else dev = "" end
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id, UserId_Info.id) then
mk = "المالكين • " else mk = "" end
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
crr = "المنشئين الاساسيين • " else crr = "" end
if Redis:sismember(TheSNAK..'SNAK:Originators:Group'..msg_chat_id, UserId_Info.id) then
cr = "المنشئين • " else cr = "" end
if Redis:sismember(TheSNAK..'SNAK:Managers:Group'..msg_chat_id, UserId_Info.id) then
own = "المدراء • " else own = "" end
if Redis:sismember(TheSNAK..'SNAK:Addictive:Group'..msg_chat_id, UserId_Info.id) then
mod = "الادمنيه • " else mod = "" end
if Redis:sismember(TheSNAK..'SNAK:Cleaner:Group'..msg_chat_id, UserId_Info.id) then
Cle = "المنظفين • " else Cle = "" end
if Redis:sismember(TheSNAK..'SNAK:Distinguished:Group'..msg_chat_id, UserId_Info.id) then
vip = "المميزين • " else vip = ""
end
if The_ControllerAll(UserId_Info.id) == true then
Rink = 1
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id)  then
Rink = 3
elseif Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id)  then
Rink = 4
elseif Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
elseif Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 9
elseif Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id, UserId_Info.id) then
Rink = 10
elseif Redis:sismember(TheSNAK.."SNAK:TheBas:Group"..msg_chat_id, UserId_Info.id) then
Rink = 11
elseif Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id, UserId_Info.id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(TheSNAK.."SNAK:Cleaner:Group",UserId_Info.id)
elseif msg.DevelopersQ then
if Rink == 3 or Rink < 3 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id)
...
if Rink == 8 or Rink < 8 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id, UserId_Info.id) end
return LuaTele.sendText(msg_chat_id,msg_id,"\n*‹ : تم تنزيله من ↫ ⤈\n ‹ "..d..""..de..""..dev..""..crr..""..cr..""..own..""..mod..""..vip..""..Cle..""..mk.." ›*","md",true)  end
...
if text == 'رسائلي' then
local lar = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح رسائلي : '..lar..' ›', data = msg.sender.user_id..'/MMsgDel'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد رسائلك هنا ↫ ‹ *'..lar..'* ›',"md",false ,false, false,false,reply_markup)  end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local LaR = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..LaR..' ›', data = msg.sender.user_id..'/MsgDell'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد التعديلات هنا ↫ ‹ *'..LaR..'* ›',"md",false, false, false,false, reply_markup)  end
if text == 'مسح جهاتي' then
Redis:del(TheSNAK..'SNAK:Num:Add:Memp'..msg.chat_id..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد جهاتك المضافه هنا ↫ ‹ *'..(Redis:get(TheSNAK.."SNAK:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'* ›',"md",true)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل الان النص
‹ : يمكنك اضافه :
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Set:Id:Groups")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل الان النص
‹ : يمكنك اضافه :
‹ : `#username` ↫ اسم المستخدم
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Set:Id:Group"..msg.chat_id)
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:DevelopersAS:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين اساسيين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:DevelopersAS:Groups") 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:DevelopersQ:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين ثانويين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Developers:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:Developers:Groups") 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مالكين في البوت ","md",true)  end
Redis:del(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد منشئين اساسيين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد منشئين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:Originators:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مدراء حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:Managers:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد ادمنيه حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مميزين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheSNAK.."SNAK:BanAll:Groups") 
Redis:del(TheSNAK.."SNAK:ktmAll:Groups") 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد محظورين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مكتومين حالياً , ","md",true)  end
Redis:del(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id)
local RR = Redis:scard(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ ردود المدير : '..RR..' ›', data = msg.sender.user_id..'/RRD'},},{{text = '‹ الردود المتعدده : '..R..' ›', data = msg.sender.user_id..'/Rdlar'},},}}
...
local R = Redis:scard(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id)
local RR = Redis:scard(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ ردود المدير : '..RR..' ›', data = msg.sender.user_id..'/RD'},},{{text = '‹ الردود المتعدده : '..R..' ›', data = msg.sender.user_id..'/RdLaR'},},}}
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RdLaR'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/Rdlar'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RD'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RRD'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "‹ : من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
-- Lar --
if text == "اضف رد" then
if not msg.Addictive then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للادمنية واعلى فقط',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closeRD'},},}}
Redis:set(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheSNAK.."SNAK:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheSNAK.."SNAK11:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RSoLaR'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RSolar'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "‹ : من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
--
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheSNAK.."SNAK:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RDs'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RRDs'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "‹ : من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
--
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/LARcloseSo'},},}}
Redis:set(TheSNAK.."SNAK:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheSNAK..'SNAK:GetOwner:OwnerTheSNAK'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheSNAK..'SNAK:Owner:OwnerTheSNAK'..msg_chat_id)
...
Redis:set(TheSNAK..'SNAK:GetTexting:DevTheSNAK'..msg_chat_id..':'..msg.sender.user_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK..'SNAK:Texting:DevTheSNAK')
...
local DevText = Redis:get(TheSNAK..'SNAK:Texting:DevTheSNAK')
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
if Redis:get(TheSNAK.."SNAK:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheSNAK.."SNAK:Status:kool"..msg.chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true)  end end
if text == "صورتي" then
if Redis:get(TheSNAK.."SNAK:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Delete Bot ›', url = "https://t.me/R3J3BOT"}},{{text = '‹ Telegram', url = "https://my.telegram.org/auth?to=delete"},{text = 'Instagram ›', url = "https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},{{text = '‹ Facebook', url = "https://www.facebook.com/help/deleteaccount"},{text = 'Snapchat ›', url = "https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = "https://t.me/ivviv"}}}
local msgg = msg_id/2097152/0.5
...
local RinkBot = msg.Name_Controller
photo = "https://t.me/UU_SNAKVX/1704"
...
{
{text = '- Boot Snak', url = "https://t.me/UU_TBOT"}
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسين ›', data = msg.sender.user_id..'/TheBasics'},},{{text = '‹ مسح المنشئين ›', data = msg.sender.user_id..'/Originators'},{text = '‹ مسح المدراء ›', data = msg.sender.user_id..'/Managers'},},{{text = '‹ مسح الادمنيه ›', data = msg.sender.user_id..'/Addictive'},{text = '‹ مسح المميزين ›', data = msg.sender.user_id..'/DelDistinguished'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local L = Redis:scard(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
local LL = Redis:scard(TheSNAK.."SNAK:Originators:Group"..msg_chat_id) 
local LLL = Redis:scard(TheSNAK.."SNAK:Managers:Group"..msg_chat_id)
local LLLL = Redis:scard(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id)  
local LLLLL = Redis:scard(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الاساسيين : '..L..' ›', data = msg.sender.user_id..'/TheBasicslar'},},{{text = '‹ المنشئين : '..LL..' ›', data = msg.sender.user_id..'/Originatorslar'},{text = '‹ المدراء : '..LLL..' ›', data = msg.sender.user_id..'/Managerslar'},},{{text = '‹ الادمنيه : '..LLLL..' ›', data = msg.sender.user_id..'/Addictivelar'},{text = '‹ المميزين : '..LLLLL..' ›', data = msg.sender.user_id..'/DelDistinguishedlar'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : هلا بك في قسم رتب المجموعة',"md",false, false, false, false, reply_markup)
--
...
local LaR = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local lar = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..LaR..' ›', data = msg.sender.user_id..'/MsgDell'},{text = '‹ مسح رسائلي : '..lar..' ›', data = msg.sender.user_id..'/MMsgDel'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help1'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help2'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
elseif text == 'م3' then
if not msg.Addictive then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للادمنية واعلى فقط',"md",true)  end
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help3'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
elseif text == 'م4' then
if not msg.Addictive then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للادمنية واعلى فقط',"md",true)  end
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help4'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
elseif text == 'م5' then
if not msg.Addictive then return LuaTele.sendText(msg_chat_id,msg_id,'\n‹ : هذا الامر للادمنية واعلى فقط',"md",true)  end
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help5'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ قائمة الاوامر ›', data = msg.sender.user_id..'/help6'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheSNAK.."SNAK:Name:Bot") or "ليفانا") then
local NamesBot = (Redis:get(TheSNAK.."SNAK:Name:Bot") or "ليفانا")
local NameBots = {
"عمر "..NamesBot.. " شتريد ؟",
...
x = x + 1
Redis:srem(TheSNAK..'SNAK:Num:User:Pv',v) end end
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheSNAK)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*‹ : البوت عضو في المجموعة سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheSNAK..'SNAK:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheSNAK..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i]) end
LuaTele.leaveChat(Get_Chat.id) end
else
x = x + 1
local keys = Redis:keys(TheSNAK..'*'..v)
for i = 1, #keys do
Redis:del(keys[i]) end
Redis:srem(TheSNAK..'SNAK:ChekBotAdd',v)
...
Redis:set(TheSNAK.."SNAK:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheSNAK.."SNAK:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheSNAK.."SNAK:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheSNAK.."SNAK:Status:Games"..msg.chat_id) then
Redis:del(TheSNAK.."SNAK:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheSNAK.."SNAK:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheSNAK.."SNAK:Status:Games"..msg.chat_id) then
Redis:del(TheSNAK.."SNAK:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheSNAK.."SNAK:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheSNAK.."SNAK:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : اهلا بك عزيزي في لعبة التخمين :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n".."‹ : ملاحظه لديك {3} محاولات فقط فكر قبل ارسال تخمينك \n\n".."‹ : سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ","md",true) end end
if text == "المختلف" then
if Redis:get(TheSNAK.."SNAK:Status:Games"..msg.chat_id) then
mktlf = {"😸","☠","🐼","🐇","🌑","🌚","⭐️","✨","⛈","🌥","⛄️","👨‍🔬","👨‍💻","👨‍🔧","👩‍🍳","🧚‍♀","🧜‍♂","🧝‍♂","🙍‍♂","🧖‍♂","👬","🕓","🕤","⌛️","📅",};
name = mktlf[math.random(#mktlf)]
Redis:set(TheSNAK.."SNAK:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheSNAK.."SNAK:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheSNAK.."SNAK:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
Redis:incrby(TheSNAK.."SNAK:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheSNAK.."SNAK:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','مسح رسائلي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'حذ','حذف رد')
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'#','مسح قائمه العام')
...
download('https://raw.githubusercontent.com/DevLivanaTeAm/SNAK/master/SNAK.lua','SNAK.lua')
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
if not msg.DevelopersAS then
if not Redis:get(TheSNAK.."SNAK:Start:Bot") then
local CmdStart = '‹ : مرحبا انا بوت اسمي ‹ '..(Redis:get(TheSNAK.."SNAK:Name:Bot") or "ليفانا")..' ›\n‹ : اختصاصي التسليه وحماية المجموعات\n‹ : من المخربين والتفليش والسبام والخ\n‹ : فقط قم برفعي ادمن في مجموعتك\n‹ : وارسل كلمة ↫ ‹ تفعيل ›'
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ المطور ›', url = "t.me/"..UserSudo..""},},{{text = '‹ قناة السورس ›', url = 't.me/ivviv'},{text = '‹ لتنصيب بوت ›', url = 't.me/Z7777DONE'},},{{text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheSNAK.."SNAK:Start:Bot"),"md",false, false, false, false, reply_markup) end
else
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ السورس ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ اسم البوت ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ الاذاعة ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ العام ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ المطورين ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ الاحصائيات ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ الاشتراك الاجباري ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local LaR = '‹ : اهلا بك في قسم ‹ التفعيل والتعطيل ›\n‹ : اضغط على الامر الذي تريد تنفيذه'
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheSNAK.."SNAK:Start:Bot"),"md",false, false, false, false, reply_markup) end end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheSNAK.."SNAK:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheSNAK.."SNAK:Start:Bot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheSNAK.."SNAK:List:Rd:Sudo")
text = "\n‹ : قائمة ردود المطور ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ??"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." - ‹ "..v.." › ↫ ‹"..db.."›\n"
end
...
local list = Redis:smembers(TheSNAK.."SNAK:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..v)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Text"..v)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Photo"..v)
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Video"..v)
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:File"..v)
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Audio"..v)
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:video_note"..v)
Redis:del(TheSNAK.."SNAK:List:Rd:Sudo") end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه عام من المجموعات  ").Reply,"md",true) end end
if not msg.DevelopersAS then
if Redis:get(TheSNAK.."SNAK:TwaslBot") and not Redis:sismember(TheSNAK.."SNAK:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheSNAK.."SNAK:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheSNAK.."SNAK:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheSNAK..'SNAK:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'‹ : تم حظره من تواصل البوت ').Reply,"md",true)  end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheSNAK..'SNAK:BaN:In:Tuasl',Info_User)  
...
local inget = Redis:get(TheSNAK..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(TheSNAK..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(TheSNAK..'hmsabots'..idnum..data.sender_user_id,username[1]) end end
end
if data and data.luatele and data.luatele == "updateSupergroup" then
local Get_Chat = LuaTele.getChat('-100'..data.supergroup.id)
if data.supergroup.status.luatele == "chatMemberStatusBanned" then
Redis:srem(TheSNAK.."SNAK:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheSNAK..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i]) end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
if idPhoto == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end
elseif text then
if text == Redis:get(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id) end end

elseif data and data.luatele and data.luatele == "updateNewMessage" then
if data.message.content.luatele == "messageChatDeleteMember" or data.message.content.luatele == "messageChatAddMembers" or data.message.content.luatele == "messagePinMessage" or data.message.content.luatele == "messageChatChangeTitle" or data.message.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheSNAK.."SNAK:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheSNAK then
print('This is Edit for Bot')
return false end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheSNAK..'SNAK:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheSNAK.."SNAK:Lock:edit"..data.chat_id) then
...
--
if Text and Text:match('(%d+)/MsHLaR') then
local UserId = Text:match('(%d+)/MsHLaR')
if tonumber(IdUser) == tonumber(UserId) then
local list = Redis:smembers(TheSNAK.."SNAK:allM"..data.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "‹ : تم حذف ‹ "..k.." › من الميديا"
LuaTele.deleteMessages(data.chat_id,{[1]= Message})
Redis:del(TheSNAK.."SNAK:allM"..data.chat_id) end end
if #list == 0 then
t = "‹ : لا توجد ميديا في المجموعة"
end
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction1"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر غنيلي معطل",true) end 
Abs = math.random(4,2824); 
local Text ='‹ : تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Song'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction2"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر متحركه معطل",true) end 
Abs = math.random(4,1075); 
local Text ='‹ : تم اختيار المتحركه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'animation'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction3"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر شعر معطل",true) end 
Abs = math.random(4,140); 
local Text ='‹ : تم اختيار الشعر لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'voice'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction4"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر ميمز معطل",true) end 
Abs = math.random(4,1201); 
local Text ='‹ : تم اختيار الميمز لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Memz'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction5"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر ريمكس معطل",true) end 
Abs = math.random(4,612); 
local Text ='‹ : تم اختيار الريمكس لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Remix'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction6"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر فلم معطل",true) end 
Abs = math.random(4,125); 
local Text ='‹ : تم اختيار الفلم لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Movies'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction7"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر انمي معطل",true) end 
Abs = math.random(4,1002); 
local Text ='‹ : تم اختيار الانمي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Anime'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction8"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر اغنيه معطل",true) end 
Abs = math.random(4,1167); 
local Text ='‹ : تم اختيار الاغنيه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Mp'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction9"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر صوره معطل",true) end 
Abs = math.random(4,1171); 
local Text ='‹ : تم اختيار الصوره لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Photos'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction10"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"‹ : عذراً امر مسلسل معطل",true) end 
Abs = math.random(4,54); 
local Text ='‹ : تم اختيار المسلسل لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Series'}},{{text='‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›',url="t.me/ivviv"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK..'SNAK:GetTexting:DevTheSNAK'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DelOwner') then
local UserId = Text:match('(%d+)/DelOwner')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK..'SNAK:GetOwner:OwnerTheSNAK'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerdControllerBot') then
local UserId = Text:match('(%d+)/closerdControllerBot')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0bot') then
local UserId = Text:match('(%d+)/closerd0bot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text'..test)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text1'..test)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text2'..test)
Redis:del(TheSNAK.."SNAK11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheSNAK.."SNAK11:List:Rd:Sudo", test)
...
--
if Text and Text:match('(%d+)/delrdLARRbot') then
local UserId = Text:match('(%d+)/delrdLARRbot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text'..test)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text1'..test)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK11:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
---- LaR
if Text and Text:match('(%d+)/closerdManagers') then
local UserId = Text:match('(%d+)/closerdManagers')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0') then
local UserId = Text:match('(%d+)/closerd0')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text1'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text2'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text3'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text4'..test..data.chat_id)
Redis:del(TheSNAK.."SNAK1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id, test)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء حفظ الرد',"md",true) end end
--
...
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء وحذف التخزين',"md",true) end end
--
if Text and Text:match('(%d+)/delrdLARR') then
local UserId = Text:match('(%d+)/delrdLARR')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text1'..test..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK1:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
-- LaR
if Text and Text:match('(%d+)/closeRules') then
local UserId = Text:match('(%d+)/closeRules')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Rules:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeDescription') then
local UserId = Text:match('(%d+)/closeDescription')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Description:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeWelcome') then
local UserId = Text:match('(%d+)/closeWelcome')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."Tshake:Welcome:Group" .. data.chat_id .. "" .. data.sender_user_id)  
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeLINK') then
local UserId = Text:match('(%d+)/closeLINK')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Link"..data.chat_id..""..data.sender_user_id) 
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
-- LaR
...
local UserId = Text:match('(%d+)/closerd')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK:Text:Manager"..data.sender_user_id..":"..data.chat_id.."")
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..test..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..test..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..test..data.chat_id)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Text"..test..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..test..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Video"..test..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:File"..test..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..test..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..test..data.chat_id)
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheSNAK.."SNAK:List:Manager"..data.chat_id.."", test)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء حفظ الرد',"md",true) end end
--
if Text and Text:match('(%d+)/closerD') then
local UserId = Text:match('(%d+)/closerD')
...
Rink = 1
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",IdUser)  then
Rink = 2
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",IdUser)  then
Rink = 3
elseif Redis:sismember(TheSNAK.."SNAK:Developers:Groups",IdUser)  then
Rink = 4
elseif Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..data.chat_id, IdUser) then
Rink = 5
elseif Redis:sismember(TheSNAK.."SNAK:Originators:Group"..data.chat_id, IdUser) then
Rink = 6
elseif Redis:sismember(TheSNAK.."SNAK:Managers:Group"..data.chat_id, IdUser) then
Rink = 7
elseif Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..data.chat_id, IdUser) then
Rink = 8
elseif Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..data.chat_id, IdUser) then
Rink = 9
elseif Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..data.chat_id, IdUser) then
Rink = 10
else
Rink = 11
end
...
Redis:srem(TheSNAK.."SNAK:DevelopersAS:Groups", IdUser)
Redis:srem(TheSNAK.."SNAK:DevelopersQ:Groups", IdUser)
Redis:srem(TheSNAK.."SNAK:Developers:Groups", IdUser)
Redis:srem(TheSNAK.."SNAK:TheBasics:Group"..data.chat_id, IdUser)
Redis:srem(TheSNAK.."SNAK:Originators:Group"..data.chat_id, IdUser)
Redis:srem(TheSNAK.."SNAK:Managers:Group"..data.chat_id, IdUser)
Redis:srem(TheSNAK.."SNAK:Addictive:Group"..data.chat_id, IdUser)
Redis:srem(TheSNAK.."SNAK:Distinguished:Group"..data.chat_id, IdUser)
Redis:srem(TheSNAK.."SNAK:Cleaner:Group"..data.chat_id, IdUser)
...
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(data.chat_id,TheSNAK)
...
Redis:srem(TheSNAK..'SNAK:ChekBotAdd',data.chat_id)
local keys = Redis:keys(TheSNAK..'*'..data.chat_id)
for i = 1, #keys do
Redis:del(keys[i]) end
...
if #list == 0 then
LaR = "‹ : عذراً لا توجد ردود للمطور"
end
return LuaTele.editMessageText(ChatId,Msg_id,LaR,"md",true) end end
--
if Text and Text:match('(%d+)/RDs') then
local UserId = Text:match('(%d+)/RDs')
if tonumber(IdUser) == tonumber(UserId) then
local Rds = Redis:scard(TheSNAK.."SNAK:List:Rd:Sudo")
local list = Redis:smembers(TheSNAK.."SNAK:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..v)   
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheSNAK.."SNAK11:List:Rd:Sudo")
...
local list = Redis:smembers(TheSNAK.."SNAK11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheSNAK.."SNAK11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheSNAK.."SNAK11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheSNAK.."SNAK11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheSNAK.."SNAK11:List:Rd:Sudo") end
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم حذف ‹ '..R..' › من ردود المتعدده العامه',"md",true) end end
--
if Text and Text:match('(%d+)/LARcloseSo') then
local UserId = Text:match('(%d+)/LARcloseSo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DevIDClose') then
local UserId = Text:match('(%d+)/DevIDClose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:AddSudosNew"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
-- Lar --
if Text and Text:match('(%d+)/Rdlar') then
local UserId = Text:match('(%d+)/Rdlar')
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id)
...
local UserId = Text:match('(%d+)/RdLaR')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id)
local list = Redis:smembers(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id)
for k,v in pairs(list) do  
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text"..v..data.chat_id) 
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text1"..v..data.chat_id) 
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text2"..v..data.chat_id) 
Redis:del(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id) end
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheSNAK.."SNAK:List:Manager"..data.chat_id.."")
LaR = "‹ : قائمة ردود المدير ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..data.chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..data.chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..data.chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..data.chat_id) then
db = "رساله ✉"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..data.chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..data.chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..data.chat_id) then
db = "ملف 📁"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..data.chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..data.chat_id) then
db = "فيديو نوت 🎥"
end
LaR = LaR..""..k.." - ‹ `"..v.."` › ↫ ‹"..db.."›\n"
end
if #list == 0 then
LaR = "‹ : عذرا لا يوجد ردود للمدير في المجموعة"
end
LuaTele.editMessageText(ChatId,Msg_id,LaR, 'md', true) end end
--
if Text and Text:match('(%d+)/RD') then
local UserId = Text:match('(%d+)/RD')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheSNAK.."SNAK:List:Manager"..data.chat_id.."")
local list = Redis:smembers(TheSNAK.."SNAK:List:Manager"..data.chat_id.."")
for k,v in pairs(list) do
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..data.chat_id)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..data.chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..data.chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..data.chat_id)
Redis:del(TheSNAK.."SNAK:List:Manager"..data.chat_id) end
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم حذف ‹ '..R..' › من ردود المدير',"md",true)  end 
end
--
if Text and Text:match('(%d+)/LARclose') then
local UserId = Text:match('(%d+)/LARclose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'‹ : تم الغاء الامر',"md",true) end end
-- Lar --
...
if Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n‹ : المجموعة تم تفعيلها بالتأكيد' ,"md",true)  
else
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheSNAK.."SNAK:TheBas:Group"..data.chat_id,v.member_id.user_id) 
x = x + 1 end end
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رفع الادمنيه ›', data = UserId..'/'.. 'addAdmins@'..data.chat_id},{text = '‹ تفعيل الحمايه ›', data = UserId..'/'.. 'LockAllGroup@'..data.chat_id},},{{text = '‹ الاوامر ›', data = UserId..'/'.. 'helpall'},},{{text = '‹ غادر ›', data = UserId..'/'..'Yesbot'},{text = '‹ تعطيل ›', data = UserId..'/'..'disable'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
Redis:sadd(TheSNAK.."SNAK:ChekBotAdd",data.chat_id)
Redis:set(TheSNAK.."SNAK:Status:Id"..data.chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:Reply"..data.chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:ReplySudo"..data.chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:BanId"..data.chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:SetId"..data.chat_id,true) 
...
local Get_Chat = LuaTele.getChat(data.chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(data.chat_id)
if not Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n‹ : المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ غادر ›', data = UserId..'/'..'Yesbot'},{text = '‹ تفعيل ›', data = UserId..'/'..'activation'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
Redis:srem(TheSNAK.."SNAK:ChekBotAdd",data.chat_id)
...
Redis:incrby(TheSNAK.."SNAK:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
‹ : اوامر ادمنية ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
‹ : رفع • تنزيل ↫ مميز
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
‹ : اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
‹ : رفع • تنزيل ↫ ادمن
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
local TextHelp = [[*
‹ : قائمه الالعاب البوت ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheSNAK.."SNAK:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheSNAK.."SNAK:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele ~= "chatMemberStatusCreator" then
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1 end end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheSNAK.."SNAK:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheSNAK..'SNAK:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
local MMsgDel = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..data.chat_id..':'..UserId) or 0)
Redis:del(TheSNAK..'SNAK:Num:Message:User'..data.chat_id..':'..UserId) 
...
if tonumber(IdUser) == tonumber(UserId) then
local MsgDell = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..data.chat_id..UserId) or 0)
Redis:del(TheSNAK..'SNAK:Num:Message:Edit'..data.chat_id..UserId)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'Rgg'},},}}
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:TheBasics:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar'},},}}
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Originators:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar'},},}}
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Managers:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar'},},}}
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Addictive:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar'},},}}
local Info_Members = Redis:smembers(TheSNAK.."SNAK:Distinguished:Group"..data.chat_id) 
...
local L = Redis:scard(TheSNAK.."SNAK:TheBasics:Group"..data.chat_id) 
local LL = Redis:scard(TheSNAK.."SNAK:Originators:Group"..data.chat_id) 
local LLL = Redis:scard(TheSNAK.."SNAK:Managers:Group"..data.chat_id)
local LLLL = Redis:scard(TheSNAK.."SNAK:Addictive:Group"..data.chat_id)  
local LLLLL = Redis:scard(TheSNAK.."SNAK:Distinguished:Group"..data.chat_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الاساسيين : '..L..' ›', data =IdUser..'/'.. 'TheBasicslar'},},{{text = '‹ المنشئين : '..LL..' ›', data =IdUser..'/'.. 'Originatorslar'},{text = '‹ المدراء : '..LLL..' ›', data =IdUser..'/'.. 'Managerslar'},},{{text = '‹ الادمنيه : '..LLLL..' ›', data =IdUser..'/'.. 'Addictivelar'},{text = '‹ المميزين : '..LLLLL..' ›', data =IdUser..'/'.. 'DelDistinguishedlar'},},{{text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr'}},}}
...
if tonumber(IdUser) == tonumber(UserId) then
local LaR = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..data.chat_id..UserId) or 0)
local lar = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..data.chat_id..':'..UserId) or 0)
local Text = "\n‹ : من خلال الازرار يمكنك مسح رسائلك وسحكاتك"
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..LaR..' ›', data =IdUser..'/'.. 'MsgDell'},{text = '‹ مسح رسائلي : '..lar..' ›', data =IdUser..'/'.. 'MMsgDel'},},{{text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 SNAK ›', url = 't.me/ivviv'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Text, 'md', false, false, reply_markup) end end 
-- LaR
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheSNAK.."SNAK:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:TheBasics:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Originators:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Managers:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Addictive:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Cleaner:Group"..ChatId) 
