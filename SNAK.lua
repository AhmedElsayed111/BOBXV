...
local N = (Redis:get(SNAK.."Name:Bot") or "جيسكا")
...
elseif msg.sender.user_id == tonumber(19189682211) then
LuaTele.sendText(msg_chat_id,msg_id,"• انت مطور السورس يقلبي🌚♥","md",true)
...
local TextingDevSNAK = Redis:get(SNAK..'Texting:DevSNAK')
...
if text == (Redis:get(SNAK.."Name:Bot") or "جيسكا") then
local NamesBot = (Redis:get(SNAK.."Name:Bot") or "جيسكا")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
local Namebot = (Redis:get(SNAK.."Name:Bot") or "جيسكا")
local BotName = {
'⊲ '..Namebot..' ⊳ ',
}
...
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
KlamSNAK = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","جيسكا","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","معتز","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSNAK[math.random(#KlamSNAK)]
...
name = string.gsub(name,"جيسكا","ر و ف ر ي")
...
data = {
{
{text = 'زخرف اسمك الان', url = 't.me/okrbot'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*• زخرفه جيسكا اضغط وزخرف اسمك ب زخرف اسمك بزخرفه رائعه 🍄.*',"md",false, false, false, false, reply_markup)
end
...
local CmdStart = '\n• مرحبا انا بوت '..(Redis:get(SNAK.."Name:Bot") or "جيسكا")..
...
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه ب التفعيل والتعطيل لبوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع •',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه ب أحصائيات  بوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء •',type = 'text'},},
{{text = 'رجـوع •',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه ب المطورين لبوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء •',type = 'text'},},
{{text = 'رجـوع •',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه بالاذاعه لبوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء •',type = 'text'},},
{{text = 'رجـوع •',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه بالعام لبوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء •',type = 'text'},},
{{text = 'رجـوع •',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙اهلا بك مجددا عزيزي المطور \n•︙اليك الازرار الخاصه ببوتك المثبت علئ لبوت جيسكا فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source SNAK     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين •' then
...
data = {
{
{text = 'بوت جيسكا', url = 't.me/UU_SNAK'}, 
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'بوت جيسكا', url = 't.me/UU_SNAK'}, },}}
...
{{text = '• العاب جيسكا', data = IdUser..'/normgm'}, {text = '• العاب متطورة', data = IdUser..'/degm'}, },
{{text = '• القائمه الرئيسيه', data = IdUser..'/helpall'},},
}}
local TextHelp = [[*
• أهلا بك في قائمة العاب بوت جيسكا اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{{text = 'القائمه الرئيسيه', data = IdUser..'/helpall'}, },}}
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص ببوت جيسكا
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 'http://t.me/UU_SNAK'}, },}}
