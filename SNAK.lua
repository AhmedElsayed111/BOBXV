...
LuaTele = luatele.set_config{api_id=10332903,api_hash='17598f27636c07b3c8a14327828e6e02',session_name=SNAK,token=Token}
function var(value)  
...
TheBasicsQ = Redis:sismember(SNAK.."SNAK:TheBasicsQ:Group"..ChatId,UserId) 
...
Status = Redis:get(SNAK.."SNAK:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
ktmall = Redis:sismember(SNAK.."SNAK:ktmAll:Groups",UserId) ,
...
elseif Redis:sismember(SNAK.."SNAK:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(SNAK.."SNAK:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if text and Redis:get(SNAK.."SNAK:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(SNAK.."SNAK:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(SNAK.."SNAK:All:Get:Reides:Commands:Group"..text)
Redis:del(SNAK.."SNAK:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(SNAK.."SNAK:All:Command:List:Group",text)
...
Redis:del(SNAK.."SNAK:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(SNAK.."SNAK:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(SNAK.."SNAK:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(SNAK.."SNAK:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(SNAK.."SNAK:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"•ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(SNAK.."SNAK:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(SNAK.."SNAK:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(SNAK.."SNAK:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(SNAK.."SNAK:All:Command:List:Group",text)
Redis:del(SNAK.."SNAK:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
{
{text = 'Source SNAK', url='https://t.me/UU_SNAK'},
},
}
}
...
if text then
local NewCmmd = Redis:get(SNAK.."SNAK:All:Get:Reides:Commands:Group"..text) or Redis:get(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Redis:set(SNAK.."SNAK:SendBcBot",true) 
...
Redis:set(SNAK.."SNAK:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"•تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(SNAK.."SNAK:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SNAK.."SNAK:AddSudosNew"..msg_chat_id)
...
Redis:set(SNAK.."SNAK:AddSudosNew"..msg_chat_id,true)
...
local TotalMsg = Redis:get(SNAK..'SNAK:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(SNAK..'SNAK:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(SNAK.."SNAK:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(SNAK.."SNAK:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(SNAK.."SNAK:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:del(SNAK.."SNAK:PresidentQ:Group:Reply"..msg.chat_id)
...
local Info_Members = Redis:smembers(SNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."SNAK:ktmAll:Groups") 
if #Info_Members == 0 then
...
Redis:set(SNAK.."SNAK:photo:Rank"..msg_chat_id,true) 
...
if TextMsg == 'التحقق' then
    Redis:set(SNAK.."SNAK:Status:joinet"..msg_chat_id,true) 
...
Redis:del(SNAK.."SNAK:photo:Rank"..msg_chat_id) 
...
if TextMsg == 'التحقق' then
    Redis:del(SNAK.."SNAK:Status:joinet"..msg_chat_id) 
...
if not msg.ControllerBot and not Redis:set(SNAK.."SNAK:LeftBot") then
...
Redis:set(SNAK.."SNAK:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(SNAK.."SNAK:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(SNAK.."SNAK:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(SNAK.."SNAK:All:Get:Reides:Commands:Group"..v)
Redis:del(SNAK.."SNAK:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(SNAK.."SNAK:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:del(SNAK.."SNAK:ktmAll:Groups") 
...
local CmdStart = '*\n•أهلآ بك في بوت '..(Redis:get(SNAK.."SNAK:Name:Bot") or "سناك")..
...
if not msg.ControllerBot and not Redis:set(SNAK.."SNAK:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/UU_SNAK'}, },}}
...
Redis:del(SNAK.."SNAK:List:Manager"..'-100'..data.supergroup.id)
Redis:del(SNAK.."SNAK:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(SNAK..'SNAK:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:del(SNAK.."SNAK:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(SNAK.."SNAK1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."SNAK:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."SNAK:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(SNAK.."SNAK1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(SNAK.."SNAK:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(SNAK.."SNAK:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الزخرفه بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الزخرفه بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(SNAK..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(SNAK..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(SNAK..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(SNAK.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الابراج بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SNAK..'Rio:Brg:Rio'..msg.chat_id_) then
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SNAK..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(SNAK..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(SNAK..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(SNAK..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(SNAK..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "• نسبه الخيانه •" and DevRio:get(SNAK..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(SNAK..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SNAK..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال البوب و سناك ', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "• نسبه الجمال •" and DevRio:get(SNAK..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(SNAK..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SNAK..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "• نسبه الكره •" and DevRio:get(SNAK..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(SNAK..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SNAK..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال البوب و سناك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "• نسبه الرجوله •" and DevRio:get(SNAK..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(SNAK..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SNAK..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال • بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "• نسبه الانوثه •" and DevRio:get(SNAK..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(SNAK..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SNAK..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال البوب و سناك ', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "• نسبه الغباء •" and DevRio:get(SNAK..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(SNAK..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل حساب العمر'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل حساب العمر'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SNAK..'Rio:Age:Rio'..msg.chat_id_) then
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل معاني الاسماء'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SNAK..'Rio:Mean:Rio'..msg.chat_id_) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل المتحركه'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل المتحركه'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "• متحركه •") and not DevRio:get(SNAK..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الميمز'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الميمز'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "• ميمز •") and not DevRio:get(SNAK..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل غنيلي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل غنيلي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text == "غنيلي" then
local t = "Your song"
Rv = math.random(8,83)
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الاغاني'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الاغاني'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "• اغنيه •" or text == "اغاني") and not DevRio:get(SNAK..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الريمكس'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الريمكس'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "• ريمكس •") and not DevRio:get(SNAK..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الصوره'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الصوره'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "• صوره •") and not DevRio:get(SNAK..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الانمي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الانمي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "• انمي •") and not DevRio:get(SNAK..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الافلام'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الافلام'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "• فلم •") and not DevRio:get(SNAK..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل المسلسلات'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SNAK..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local SNAKTeam = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل المسلسلات'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAKTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SNAK..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "• مسلسل •") and not DevRio:get(SNAK..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."SNAK:TheBasicsQ:Group"..ChatId) 
