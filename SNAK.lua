...
local N = (Redis:get(SNAK.."Name:Bot") or "داغر")
...
if text == 'رفع نسخه داغر' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✘︙ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'✘︙ تم استرجاع المجموعات من نسخه داغر')
else
...
local Namebot = (Redis:get(SNAK.."Name:Bot") or "داغر")
local BotName = {
...
if text == (Redis:get(SNAK.."Name:Bot") or "داغر") then
local photo = LuaTele.getUserProfilePhotos(SNAK)
local ban = LuaTele.getUser(SNAK)
local Namebot = (Redis:get(SNAK.."Name:Bot") or "داغر")
local BotName = {
...
------------------------------------------------
-- This Source Was Developed By (Joker) @XB0BB.--
