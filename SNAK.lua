------------------------------------------------
-- This Source Was Developed By (ELBOB) @UU_SNAK.--
--   This Is The Source Channel @UU_SNAK .   --
--           - Source Speed -                 --
--        -- https://t.me/UU_SNAK --         --
------------------------------------------------ 
...
os.execute('chmod +x TheSNAK;chmod +x Run;./Run')
end
...
Status = Redis:get(TheSNAK.."SNAK:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBas then
Status = Redis:get(TheSNAK.."SNAK:TheBas:Group:Reply"..ChatId) or 'المالك'
elseif TheBasicsQ then
Status = Redis:get(TheSNAK.."SNAK:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheSNAK.."SNAK:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheSNAK.."SNAK:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheSNAK.."SNAK:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheSNAK.."SNAK:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعة'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعة'
elseif Distinguished then
Status = Redis:get(TheSNAK.."SNAK:Vip:Group:Reply"..ChatId) or 'المميز'
elseif Cleaner then
Status = Redis:get(TheSNAK.."SNAK:Cle:Group:Reply"..ChatId) or 'المنظف'
else
Status = Redis:get(TheSNAK.."SNAK:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheSNAK.."SNAK:lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(TheSNAK.."SNAK:Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(TheSNAK.."SNAK:Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(TheSNAK.."SNAK:Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(TheSNAK.."SNAK:Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheSNAK.."SNAK:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheSNAK.."SNAK:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{ 
BanAll = Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) ,
ktmAll = Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..ChatId,UserId)
 }
end
...
ReplyJok    = '•︙عزيزي ↫ '..UserInfousername..'\n'..TextMsg..''
 }
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheSNAK).status
if GetMemberStatus.can_change_info then
...
if tonumber(msg.sender.user_id) == tonumber(TheSNAK) then
...
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",msg.sender.user_id) == true then
msg.The_Controller = 100
msg.Name_Controller = 'المطور الاساسي'
elseif Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الاساسي²'
elseif Redis:sismember(TheSNAK.."SNAK:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Developer:Bot:Reply"..msg.chat_id) or 'المطور'
elseif Redis:sismember(TheSNAK.."SNAK:TheBas:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 99
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:TheBas:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Vip:Group:Reply"..msg.chat_id) or 'المميز'
elseif Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 88
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Cle:Group:Reply"..msg.chat_id) or 'المنظف'
elseif tonumber(msg.sender.user_id) == tonumber(TheSNAK) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheSNAK.."SNAK:Mempar:Group:Reply"..msg.chat_id) or 'العضو'
end  
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع الفشار في المجموعة").ReplyJok,"md",true)
return false
end 
end
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع التكلم بالطائفيه هنا").ReplyJok,"md",true)
return false
end 
end
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع الكفر في المجموعة").ReplyJok,"md",true)
return false
end 
end
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع التكلم باللغه الفارسيه").ReplyJok,"md",true)
return false
end 
end
...
Num_Msg_Max = Redis:hget(TheSNAK.."SNAK:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع توجيه الرسائل هنا").ReplyJok,"md",true)
...
elseif Info_User.type.luatele == "userTypeReguJok" then
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال الفيديوهات هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال الملفات هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال الاغاني هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال البصمات هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال الملصقات هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال المتحركات هنا").ReplyJok,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"•︙ممنوع ارسال الصور هنا").ReplyJok,"md",true)
...
if Text_Filter then   
Redis:set(TheSNAK.."SNAK:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
...
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
...
if Redis:get(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheSNAK.."SNAK:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheSNAK.."SNAK:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheSNAK.."SNAK:PinMsegees:"..v,text)
end
end
...
if tonumber(TheSNAK) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'•︙عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',v)  
end
X = 0
...
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Cleaner then
for k,v in pairs(ListGroup.Cleaner) do
Redis:sadd(TheSNAK.."SNAK:Cleaner:Group"..GroupId,v)
end
end 
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheSNAK.."SNAK:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(TheSNAK.."SNAK:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheSNAK.."SNAK:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheSNAK.."SNAK:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..idg,idASAS)
end;end
end
...
local tt =[[
•︙[Source Speed](https://t.me/UU_SNAK) .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ Source Channel .', url = "https://t.me/UU_SNAK"}},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_SNAK&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '‹ مبرمج السورس ›' or text == 'مبرمج' or text == 'مبرمج السورس' or text == 'مطور السورس' or text == 'المبرمج' then
local tt =[[
•︙[مبرمج السورس](https://t.me/UU_SNAK) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مبرمج السورس .', url = "https://t.me/UU_SNAK"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_SNAK&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '‹ تحديثات السورس ›' or text == 'قناة التحديثات' or text == 'تحديثات السورس' then
local tt =[[
•︙[Exp Source](https://t.me/UU_SNAK) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Exp Source .', url = "https://t.me/UU_SNAK"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_SNAK&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "‹ اسم البوت ›" then
local NamesBot = (Redis:get(TheSNAK.."SNAK:Name:Bot") or "سناك")
local BotName = { 
...
download('https://raw.githubusercontent.com/l-Lwa/Lir/master/SNAK.lua','SNAK.lua')
...
db = "video_note@"..Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:set(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheSNAK..'SNAK:Num:Add:Bot') or 0)) and not msg.DevelopersAS then
return LuaTele.sendText(msg_chat_id,msg_id,'•︙عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(TheSNAK..'SNAK:Num:Add:Bot'),"md",true)  
end
...
{ 
{ text = '‹ TeAm Speed ›', url = 't.me/UU_SNAK' },
 },
 }
 }
if not msg.ControllerBot then
...
if UserInfo.username then
Jok = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')'
else
Jok = '['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')'
end
...
if not Redis:get(TheSNAK.."SNAK:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsgT = Total_message(TotalMsg) 
if UserInfo.username then
Jok = '@'..UserInfo.username..''
else
Jok = 'لا يوجد'
end
return LuaTele.sendText(msg_chat_id,msg_id, '•︙معرفه ↫ '..Jok..'\n•︙ايديه ↫ ❨ `'..UserId..'` ❩\n•︙رتبته ↫ '..RinkBot..'\n•︙رسائله ↫ ❨ '..TotalMsg..' ❩\n•︙سحكاته ↫ ❨ '..TotalEdit..' ❩\n•︙تفاعله ↫ '..TotalMsgT..'\n•︙نقاطه ↫ ❨ '..NumberGame..' ❩ ' ,"md",true) 
end
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) then
...
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:SetId"..msg_chat_id) then
...
if Redis:sismember(TheSNAK.."SNAK:DevelopersAS:Groups",UserId) then
...
if Redis:sismember(TheSNAK.."SNAK:DevelopersQ:Groups",UserId) then
...
if Redis:sismember(TheSNAK.."SNAK:Developers:Groups",UserId) then
...
if Redis:sismember(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:Originators:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:Managers:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id,UserId[2]) then
...
local Jok = Redis:scard(TheSNAK.."SNAK:DevelopersAS:Groups") 
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح الاساسيين : '..Jok..' ›', data = msg.sender.user_id..'/DevelopersAS' }, }, } }
...
local Jok = Redis:scard(TheSNAK.."SNAK:DevelopersQ:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح الثانويين : '..Jok..' ›', data = msg.sender.user_id..'/DevelopersQ' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Developers:Groups")  
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المطورين : '..Jok..' ›', data = msg.sender.user_id..'/Developers' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id)
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المالكين : '..Jok..' ›', data = msg.sender.user_id..'/TheBasicsQ' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح الاساسيين : '..Jok..' ›', data = msg.sender.user_id..'/TheBasics' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Originators:Group"..msg_chat_id)
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المنشئين : '..Jok..' ›', data = msg.sender.user_id..'/Originators' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المدراء : '..Jok..' ›', data = msg.sender.user_id..'/Managers' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Addictive:Group"..msg_chat_id)
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح الادمنيه : '..Jok..' ›', data = msg.sender.user_id..'/Addictive' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Cleaner:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المنظفين : '..Jok..' ›', data = msg.sender.user_id..'/Cleaner' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المميزين : '..Jok..' ›', data = msg.sender.user_id..'/DelDistinguished' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(TheSNAK.."SNAK:BanAll:Groups") 
local Jok = Redis:scard(TheSNAK.."SNAK:BanAll:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المحظورين عام : '..Jok..' ›', data = msg.sender.user_id..'/BanAll' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:ktmAll:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المكتومين عام : '..Jok..' ›', data = msg.sender.user_id..'/ktmAll' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المحظورين : '..Jok..' ›', data = msg.sender.user_id..'/BanGroup' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Jok = Redis:scard(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { { { text = '‹ مسح المكتومين : '..Jok..' ›', data = msg.sender.user_id..'/SilentGroupGroup' }, }, } }
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text3"..test..msg.chat_id, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK1:Add:Rd:Sudo:Text4"..test..msg.chat_id, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{ text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdJokR' },},}}
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text"..test, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text1"..test, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheSNAK.."SNAK11:Add:Rd:Sudo:Text2"..test, text)  
end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{ text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdJokRbot' },},}}
...
LuaTele.sendText(msg_chat_id,msg_id,'•︙عدد المسح الحالي ↫ ‹ *'..(Redis:get(TheSNAK..'SNAK:Num:Add:Bot'..msg_chat_id) or 150)..'* › ',"md",true)  
end
...
Redis:del(TheSNAK.."SNAK:allM"..msg.chat_id)
end
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{ text = '‹ امسح ›', data = msg.sender.user_id..'/MsHJok' },},}}
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) then
...
local NcH = (Redis:get(TheSNAK.."SNAK:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(TheSNAK.."SNAK:CHlink:Bot") or "•︙عذراً لاتستطيع استخدام البوت !\n•︙عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = NcH, url = 't.me/UU_SNAK' }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then
...
if not msg.Originators and not Redis:get(TheSNAK.."SNAK:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) then
...
if Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanAll:Groups",UserId_Info.id) and not Redis:sismember(TheSNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then
...
if Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId) then
...
if Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) then
...
if not Redis:sismember(TheSNAK.."SNAK:SilentGroup:Group"..msg_chat_id,UserId) then
...
Jok = '['..User_Info.first_name..'](t.me/'..User_Info.username..')'
else
Jok = '['..User_Info.first_name..'](tg://user?id='..msg.sender.user_id..')'
end
...
if text == "غنيلي" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction1"..msg_chat_id) then
...
if text == "متحركه" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction2"..msg_chat_id) then
...
if text == "شعر" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction3"..msg_chat_id) then
...
if text == "ميمز" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction9"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction8"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction4"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction7"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction6"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:distraction5"..msg_chat_id) then
...
if text == "مسلسل" then
if not Redis:get(TheSNAK.."SNAK:Status:distraction10"..msg_chat_id) then
...
if text == "الرابط" then
if not Redis:get(TheSNAK.."SNAK:Status:Link"..msg_chat_id) then
...
if text == 'نزلني' then
if not Redis:get(TheSNAK.."SNAK:Status:remMe"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:KickMe"..msg_chat_id) then
...
if not Redis:get(TheSNAK.."SNAK:Status:Welcome"..msg_chat_id) then
...
Redis:srem(TheSNAK.."SNAK:List:Filter"..msg_chat_id,v)  
end  
...
Redis:del(TheSNAK.."SNAK:Command:List:Group"..msg_chat_id)
end
...
if text == 'رسائلي' then
local Jok = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ مسح رسائلي : '..Jok..' ›', data = msg.sender.user_id..'/MMsgDel' }, }, } }
LuaTele.sendText(msg_chat_id,msg_id,'•︙عدد رسائلك هنا ↫ ‹ *'..Jok..'* ›',"md",false ,false, false,false,reply_markup)  
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local Jok = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ مسح سحكاتي : '..Jok..' ›', data = msg.sender.user_id..'/MsgDell'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'•︙عدد التعديلات هنا ↫ ‹ *'..Jok..'* ›',"md",false, false, false,false, reply_markup)  
end
...
{
{ text = '‹ الردود المتعدده : '..R..' ›', data = msg.sender.user_id..'/RdJok' },
}, 
} 
}
...
data = {
{
{ text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RdJok' },{ text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RdJok' },
}, 
{ 
{ text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr' }
 },
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {{{ text = '‹ الغاء ›', data = msg.sender.user_id..'/Jokclose' },},}}
...
data = {
{
{ text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RSoJok' },{ text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RSoJok' },
}, 
{ 
{ text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr' }
 },
...
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {{{ text = '‹ الغاء ›', data = msg.sender.user_id..'/JokcloseSo' },},}}
...
if Redis:get(TheSNAK.."SNAK:Status:kool"..msg.chat_id) then
...
{{text = '‹ TeAm Speed ›', url = "https://t.me/UU_SNAK"}}
}
local msgg = msg_id/2097152/0.5
...
data = { 
{ 
{ text = '‹ الاساسيين : '..L..' ›', data = msg.sender.user_id..'/TheBasicsJok' },
 },
{ 
{ text = '‹ المنشئين : '..LL..' ›', data = msg.sender.user_id..'/OriginatorsJok' },{ text = '‹ المدراء : '..LLL..' ›', data = msg.sender.user_id..'/ManagersJok' },
 },
{ 
{ text = '‹ الادمنيه : '..LLLL..' ›', data = msg.sender.user_id..'/AddictiveJok' },{ text = '‹ المميزين : '..LLLLL..' ›', data = msg.sender.user_id..'/DelDistinguishedJok' },
 },
{ 
{ text = '‹ TeAm Speed ›', url = 't.me/UU_SNAK' }, 
 },
...
data = { 
{ 
{ text = '‹ مسح سحكاتي : '..Jok..' ›', data = msg.sender.user_id..'/MsgDell' },{ text = '‹ مسح رسائلي : '..Jok..' ›', data = msg.sender.user_id..'/MMsgDel' },
 },
 { 
{ text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr' }
 },
...
local Jok = LuaTele.getUser(SNAK)
local Namebot = (Redis:get(SNAK.."Name:Bot") or "سناك")
local BotName = {
...
if Jok.username then
Creator = " "..Jok.first_name.." "
else
Creator = " سناك\n"
end
...
if text == (Redis:get(SNAK.."Name:Bot") or "سناك") then
local photo = LuaTele.getUserProfilePhotos(SNAK)
local Jok = LuaTele.getUser(SNAK)
local Namebot = (Redis:get(SNAK.."Name:Bot") or "سناك")
local BotName = {
...
x = x + 1
Redis:srem(TheSNAK..'SNAK:Num:User:Pv',v)
end
end
if x ~= 0 then
...
{ 
{ text = '‹ قناة السورس ›', url = 't.me/UU_SNAK' },{ text = '‹ لتنصيب بوت ›', url = 't.me/UU_0B' }, 
 },
{ 
{ text = '‹ - Boot Snak ›', url = 't.me/UU_TBOT'}, 
},
{ 
{ text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?SNAKgroup=new' }, 
 },
 }
 }
return LuaTele.sendText(msg_chat_id,msg_id,CmdSNAK,"md",false, false, false, false, reply_markup)
else
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(SNAK.."SNAK:SNAK:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
return LuaTele.sendText(msg_chat_id,msg_id, Jok, 'md', false, false, false, false, reply_markup)
end
if text == '‹  السورس  ›' and msg.DevelopersAS then
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ السورس ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ اسم البوت ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
 { 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ الاذاعة ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ العام ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ المطورين ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ الاحصائيات ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ الاشتراك الاجباري ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
Redis:sadd(TheSNAK..'SNAK:Num:User:Pv',msg.sender.user_id)  
local Jok = '•︙اهلا بك في قسم ‹ التفعيل والتعطيل ›\n•︙اضغط على الامر الذي تريد تنفيذه'
local reply_markup = LuaTele.replyMarkup{ type = 'keyboard',resize = true,is_personal = true,
data = { 
{ 
...
if not Redis:get(TheSNAK.."SNAK:Start:Bot") then
local CmdStart = '•︙مرحبا انا بوت اسمي ‹ '..(Redis:get(TheSNAK.."SNAK:Name:Bot") or "سناك")..' ›\n•︙اختصاصي التسليه وحماية المجموعات \n•︙من المخربين والتفليش والسبام والخ\n•︙فقط قم برفعي ادمن في مجموعتك\n•︙وارسل كلمة ↫ ‹ تفعيل ›'
return LuaTele.sendText(msg_chat_id,msg_id,CmdStart,"md",false, false, false, false, reply_markup)
else
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheSNAK.."SNAK:Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
...
Redis:del(TheSNAK.."SNAK:List:Rd:Sudo")
end
...
Redis:set(TheSNAK..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:del(TheSNAK.."SNAK:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if Text and Text:match('(%d+)/MsHJok') then
local UserId = Text:match('(%d+)/MsHJok')
if tonumber(IdUser) == tonumber(UserId) then
...
Redis:del(TheSNAK.."SNAK:allM"..data.chat_id)
end
end
if #list == 0 then
t = "•︙لا توجد ميديا في المجموعة"
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction1"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction2"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction3"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction4"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction5"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction6"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction7"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction8"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction9"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheSNAK.."SNAK:Status:distraction10"..data.chat_id) then
...
if Text and Text:match('(%d+)/delrdJokRbot') then
local UserId = Text:match('(%d+)/delrdJokRbot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text'..test)
Redis:del(TheSNAK..'SNAK11:Add:Rd:Sudo:Text1'..test)
...
if Text and Text:match('(%d+)/delrdJokR') then
local UserId = Text:match('(%d+)/delrdJokR')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheSNAK.."SNAK1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(TheSNAK..'SNAK1:Add:Rd:Sudo:Text1'..test..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then 
local Get_Chat = LuaTele.getChat(data.chat_id) 
local GetLink = Redis:get(TheSNAK.."SNAK:Group:Link"..data.chat_id) 
if GetLink then
...
if #list == 0 then
Jok = "•︙عذراً لا توجد ردود للمطور"
end
return LuaTele.editMessageText(ChatId,Msg_id,Jok,"md",true)  
end
end
...
if Text and Text:match('(%d+)/RSoJok') then
local UserId = Text:match('(%d+)/RSoJok')
if tonumber(IdUser) == tonumber(UserId) then 
...
Redis:del(TheSNAK.."SNAK11:List:Rd:Sudo")
end
...
if Text and Text:match('(%d+)/JokcloseSo') then
local UserId = Text:match('(%d+)/JokcloseSo')
if tonumber(IdUser) == tonumber(UserId) then
...
if Text and Text:match('(%d+)/RdJok') then
local UserId = Text:match('(%d+)/RdJok')
if tonumber(IdUser) == tonumber(UserId) then 
...
Redis:del(TheSNAK.."SNAK1:List:Rd:Sudo"..data.chat_id)
end
...
if #list == 0 then
Jok = "•︙عذرا لا يوجد ردود للمدير في المجموعة"
end
LuaTele.editMessageText(ChatId,Msg_id,Jok, 'md', true)
end
end
...
Redis:del(TheSNAK.."SNAK:List:Manager"..data.chat_id)
end
...
if Text and Text:match('(%d+)/Jokclose') then
local UserId = Text:match('(%d+)/Jokclose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSNAK.."SNAK:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'•︙تم الغاء الامر',"md",true)
end
...
if Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",data.chat_id) then
return LuaTele.editMessageText(ChatId,Msg_id, '\n•︙المجموعة تم تفعيلها بالتأكيد' ,"md",true)  
else
...
local Get_Chat = LuaTele.getChat(data.chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(data.chat_id)
if not Redis:sismember(TheSNAK.."SNAK:ChekBotAdd",data.chat_id) then
return LuaTele.editMessageText(ChatId,Msg_id, '\n•︙المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
...
if Text and Text:match('(%d+)/TheBasicsJok') then
local UserId = Text:match('(%d+)/TheBasicsJok')
if tonumber(IdUser) == tonumber(UserId) then 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAJok' }, }, } }
...
if Text and Text:match('(%d+)/OriginatorsJok') then
local UserId = Text:match('(%d+)/OriginatorsJok')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAJok' }, }, } }
...
if Text and Text:match('(%d+)/ManagersJok') then
local UserId = Text:match('(%d+)/ManagersJok')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAJok' }, }, } }
...
if Text and Text:match('(%d+)/AddictiveJok') then
local UserId = Text:match('(%d+)/AddictiveJok')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAJok' }, }, } }
...
if Text and Text:match('(%d+)/DelDistinguishedJok') then
local UserId = Text:match('(%d+)/DelDistinguishedJok')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAJok' }, }, } }
...
if Text and Text:match('(%d+)/RgoAJok') then
local UserId = Text:match('(%d+)/RgoAJok')
if tonumber(IdUser) == tonumber(UserId) then
...
data = { 
{ 
{ text = '‹ الاساسيين : '..L..' ›', data =IdUser..'/'.. 'TheBasicsJok' },
 },
{ 
{ text = '‹ المنشئين : '..LL..' ›', data =IdUser..'/'.. 'OriginatorsJok' },{ text = '‹ المدراء : '..LLL..' ›', data =IdUser..'/'.. 'ManagersJok' },
 },
{ 
{ text = '‹ الادمنيه : '..LLLL..' ›', data =IdUser..'/'.. 'AddictiveJok' },{ text = '‹ المميزين : '..LLLLL..' ›', data =IdUser..'/'.. 'DelDistinguishedJok' },
 },
{ 
{ text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr' }
 },
...
if tonumber(IdUser) == tonumber(UserId) then
local Jok = (Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..data.chat_id..UserId) or 0)
local Jok = (Redis:get(TheSNAK..'SNAK:Num:Message:User'..data.chat_id..':'..UserId) or 0)
local Text = "\n•︙من خلال الازرار يمكنك مسح رسائلك وسحكاتك"
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
{ 
{ text = '‹ مسح سحكاتي : '..Jok..' ›', data =IdUser..'/'.. 'MsgDell' },{ text = '‹ مسح رسائلي : '..Jok..' ›', data =IdUser..'/'.. 'MMsgDel' },
 },
{ 
{ text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr' }
 },
