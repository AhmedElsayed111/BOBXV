...
local Added_Me = Redis:get(daghir.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Redis:get(daghir.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(daghir.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
----زخرفه-----
if Redis:get(daghir.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
Redis:del(daghir.."zhrfa"..msg.sender.user_id) 
end
...
if text == 'البوب' or text == 'بوب' or text == 'احمد' or text == 'elbob' then
local UserId_Info = LuaTele.searchPublicChat("UU_0B")
...
if text == 'معتز' or text == 'ميزو' or text == 'MOATAZ' or text == 'كسم معتز' then
...
Redis:set(daghir.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*❅ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(daghir.."zhrfa"..IdUser,"sendzh") 
