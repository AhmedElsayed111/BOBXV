...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheSNAK -X kill
screen -S TheSNAK ./TheSNAK
done
]])
Run:close()
...
MsgText = 'التفاعل مش حلو' 
elseif tonumber(Message) < 200 then 
MsgText = 'تفاعلك ضعيف ليه'
...
MsgText = 'اساس لتفاعل يعمنا'  
elseif tonumber(Message) < 4000 then 
MsgText = 'عوف لجواهر وتفاعل بزودك' 
elseif tonumber(Message) < 4500 then 
MsgText = 'قمة التفاعل' 
elseif tonumber(Message) < 5500 then 
MsgText = 'ايه التفاعل دا استمر' 
...
return {
Lock     = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘︙خاصيه المسح *',
unLock   = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘︙خاصيه الكتم *',
lockKid  = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘︙خاصيه التقييد *',
lockKick = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘︙خاصيه الطرد *',
Reply    = '[- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .](https://t.me/UU_SNAK)\n*— — — — — — — — —\n✘︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if Redis:get(TheSNAK.."SNAK:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
if text and (Redis:get(TheSNAK..'SNAK:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheSNAK..'SNAK:Channel:Join')}, },}}
...
--download('https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/master/SNAK.lua','SNAK.lua')
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheSNAK..'SNAK:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'✘︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheSNAK..'SNAK:Num:Add:Bot'),"md",true)  
end
...
Redis:set(TheSNAK.."SNAK:Status:Id"..msg_chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:Reply"..msg_chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:BanId"..msg_chat_id,true) ;Redis:set(TheSNAK.."SNAK:Status:SetId"..msg_chat_id,true) 
...
if Redis:sismember(SNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local list = Redis:smembers(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheSNAK.."SNAK1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheSNAK.."SNAK1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:del(TheSNAK.."SNAK:Status:yt"..msg.chat_id)
...
Redis:set(TheSNAK.."SNAK:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'✘︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheSNAK.."SNAK:Status:yt"..msg.chat_id) then
...
if not Redis:sismember(SNAK.."SNAK:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(SNAK.."SNAK:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(SNAK.."SNAK:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"•تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(SNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم حظره من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:sismember(SNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."SNAK:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم الغاء حظره من المجموعه  ").Reply,"md",true)  
end
end
...
Redis:del(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheSNAK..'SNAK:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
...
LuaTele.sendText(msg_chat_id,msg_id,'✘︙عدد رسائلك هنا *~ '..(Redis:get(TheSNAK..'SNAK:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘︙عدد التعديلات هنا *~ '..(Redis:get(TheSNAK..'SNAK:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(SNAK.."SNAK:Set:Id:Groups")
...
local list = Redis:smembers(TheSNAK.."SNAK:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheSNAK.."SNAK:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheSNAK.."SNAK:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local TextingDevTheSNAK = Redis:get(TheSNAK..'SNAK:Texting:DevTheSNAK')
if TextingDevTheSNAK then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevSNAK,"md",true)  
else
...
local NamesBot = (Redis:get(SNAK.."SNAK:Name:Bot") or "سناك")
local BotName = {
'اسمي  '..NamesBot..'🖤',
'اسمي '..NamesBot..'❤️',
'اسمي  '..NamesBot..'♥️',
...
if text == (Redis:get(SNAK.."SNAK:Name:Bot") or "سناك") then
local photo = LuaTele.getUserProfilePhotos(SNAK)
local UserInfo = LuaTele.getUser(SNAK)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
Redis:set(TheSNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
...
local CmdStart = '*\n✘︙أهلآ بك في بوت '..(Redis:get(TheSNAK.."SNAK:Name:Bot") or "كادي")..
...
data = {
{
{text = '𖤐 السورس .', url = 't.me/UU_SNAK'},{text = '𖤐 لتنصيب بوت .', url = 't.me/XB8Bbot'}, 
},
{
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheSNAK.."SNAK:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
