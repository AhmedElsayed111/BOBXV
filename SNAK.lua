...
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/main/SNAK.lua?token=GHSAT0AAAAAABRCLSCLMPQSGNPRGHRVNT4YYQDHHWQ')
...
local TotalMsg = Redis:get(daghir..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(daghir..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(daghir.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(daghir.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
