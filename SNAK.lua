...
data = {
{
{text = 'Channel Source ،', url = 't.me/UU_SNAK'}, 
},
{
{text = 'Annotations Source', url = 't.me/UU_SNAK'}, 
},
{
{text = 'Communication Source', url = 't.me/DDT5BOT'}, 
},
{
{text = 'Developer Source !', url = 't.me/UU_0P'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(SNAK.."SNAK:Name:Bot") or "ايك") then
local NamesBot = (Redis:get(SNAK.."SNAK:Name:Bot") or "ايك")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(SNAK.."SNAK:Name:Bot") or "ايك")..
