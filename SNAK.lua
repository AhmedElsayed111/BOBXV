...
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(SNAK.."SNAK:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
