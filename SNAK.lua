...
LuaTele = luatele.set_config{api_id=1846213,api_hash='c545c613b78f18a30744970910124d53',session_name=SNAK,token=Token}
function var(value)
...
shh = text
if Redis:get(SNAK..'rmzsource') then
shh = shh:gsub("•",Redis:get(SNAK..'rmzsource'))
end
local listm = Redis:smembers(SNAK.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(SNAK.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = text
if Redis:get(SNAK..'rmzsource') then
sh = sh:gsub("•",Redis:get(SNAK..'rmzsource'))
end
local listm = Redis:smembers(SNAK.."Words:r")
for k,v in pairs(listm) do
...
if Redis:get(SNAK..'chdevolper') then
chdevolper = Redis:get(SNAK..'chdevolper')
else 
chdevolper = "UU_0P"
end
...
Status = 0
Devss = Redis:sismember(SNAK.."Devss:Groups",UserId) 
Dev = Redis:sismember(SNAK.."Dev:Groups",UserId)
Supcreator = Redis:sismember(SNAK.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(SNAK.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(SNAK.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(SNAK.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(SNAK.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(SNAK.."Special:Group"..ChatId,UserId)
...
Status = 'البوت'
elseif Devss then
Status = Redis:get(SNAK.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
...
MsgText = 'تفاعل ام عبير وهي بتكلم ام بوب عشان تجوز بوب لعبير'
...
if Redis:sismember(SNAK.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(SNAK.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(SNAK.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(SNAK.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(SNAK.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(SNAK.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(SNAK.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
if tonumber(msg.sender.user_id) ~= tonumber(1918968211) then
JoinChannel = false 
end
end
end 
...
if Redis:get(SNAK.."Lock:channell"..msg_chat_id) then
local m = Redis:get(SNAK.."chadmin"..msg_chat_id) 
...
Redis:incr(SNAK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
elseif Redis:sismember(SNAK.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(SNAK.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(SNAK.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(SNAK.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(SNAK.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(SNAK.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(SNAK.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(SNAK.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(SNAK.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(SNAK.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(SNAK.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(SNAK.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(SNAK.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(SNAK.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
...
if Redis:get(SNAK.."Lock:text"..msg_chat_id) and not msg.Special then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(SNAK) then
return false
end
...
if text and Redis:get(SNAK..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(SNAK..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*متعملش توجيه هنا يكسمك*").Reply,"md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(SNAK.."Name:Bot") or "سناك")
...
local txx = " • عذرآ عزيزي ↤ ["..u.first_name.." .\n• *ممنوع ارسال المعرفات*"
...
if text and Redis:get(SNAK..msg.chat_id..msg.sender.user_id.."replace") == "true1" then
Redis:del(SNAK..msg.chat_id..msg.sender.user_id.."replace")
local word = Redis:get(SNAK..msg.sender.user_id.."word")
Redis:set(SNAK.."Word:Replace"..word,text)
Redis:sadd(SNAK..'Words:r',word)  
LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الكلمه","md",true)  
return false 
end
if text and Redis:get(SNAK..msg.chat_id..msg.sender.user_id.."replace") == "true" then
Redis:set(SNAK..msg.sender.user_id.."word",text)
Redis:set(SNAK..msg.chat_id..msg.sender.user_id.."replace","true1")
...
Redis:set(SNAK.."Group:Link"..msg_chat_id,text)
Redis:del(SNAK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
if text and not Redis:get(SNAK.."Status:ReplySudo"..msg_chat_id) then
...
if text and not Redis:get(SNAK.."Status:Reply"..msg_chat_id) then
...
if Redis:get(SNAK..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(SNAK..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
Redis:sadd(SNAK.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(SNAK.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(SNAK.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,' * • لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(SNAK.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * • تم حذفه بنجاح .* ',"md",true)
end
end
if text then
if Redis:get(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(SNAK..'List:array',text) then
send(msg_chat_id, msg_id,' * • لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:set(SNAK.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(SNAK.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(SNAK.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == 'true' then
Redis:sadd(SNAK..'List:array', text)
Redis:set(SNAK..'Text:array'..msg.sender.user_id..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'ارسل الرد الذي تريد اضافته',"md",true)
Redis:del(SNAK.."Set:array"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(SNAK..'Set:array'..msg.sender.user_id..':'..msg_chat_id,'true1')
Redis:del(SNAK.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(SNAK.."Add:Rd:array:Text"..text)
Redis:srem(SNAK..'List:array', text)
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(SNAK.."chmembers") == "on" then
...
if Redis:get(SNAK.."mshaher"..msg.chat_id) then
if text == Redis:get(SNAK.."mshaher"..msg.chat_id) then
Redis:del(SNAK.."mshaher"..msg.chat_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SNAK.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:enkliz"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:enkliz"..msg.chat_id)
...
if Redis:get(SNAK.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(SNAK.."ch:addd"..msg.sender.user_id,"off")
...
Redis:set(SNAK.."ch:admin",data.result.invite_link)
else
...
Redis:set(SNAK.."ch:addd"..msg.sender.user_id,"on")
...
Redis:sadd(SNAK.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(SNAK.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(SNAK.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(SNAK.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(SNAK.."Special:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(SNAK.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(SNAK.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(SNAK.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(SNAK.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(SNAK.."AddSudosNew"..msg_chat_id,true)
...
local President = Redis:smembers(SNAK.."Supcreator:Group"..v)
local Constructor = Redis:smembers(SNAK.."Creator:Group"..v)
local Manager = Redis:smembers(SNAK.."Manger:Group"..v)
local Admin = Redis:smembers(SNAK.."Admin:Group"..v)
local Vips = Redis:smembers(SNAK.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
send(msg_chat_id,msg_id,'*•عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n•عدد المجموعات : '..(Redis:scard(SNAK..'ChekBotAdd') or 0)..'\n•عدد المشتركين : '..(Redis:scard(SNAK..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if Redis:sismember(SNAK..'ban:online',msg.chat_id) then
...
return send(msg_chat_id,msg_id,'•عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(SNAK..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(SNAK.."Status:Id"..msg_chat_id,true) ;Redis:del(SNAK.."Status:Reply"..msg_chat_id) ;Redis:del(SNAK.."Status:ReplySudo"..msg_chat_id) ;Redis:set(SNAK.."Status:BanId"..msg_chat_id,true) ;Redis:set(SNAK.."Status:SetId"..msg_chat_id,true) 
...
if chat_type(msg.chat_id) == "GroupBot" and not Redis:sismember(SNAK.."ChekBotAdd",msg_chat_id) then
Redis:sadd(SNAK.."ChekBotAdd",msg_chat_id)
local list = Redis:smembers(SNAK.."ChekBotAdd")
...
if not Redis:sismember(SNAK.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Devss:Groups",UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Dev:Groups",UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من الوتكات قبل كدة 🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•الكلب دا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(SNAK.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(SNAK.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "عره" then
if not Redis:sismember(SNAK.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(SNAK.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(SNAK.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Devss:Groups",UserId_Info.id) 
...
if Redis:sismember(SNAK.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Dev:Groups",UserId_Info.id) 
...
if Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(SNAK.."Status:SetId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SNAK.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•محطوط ف قايمة الخولات من  بدري 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•دا مولود كده ومحطوط عندنا من زمان 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•نزلناه من زمان وفكينا الكارو 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•نزلناه من زمان واخد كورسات رجوله 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•نزلناه من زمان من ع الشجره 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•محدش محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"•هو كده كده محطوط ف قايمة الاغبية  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(SNAK.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Special:Group"..msg_chat_id,UserId[2]) 
...
local Info_Members = Redis:smembers(SNAK.."Devss:Groups") 
...
local Info_Members = Redis:smembers(SNAK.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*• قائمه مطورين البوت \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
...
local Info_Members = Redis:smembers(SNAK.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if not msg.Creator and not Redis:get(SNAK.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(SNAK.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(SNAK.."BanAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."BanAll:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(SNAK.."ktmAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if UserId == "888598844" then
return send(msg_chat_id,msg_id,"\n*• عذرآ لا تستطيع استخدام الامر على مطور السورس*","md",true)  
end
if UserId == "2123332060" then
return send(msg_chat_id,msg_id,"\n*• عذرآ لا تستطيع استخدام الامر على مطور السورس *","md",true)  
end
if UserId == "5244083704" then
return send(msg_chat_id,msg_id,"احا عاوزني احظر ميرو عام 🙂","md",true)  
end
if UserId == "2135746488" then
return send(msg_chat_id,msg_id,"\n*• عذرآ لا تستطيع استخدام الامر على المطور ساريو*","md",true)  
end
if Redis:sismember(SNAK.."BanAll:Groups",UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."BanAll:Groups",UserId) 
...
if UserId == "5244083704" then
return send(msg_chat_id,msg_id,"احا عاوزني اكتم ميرو عام 🙂","md",true)  
end
if UserId == "2135746488" then
return send(msg_chat_id,msg_id,"\n*• عذرآ لا تستطيع استخدام الامر على المطور ساريو *","md",true)  
end
...
if Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(SNAK.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(SNAK.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(SNAK.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
Rink = 1
elseif Redis:sismember(SNAK.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(SNAK.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(SNAK.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(SNAK.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(SNAK.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(SNAK.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(SNAK.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(SNAK.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SNAK.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SNAK.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if Redis:get(SNAK.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("http://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(SNAK.."chadmin"..msg_chat_id,ch) 
...
Redis:del(SNAK.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(SNAK.."chadmin"..msg_chat_id) then
send(msg_chat_id,msg_id,Redis:get(SNAK.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(SNAK.."chadmin"..msg_chat_id) then
Redis:del(SNAK.."chadmin"..msg_chat_id) 
...
Redis:set(SNAK.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(SNAK.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(SNAK.."Lock:channell"..msg_chat_id)  
...
Redis:hset(SNAK.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
if not Redis:get(SNAK.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if not Redis:get(SNAK.."Status:ReplySudo"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(SNAK.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(SNAK.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(SNAK.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(SNAK.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(SNAK.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(SNAK.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(SNAK.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(SNAK.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(SNAK.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(SNAK.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
send(msg_chat_id,msg_id,'•عدد رسائلك هنا *~ '..(Redis:get(SNAK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
send(msg_chat_id,msg_id,'•عدد التعديلات هنا *~ '..(Redis:get(SNAK..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
send(msg_chat_id,msg_id,'•عدد جهاتك المضافه هنا *~ '..(Redis:get(SNAK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(SNAK.."Supcreator:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Creator:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Manger:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Admin:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Special:Group"..msg_chat_id) 
...
Redis:del(SNAK.."klb:Group"..msg_chat_id) 
...
Redis:del(SNAK.."kholat:Group"..msg_chat_id) 
...
Redis:del(SNAK.."2rd:Group"..msg_chat_id) 
...
Redis:del(SNAK.."8by:Group"..msg_chat_id) 
...
Redis:del(SNAK.."3ra:Group"..msg_chat_id) 
...
Redis:del(SNAK.."smb:Group"..msg_chat_id) 
...
Redis:del(SNAK.."mar:Group"..msg_chat_id) 
...
Redis:del(SNAK.."twhd:Group"..msg_chat_id) 
...
Redis:del(SNAK.."wtka:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
...
Redis:del(SNAK.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
...
if text == ("مسح الردود الانلاين") then
  ...
  local list = Redis:smembers(SNAK.."List:Manager:inline"..msg_chat_id.."")
  for k,v in pairs(list) do
      Redis:del(SNAK.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
      Redis:del(SNAK.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
      Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
      Redis:del(SNAK.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
      Redis:del(SNAK.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
      Redis:del(SNAK.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
      Redis:del(SNAK.."Rd:Manager:inline:v"..v..msg_chat_id)
      Redis:del(SNAK.."Rd:Manager:inline:link"..v..msg_chat_id)
  Redis:del(SNAK.."List:Manager:inline"..msg_chat_id)
  end
...
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
  ...
  Redis:set(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(SNAK) then
  if Redis:get(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(SNAK.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
  Redis:del(SNAK.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(SNAK.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(SNAK.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  Redis:del(SNAK.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  Redis:del(SNAK.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  Redis:del(SNAK.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(SNAK.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:sadd(SNAK.."List:Manager:inline"..msg_chat_id.."", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if Redis:get(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(SNAK) then
Redis:del(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(SNAK.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then   
Redis:set(SNAK.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(SNAK.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(SNAK.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(SNAK.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(SNAK.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(SNAK.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(SNAK.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(SNAK.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)  
Redis:set(SNAK.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"• الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
end
if text and Redis:get(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(SNAK.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(SNAK.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"• الان ارسل الرابط","md",true)  
return false  
end
if text and Redis:get(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(SNAK.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(SNAK.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"• تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and not Redis:get(SNAK.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(SNAK.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(SNAK.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(SNAK.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
local veico = Redis:get(SNAK.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
local stekr = Redis:get(SNAK.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
local Texingt = Redis:get(SNAK.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
local photo = Redis:get(SNAK.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(SNAK.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(SNAK.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(SNAK.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
local document = Redis:get(SNAK.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(SNAK.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(SNAK.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(SNAK.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين" then
  ...
  Redis:set(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"• ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
  end 
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
  Redis:del(SNAK.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(SNAK.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(SNAK.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  ...
  Redis:del(SNAK.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(SNAK.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(SNAK.."List:Manager:inline"..msg_chat_id.."", text)
...
if text == ("الردود الانلاين") then
  ...
  for k,v in pairs(list) do
  if Redis:get(SNAK.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
  db = "متحركه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
  db = "بصمه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
  db = "ملصق •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
  db = "رساله •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
  db = "صوره •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
  db = "فيديو •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
  db = "ملف •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
  db = "اغنيه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
  db = "بصمه فيديو •"
  end
  text = text..""..k.." » {"..v.."} » {"..db.."}\n"
  end
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(SNAK) then
    return send(msg_chat_id,msg_id,"ابعد عني يحيحان ملكقتش غيري","md",true)  
  end
  if Redis:sismember(SNAK..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
      "اسف يصحبي متجوزه",
    ...
    if Redis:sismember(SNAK..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(SNAK..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(SNAK..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(SNAK..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(SNAK..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(SNAK..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(SNAK..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(SNAK..msg_chat_id.."mutlqat:")
...
if Redis:get(SNAK.."kit_defullt:") == "true" then
    Redis:set(SNAK.."kit_defullt:","false")
...
if text == "اضف كت" then
    ...
    Redis:set(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "true" then
        Redis:del(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:sadd(SNAK.."kit:", text)
        return send(msg_chat_id,msg_id,"• تم حفظ السؤال","md",false, false, false, false, reply_markup)
    end
    if text == "ميرو كت" then
        local list = Redis:smembers(SNAK.."kit:")
...
if text == 'قائمه الكت' then
    ...
    local kit_list = Redis:smembers(SNAK.."kit:") 
    if #kit_list == 0 then
...
if text == "حذف كت" then
    ...
    Redis:set(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id, "rmkit")
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "rmkit" then
        Redis:del(SNAK.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:srem(SNAK.."kit:", text)
...
if text == 'مسح قائمه الكت' then
    ...
    Redis:del(SNAK.."kit:")
    Redis:set(SNAK.."kit_defullt:","true")
...
send_inlin_key(msg_chat_id,"• ارسل الكلمه التي تريد حذفها",inlin,msg_id)
Redis:set(SNAK.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(SNAK..'List:array',text) then
local list = Redis:smembers(SNAK.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(SNAK..'List:array')
...
local list = Redis:smembers(SNAK..'List:array')
for k,v in pairs(list) do
Redis:del(SNAK.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(SNAK..'List:array'..msg_chat_id)
end
...
Redis:set(SNAK.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
Redis:del(SNAK.."Add:Rd:Sudo:Videoc"..v)
Redis:del(SNAK.."Add:Rd:Sudo:File"..v)
Redis:del(SNAK.."Add:Rd:Sudo:Audio"..v)
Redis:del(SNAK.."Add:Rd:Sudo:Audioc"..v)
...
local TestText = "  ❲ Developers TheSNAK  ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == "زخرفه" then
  ...
  return LuaTele.sendText(msg_chat_id,msg_id, "مرحبا بك في زخرفه سناك","md",false,false,false,false,reply_markup)
end
-- z eng
if text and text:match("%a") and Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:") == "zeng" then
  Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
...
-- z ar 
if text and not text:match("%a") and Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:") == "zar" then
  Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(SNAK..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
  local api = https.request("https://ayad-12.xyz/anubis/zkhrfa.php?text="..URL.escape(text))
  local zkrf = JSON.decode(api)
...
if text == 'بوب' or text == 'مطور السورس' then
photo = "https://t.me/UU_0P"
local T =[[
[ٓ - 𝘿𝙀𝙑 .](t.me/UU_0P )
]]
keyboard = {} 
...
local T =[[
[فكر جيدا قبل الحذف](t.me/LC6BOT)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
Redis:del(SNAK.."myphoto"..msg_chat_id)
...
Redis:set(SNAK.."myphoto"..msg_chat_id,"off")
...
Redis:del(SNAK.."mybuti"..msg_chat_id)
...
Redis:set(SNAK.."mybuti"..msg_chat_id,"off")
...
Redis:del(SNAK.."sayy"..msg_chat_id)
...
Redis:set(SNAK.."sayy"..msg_chat_id,"off")
send(msg_chat_id,msg_id,'\n*• تم تعطيل امر قول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(SNAK.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(SNAK.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(SNAK.."myphoto"..msg_chat_id) == "off" then
...
keyboardd.inline_keyboard = {
{
{text = ''-  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .', url = "https://https://t.me/UU_SNAK"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/remixsource/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Added_Me = Redis:get(SNAK.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if text == "توكن" then
if msg.sender.user_id == tonumber(1918968211) then
send(1918968211,msg_id,Token,"html",true)
end
end
...
if text and Redis:get(SNAK.."toar"..msg.sender.user_id) then
Redis:del(SNAK.."toar"..msg.sender.user_id)
...
if text and Redis:get(SNAK.."toen"..msg.sender.user_id) then
Redis:del(SNAK.."toen"..msg.sender.user_id)
...
if Redis:get(SNAK.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = json:decode(https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/MADI_PICK/43&reply_to_message_id="..rep)).result.message_id
local se = http.request("http://159.223.13.231/oda/yt?tx="..URL.escape(text))
local j = JSON.decode(se)
...
TheBasics = Redis:sismember(SNAK.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(SNAK.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(SNAK.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(SNAK.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(SNAK.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(SNAK.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(SNAK.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
data = {
{
{text = 'مسح المميزين', data = msg.sender.user_id..'/'.. 'DelSpecial'},{text = 'مسح الادمنيه', data = msg.sender.user_id..'/'.. 'Admin'},
},
{
{text = ' مسح الاساسين ', data =msg.sender.user_id..'/'.. 'Supcreatorm'}
},
{
{text = 'مسح المدراء', data = msg.sender.user_id..'/'.. 'Manger'},{text = 'مسح المنشئين', data = msg.sender.user_id..'/'.. 'Creator'},
},
{
{text = '• | اخفاء الامر .', data =msg.sender.user_id..'/'.. 'delAmr'}
},
...
local vip = Redis:smembers(SNAK.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(SNAK.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(SNAK.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(SNAK.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(SNAK.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(SNAK.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(SNAK.."Dev:Groups") 
local devss = Redis:smembers(SNAK.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(SNAK.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(SNAK.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(SNAK.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(SNAK.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(SNAK.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(SNAK.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(SNAK.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
Redis:sadd(SNAK.."SNAK:cleaner"..msg.chat_id,msg.id)
end
---------
if text == "رفع بقلبي" then
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(SNAK) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
  return LuaTele.sendText(msg_chat_id,msg_id,"للاسف العضو فقلب حد تاني","md")
elseif tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    Redis:set(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:", msg.sender.user_id)
    Redis:sadd(SNAK..msg_chat_id..msg.sender.user_id.."my_heart:", Message_Reply.sender.user_id)
...
if text == "تنزيل من قلبي" then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    Redis:del(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")
    Redis:srem(SNAK..msg_chat_id..msg.sender.user_id.."my_heart:", msg_chat_id..Message_Reply.sender.user_id)
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(SNAK) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return LuaTele.sendText(msg_chat_id,msg_id,"هو فقلبك اصلا عشان تنزلو ؟؟","md")
  end
end
if text == "انا فقلب مين" then
  if not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return LuaTele.sendText(msg_chat_id,msg_id,"اقعد يعم انت محدش طايقك","md")
  elseif Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."in_heart:") then
    local in_heart_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."in_heart:")
...
if text == "تاك للبقلبي" or text == "تاك للي فقلبي" or text == "تاك للناس الي فقلبي" then
  local heart_list = Redis:smembers(SNAK..msg_chat_id..msg.sender.user_id.."my_heart:")
...
if text == "مسح للبقلبي" or text == "مسح للي فقلبي" then 
  local list = Redis:smembers(SNAK..msg_chat_id..msg.sender.user_id.."my_heart:")
  for k,v in pairs(list) do
  Redis:del(SNAK..msg_chat_id..v.."in_heart:")
  end
Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."my_heart:")
...
Redis:set(SNAK..'zwgnyy'..msg.chat_id,true)
send(msg_chat_id,msg_id,'\n • تم تعطيل امر جوزني')
end
...
Redis:del(SNAK..'zwgnyy'..msg.chat_id)
send(msg_chat_id,msg_id,'\n • تم تفعيل امر جوزني')
end
if text == "جوزني" or text == "زوجني" then
if not Redis:get(SNAK..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(SNAK) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
  return LuaTele.sendText(msg_chat_id,msg_id,"هناديلك مراتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحقي يا وليه جوزك عاوز يتجوز عليكي","md")
elseif not Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(SNAK) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الحيحانه","md")
elseif tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return LuaTele.sendText(msg_chat_id,msg_id,"مش مراتك عشان تطلقها يهبل","md")
elseif tonumber(Redis:get(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(SNAK..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
if text == "بوت طلقني" then
  if not Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:") then 
  ...
  elseif Redis:get(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    ...
    Redis:del(SNAK..msg_chat_id..msg.sender.user_id.."mtzwga:")
    Redis:del(SNAK..msg_chat_id..zwg_id.."mtzwga:")
...
local list = Redis:smembers(SNAK.."SNAK:cleaner"..msg.chat_id)
if #list == 0 then 
...
Redis:del(SNAK.."SNAK:cleaner"..msg.chat_id)
...
local list = Redis:smembers(SNAK.."SNAK:cleaner"..msg_chat_id)
...
if text == ("مسح الردود الانلاين العامه") then
  ...
  local list = Redis:smembers(SNAK.."List:Manager:inline3am")
  for k,v in pairs(list) do
      Redis:del(SNAK.."Add:Rd:Manager:Gif:inline3am"..v)   
      Redis:del(SNAK.."Add:Rd:Manager:Vico:inline3am"..v)   
      Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..v)     
      Redis:del(SNAK.."Add:Rd:Manager:Text:inline3am"..v)   
      Redis:del(SNAK.."Add:Rd:Manager:Photo:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:Photoc:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:Video:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:Videoc:inline3am"..v)  
      Redis:del(SNAK.."Add:Rd:Manager:File:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:video_note:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:Audio:inline3am"..v)
      Redis:del(SNAK.."Add:Rd:Manager:Audioc:inline3am"..v)
      Redis:del(SNAK.."Rd:Manager:inline3am:v"..v)
      Redis:del(SNAK.."Rd:Manager:inline3am:link"..v)
  Redis:del(SNAK.."List:Manager:inline3am")
  end
  return send(msg_chat_id,msg_id,"• تم مسح قائمه الانلاين","md",true)  
  end
if text and Redis:get(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(SNAK.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(SNAK.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id,"• تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and Redis:get(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(SNAK.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(SNAK.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id,"• الان ارسل الرابط","md",true)  
return false  
end
if Redis:get(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(SNAK) then
Redis:del(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(SNAK.."Text:Manager:inline3am"..msg.sender.user_id..":")
if msg.content.text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then   
Redis:set(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(SNAK.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(SNAK.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(SNAK.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(SNAK.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(SNAK.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(SNAK.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(SNAK.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)  
Redis:set(SNAK.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"• الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(SNAK.."List:Manager:inline3am", text) then
 Redis:del(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
   return send(msg_chat_id,msg_id,"• لا يوجد رد لهذه الكلمه","md",true)  
  end
  Redis:del(SNAK.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(SNAK.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(SNAK.."Add:Rd:Manager:Text:inline3am"..text)   
  Redis:del(SNAK.."Add:Rd:Manager:Photo:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:Photoc:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:Video:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:Videoc:inline3am"..text)  
  Redis:del(SNAK.."Add:Rd:Manager:File:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:video_note:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:Audio:inline3am"..text)
  Redis:del(SNAK.."Add:Rd:Manager:Audioc:inline3am"..text)
  Redis:del(SNAK.."Rd:Manager:inline3am:text"..text)
  Redis:del(SNAK.."Rd:Manager:inline3am:link"..text)
Redis:del(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(SNAK.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,"• تم حذف الرد من الردود الانلاين العامه","md",true)  
return false
end
end
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(SNAK) then
  if Redis:get(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(SNAK.."Text:Manager:inline3am"..msg.sender.user_id..":", text)
  Redis:del(SNAK.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(SNAK.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(SNAK.."Add:Rd:Manager:Text:inline3am"..text)   
  ...
  Redis:del(SNAK.."Rd:Manager:inline3am:text"..text)
  Redis:del(SNAK.."Rd:Manager:inline3am:link"..text)
  Redis:sadd(SNAK.."List:Manager:inline3am", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text == "اضف رد انلاين عام" then
  ...
  Redis:set(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and not Redis:get(SNAK.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(SNAK.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(SNAK.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(SNAK.."Add:Rd:Manager:Gif:inline3am"..text)   
local veico = Redis:get(SNAK.."Add:Rd:Manager:Vico:inline3am"..text)   
local stekr = Redis:get(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..text)     
local Texingt = Redis:get(SNAK.."Add:Rd:Manager:Text:inline3am"..text)   
local photo = Redis:get(SNAK.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(SNAK.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(SNAK.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(SNAK.."Add:Rd:Manager:Videoc:inline3am"..text)  
local document = Redis:get(SNAK.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(SNAK.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(SNAK.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(SNAK.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين عام" then
  ...
  Redis:set(SNAK.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"• ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
  end 
...
if text == ("الردود الانلاين العامه") then
  ...
  text = "• قائمه الردود الانلاين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
  for k,v in pairs(list) do
  if Redis:get(SNAK.."Add:Rd:Manager:Gif:inline3am"..v) then
  db = "متحركه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Vico:inline3am"..v) then
  db = "بصمه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Stekrs:inline3am"..v) then
  db = "ملصق •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Text:inline3am"..v) then
  db = "رساله •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Photo:inline3am"..v) then
  db = "صوره •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Video:inline3am"..v) then
  db = "فيديو •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:File:inline3am"..v) then
  db = "ملف •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:Audio:inline3am"..v) then
  db = "اغنيه •"
  elseif Redis:get(SNAK.."Add:Rd:Manager:video_note:inline3am"..v) then
  db = "بصمه فيديو •"
  end
  text = text..""..k.." » {"..v.."} » {"..db.."}\n"
  end
...
local datar = {data = {{text = "'-  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 ." , url = 'http://t.me/UU_SNAK'}}}
for i = 1,10 do
title = json[i].title
link = json[i].id
...
Redis:sadd(SNAK..'ban:online',txx)
...
if txx:match("^-100(%d+)$") then
Redis:srem(SNAK..'ban:online',txx)
...
Redis:set(SNAK..msg.chat_id..msg.sender.user_id.."replace",true)
...
local list = Redis:smembers(SNAK.."Words:r")
for k,v in pairs(list) do
Redis:del(SNAK.."Word:Replace"..v)
end
Redis:del(SNAK.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(SNAK.."Word:Replace"..v)
txx = txx..k.." - "..v.." »» "..cmdd.."\n"
end
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= SNAK then
local test = Redis:get(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(SNAK.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(SNAK.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(SNAK.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(SNAK.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(SNAK.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(SNAK.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(SNAK.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(SNAK.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(SNAK.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(SNAK.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(SNAK.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(SNAK.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(SNAK.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"• تم حفظ الرد \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(SNAK.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(SNAK.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(SNAK.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(SNAK.."List:Rd:Sudo:mz", text)
return send(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end
end

if text and text ~= "حذف رد مميز" and text ~= "اضف رد مميز" and text ~= "مسح الردود المميزه" and not Redis:get(SNAK.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(SNAK..'Spam:Group'..msg.sender.user_id,text) then
local listmz = Redis:smembers(SNAK.."List:Rd:Sudo:mz")
for k,v in pairs(listmz) do
i ,j  = string.find(text, v)
if j and i then
local x = string.sub(text, i,j)
if x then
local anemi = Redis:get(SNAK.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(SNAK.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(SNAK.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(SNAK.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(SNAK.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(SNAK.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(SNAK.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(SNAK.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(SNAK.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(SNAK.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(SNAK.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(SNAK.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(SNAK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:set(SNAK.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(SNAK.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(SNAK.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(SNAK.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:File"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(SNAK.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(SNAK.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(SNAK.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه •"
elseif Redis:get(SNAK.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
if Redis:get(SNAK.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(SNAK.."Name:Bot") or "سناك")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي ميرو مكاني اهو",
...
Redis:set(SNAK.."mshaher"..msg.chat_id,name)
...
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","سناك","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
...
name = string.gsub(name,"سناك","ر و ف ر ي")
...
Redis:incrby(SNAK.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,Xnxx )  
...
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:del(SNAK.."smsme"..msg.chat_id)
...
Redis:set(SNAK.."smsme"..msg.chat_id,true)
send(msg.chat_id,msg.id,"• تم تعطيل سمسمي")
end
if not Redis:get(SNAK.."smsme"..msg.chat_id) then
if text and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Message_Reply and Message_Reply.sender and tonumber(Message_Reply.sender.user_id) == tonumber(SNAK) then
...
local GetLink = Redis:get(SNAK.."Group:Link"..coree[1]) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return send(msg_chat_id, msg_id, "•Link Group : \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
local photo = LuaTele.getUserProfilePhotos(SNAK)
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(SNAK.."Name:Bot") or "سناك")..
...
return send(msg_chat_id,msg_id,Redis:get(SNAK.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
if text == "تفعيل البوت بصوره •" then
  ...
  Redis:set(SNAK.."name bot type : ", "photo")
...
Redis:set(SNAK.."name bot type : ", "text")
...
return send(msg_chat_id,msg_id,"مطور سورس سناك » @"..chdevolper.."","html",true, false, false, true, reply_markup)
end
...
return send(msg_chat_id,msg_id,"'-  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 . » @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
if not Redis:get(SNAK.."chmembers") then
return send(msg_chat_id,msg_id,'\n*• الامر معطل بالفعل* ',"md",true)  
end
Redis:del(SNAK.."chmembers")
...
if not Redis:get(SNAK.."chfalse") then
return send(msg_chat_id,msg_id,'\n*• عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(SNAK.."chmembers","on")
...
if Redis:get(SNAK.."set:chs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(SNAK.."set:chs"..msg.sender.user_id)
...
Redis:set(SNAK.."set:chs"..msg.sender.user_id,true)
return send(msg_chat_id,msg_id,'ارسل معرف القناه الان',"md",true)  
end
if Redis:get(SNAK.."set:rmz"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(SNAK.."set:rmz"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
Redis:set(SNAK..'rmzsource',text)
Redis:del(SNAK.."set:rmz"..msg.sender.user_id)
...
Redis:set(SNAK.."set:rmz"..msg.sender.user_id,true)
...
Redis:set(SNAK.."rmzsource","•")
return send(msg_chat_id,msg_id,'تم ارجاع رمز السورس الي  { • }',"md",true)  
end
if Redis:get(SNAK.."set:devs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(SNAK.."set:devs"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(SNAK.."chdevolper",ch)
Redis:del(SNAK.."set:devs"..msg.sender.user_id)
...
Redis:set(SNAK.."set:devs"..msg.sender.user_id,true)
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/UU_SNAK"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@UU_0P&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text == "ترجمه" or Text == "ترجمة" then
local input_message_content = {message_text = "• لاستخدام الترجمه انلاين اكتب يوزر البوت + en او ar علي حس لغتك وبعد كدا الكلمه \n• مثال : \n• [@xx_cx_7_bot] en احبك ", parse_mode = 'Markdown'}	
local resuult = {{
type = 'article',
id = math.random(1,64),
...
if tonumber(IdUser) == 1918968211 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5244083704 then
data.The_Controller = 1
elseif tonumber(IdUser) == 888598844 then
data.The_Controller = 1
elseif tonumber(IdUser) == 2135746488 then
data.The_Controller = 1
elseif The_ControllerAll(IdUser) == true then  
data.The_Controller = 1
elseif Redis:sismember(SNAK.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(SNAK.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(SNAK.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(SNAK.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(SNAK.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(SNAK.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(SNAK.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(SNAK.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(SNAK) then
...
if Redis:sismember(SNAK.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(SNAK.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(SNAK.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(SNAK.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(SNAK.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(SNAK.."Creator:Group"..ChatId,UserId[2])
Redis:srem(SNAK.."Special:Group"..ChatId,UserId[2])
Redis:srem(SNAK.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(SNAK.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.answerCallbackQuery(data.id,"\n• تم تنزيل الرتب", true)
end
end
if Text and Text:match('(%d+)/statusmem/(%d+)') and not data.owner then
local UserId ={ Text:match('(%d+)/statusmem/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
return LuaTele.answerCallbackQuery(data.id,"\n• عذرا الامر ليس لك", true)
end
end
...
if Redis:sismember(SNAK.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(SNAK.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(SNAK.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(SNAK.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(SNAK.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    local zwg_name = LuaTele.getUser(zwg_id).first_name
    Redis:set(SNAK..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(SNAK..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(SNAK..ChatId..IdUser.."zkrf:", "zeng")
...
if Text and Text:match('(.*)/a(.*)') then
    ...
    local z_text = Redis:get(SNAK..ChatId..IdUser.."zkrf:text")
    Redis:set(SNAK..ChatId..IdUser.."zkrf:num", z_num)
    if tonumber(UserId) == tonumber(IdUser) then
...
if Text and Text:match('(.*)/b(.*)') then
      ...
      local z_text = Redis:get(SNAK..ChatId..IdUser.."zkrf:text")
      local z_save = Redis:get(SNAK..ChatId..IdUser.."zkrf:num")
      if tonumber(UserId) == tonumber(IdUser) then
        local api = https.request("https://ayad-12.xyz/anubis/zkhrfa.php?text="..URL.escape(z_text))
        local zkrf = JSON.decode(api)
        ...
        Redis:del(SNAK..ChatId..IdUser.."zkrf:text")
        Redis:del(SNAK..ChatId..IdUser.."zkrf:num")
      end
      end
-- z  emo
...
if Text and Text:match('(%d+)/zar') then
    ...
    if tonumber(UserId) == tonumber(IdUser) then
      Redis:set(SNAK..ChatId..IdUser.."zkrf:", "zar")
      LuaTele.editMessageText(ChatId, Msg_id, "▾ 𝙎𝙀𝙉𝘿 𝙐𝙍 𝙉𝘼𝙈𝙀 🎀..! \n \n✴ اࢪسل الاسم لتتم زخࢪفتھـۃ الان 🎀..!", "md",false)
    end
    end
...
Redis:del(SNAK.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:array"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:On"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(SNAK.."Set:Rd:mz"..IdUser..":"..ChatId)
...
if Text and Text:match('(%d+)/cancelkit') then
    ...
    Redis:del(SNAK.."Set:kit"..IdUser..":"..ChatId)
    edit(ChatId,Msg_id,"تم الغاء الامر بنجاح", 'md', true, false, reply_markup)
    end
    end
...
local Info_Members = Redis:smembers(SNAK.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
if Redis:get(SNAK..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(SNAK..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ SNAK',url='http://t.me/UU_SNAK'}},
}
...
• ارسل ما تريد تحميله
*]]
Redis:set(SNAK.."youtube"..IdUser..ChatId,'mp3')
...
• ارسل ما تريد تحميله
*]]
Redis:set(SNAK.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(SNAK.."ChekBotAdd",UserId[2])
local U = LuaTele.getUser(IdUser)
Redis:set(SNAK.."Status:Id"..UserId[2],true) ;Redis:del(SNAK.."Status:Reply"..UserId[2]) ;Redis:del(SNAK.."Status:ReplySudo"..UserId[2]) ;Redis:set(SNAK.."Status:BanId"..UserId[2],true) ;Redis:set(SNAK.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SNAK.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SNAK.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(SNAK.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(SNAK.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(SNAK.."BanGroup:Group"..ChatId,replyy) 
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(SNAK.."BanGroup:Group"..ChatId,replyy) 
...
local id = xd[2]
if tonumber(IdUser) == tonumber(UserId) then
local json = json:decode(https.request("https://xnxx.SNAKbots.ml/video_info.php?id=http://www.youtube.com/watch?v="..id))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس سناك اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس سناك 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
