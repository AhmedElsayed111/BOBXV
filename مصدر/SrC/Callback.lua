...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '- ᴀʟᴘʜᴀ ғᴀᴄᴛᴏʀʏ .',url="t.me/SOR_44bot"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
{
{text = 'مطور الملف', url = 'http://t.me/b100q'},
},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'ᏴᎪᏟᏦ', callback_data=IdUser.."/zDRGd"},
},
}
local mm = Msg_id/2097152/0.5
...
{
{text = '- ᴀʟᴘʜᴀ .', url = "http://t.me/SORALPHA"}
},
{
