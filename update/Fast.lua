...
chsource = Redis:get(Fast..'chsource') or "UU_SNAK"
devsource = Redis:get(Fast..'devsource') or "UU_0B"
devsource2 = Redis:get(Fast..'devsource') or "Zeus_cv1"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5845181263,1918968211}
...
xname =  (Redis:get(Fast.."Name:Bot") or "ابـاظـة") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5845181263) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5845181263) then
...
if tonumber(senderr) == 5845181263 then
msg.Name_Controller = 'مـلـك الـتـلـجـرام 𓋖'
msg.The_Controller = 1
elseif tonumber(senderr) == 1918968211 then
msg.Name_Controller = 'مطوري الغالي  '
msg.The_Controller = 1
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "سناك")
...
elseif tonumber(msg.sender_id.user_id) == tonumber(5845181263)  then 
Redis:set(Fast.."AddSudosNew"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"✧ ارسل معرف المطور الاساسي مع @........","md",true)
else
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5845181263) then
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "ابـاظـة")
if text then
...
data = {
{
{text = 'ᴅᴇᴠ 𝙴𝙻𝙱𝙾𝙱', url = 't.me/UU_0B'}, 
},
}
}
return send(msg_chat_id,msg_id,"[𝙴𝙻𝙱𝙾𝙱](tg://user?id=1918968211)","md",true, false, false, true, reply_markup)
end
...
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = '𝙎𝙉𝘼𝙆 𝙁𝘼𝘾𝙏𝙊𝙍𝙔 𐂡', url = 'https://t.me/UU_TBOT'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[𝙎𝙉𝘼𝙆 𝙁𝘼𝘾𝙏𝙊𝙍𝙔 𐂡](https://t.me/UU_TBOT)","md",true, false, false, true, reply_markup)
  end
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس سناك\nاكتب اسمك الان :',"md",true)  
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5845181263) then
local txx = "\n"
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@UU_SNAK")
sleep(1)
...
data = {
{
{text = '𝙙𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧', url = 't.me/'..devsource},{text = '𝙙𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧', url = 't.me/'..devsource2},
},
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙨𝙣𝙖𝙠', url = 'http://t.me/'..chsource..''}, 
},
{
{text = '- لـصـنـع بـوت مـجـانـي .',url='https://t.me/UU_TBOT'},
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[W𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 𝙨𝙣𝙖𝙠](t.me/UU_SNAK) 
...
if text == (Redis:get(Fast.."Name:Bot") or "سناك") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "سناك")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني 🥺🌚💋",
