...
data = {
{
{text = ' 𝙎𝙉𝘼𝙆 ', url = 'http://t.me/'..chsource..''}, 
},
}
}
...
if tonumber(Message_Edit.sender_id.user_id) == 1918968211 then
...
return edit(ChatId,Msg_id, ELBOB, 'md', true, false, reply_markup)
end
end
...
keyboard.inline_keyboard = {
{
{text = 'زوجه آخري -', callback_data=IdUser.."/wife"},
},
{
...
local nice = "💍 تم الزواج بنجاح ✅\n- فلوس المهر "..coniss.." جنيه 💰\n- عدد فلوس حسابك "..ballancee.." جنيه 💰"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/212",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- دعا ربه 🎮', callback_data=IdUser.."/utrue"},
},
{
{text = '- لم يدعي ربه 🎮', callback_data=IdUser.."/make"},
},
}
local mm = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/213",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- نهر الكونغو 🎮', callback_data=IdUser.."/make"},
},
{
{text = '- نهر النيل 🎮', callback_data=IdUser.."/utrffue"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/214",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف الباء 🎮', callback_data=IdUser.."/make"},
},
{
{text = '- حرف الام 🎮', callback_data=IdUser.."/kdks"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/215",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف المبائب 🎮', callback_data=IdUser.."/make"},
},
{
{text = '- حرف العزائم 🎮', callback_data=IdUser.."/nsbkjn"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/216",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف انسات 🎮', callback_data=IdUser.."/vzsnsn"},
},
{
{text = '- حرف سيدات 🎮', callback_data=IdUser.."/make"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/nsnsbk"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/217",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف الصاروخ 🎮', callback_data=IdUser.."/make"},
},
{
{text = '- حرف المنجنيق 🎮', callback_data=IdUser.."/xavhhn"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/218",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف الاسد 🎮', callback_data=IdUser.."/vabsjsbm"},
},
{
{text = '- حرف النمر 🎮', callback_data=IdUser.."/make"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/219",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- 6 🎮', callback_data=IdUser.."/qagwf"},
},
{
{text = '- 5 🎮', callback_data=IdUser.."/make"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/220",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف مهر 🎮', callback_data=IdUser.."/bsbsjdn"},
},
{
{text = '- حرف جرو 🎮', callback_data=IdUser.."/make"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/221",caption = '*≭ اختار الاجابه الصحيحه من الازار -*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- حرف الثعلب 🎮', callback_data=IdUser.."/make"},
},
{
{text = '- حرف الدلفين 🎮', callback_data=IdUser.."/endgam"},
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/nsponsbk"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/bsbshxbp"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/nvacgk"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/caxbb"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/nvakjcgk"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/zanakaown"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/wbsnsk"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- السؤال الثاني -', callback_data=IdUser.."/question"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
keyboard.inline_keyboard = {
{
{text = '- الطرد', callback_data=IdUser.."/Banme"},{text = '- الحظر', callback_data=IdUser.."/theban"},
},
{
{text = '- التقييد', callback_data=IdUser.."/tiual"},{text = '- الكتم', callback_data=IdUser.."/kautm"},
},
{
{text = '- لا اريد عقوبه', callback_data=IdUser.."/rival"},
},
}
local mm = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/EditMessagecaption?chat_id='..ChatId..'&message_id='..mm..'&caption=' .. URL.escape(txxt).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/XQCNH/252",caption = '*╭───── •*[ ⍟ ](t.me/UU_SNAK )*• ─────╮\n├ ⍟  قم بختيار نوع الاغنيه 🎧\n╰───── •*[ ⍟ ](t.me/UU_SNAK )*• ─────╯\n✦ 𝙎𝙉𝘼𝙆 𝙁𝘼𝘾𝙏𝙊𝙍𝙔 ⏎*\n',parse_mode = "Markdown"}     
...
{
{text = '🎧 راب', callback_data=IdUser.."/kanele"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'عصام صاصا -', callback_data=IdUser.."/Essam"},{text = '- سامر المدني', callback_data=IdUser.."/samer"},
},
{
{text = 'حمو الطيخا -', callback_data=IdUser.."/teka"},{text = '- حمو بيكا', callback_data=IdUser.."/bika"},
},
{
{text = 'مسلم -', callback_data=IdUser.."/moslem"},
},
{
{text = 'حوده بندق -', callback_data=IdUser.."/bondk"},{text = '- محمد رمضان', callback_data=IdUser.."/ramdan"},
},
{
{text = 'محمد منير -', callback_data=IdUser.."/moner"},{text = '- عبدالباسط حموده', callback_data=IdUser.."/hamoda"},
},
{
{text = 'تامر حسني -', callback_data=IdUser.."/tamer"},{text = '- عمر دياب ', callback_data=IdUser.."/diab"},
},
{
{text = 'عمار حسني -', callback_data=IdUser.."/amar"},{text = '- تامر عاشور ', callback_data=IdUser.."/ashor"},
},
{
{text = 'شرين -', callback_data=IdUser.."/shren"},{text = '- اصاله', callback_data=IdUser.."/asala"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'فيصل عبد الكريم -', callback_data=IdUser.."/mhrgit"},{text = '- ياس خضر', callback_data=IdUser.."/rmuisy"},
},
{
{text = 'جاسم الخياط -', callback_data=IdUser.."/hjuyn"},{text = '- نور الزين', callback_data=IdUser.."/afruh"},
},
{
{text = 'اسراء الاصيل -', callback_data=IdUser.."/hjuyn"},{text = '- بلقيس فالح', callback_data=IdUser.."/afruh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'بهاء ال يوسف -', callback_data=IdUser.."/mhrgit"},{text = '- صباح فخري', callback_data=IdUser.."/rmuisy"},
},
{
{text = 'ساريا سواس -', callback_data=IdUser.."/hjuyn"},{text = '- احمد ابراهيم', callback_data=IdUser.."/afruh"},
},
{
{text = 'علي الديك -', callback_data=IdUser.."/hjuyn"},{text = '- حسين الديك', callback_data=IdUser.."/afruh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'الثمن -', callback_data=IdUser.."/mhrgit"},{text = '- حبها واعشقها', callback_data=IdUser.."/rmuisy"},
},
{
{text = 'حرقت قلبي -', callback_data=IdUser.."/hjuyn"},{text = '- الشهيره', callback_data=IdUser.."/afruh"},
},
{
{text = 'اذربيجان -', callback_data=IdUser.."/hjuyn"},{text = '-  اجمع الازهار', callback_data=IdUser.."/afruh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'ابراهيم الحكمي -', callback_data=IdUser.."/mhrgit"},{text = '- خالد عبدالرحمن', callback_data=IdUser.."/rmuisy"},
},
{
{text = 'ماجد المهندس -', callback_data=IdUser.."/hjuyn"},{text = '- راشد الماجد', callback_data=IdUser.."/afruh"},
},
{
{text = 'طلال مداح -', callback_data=IdUser.."/hjuyn"},{text = '- جابر الكاسر', callback_data=IdUser.."/afruh"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'The Weekend -', callback_data=IdUser.."/mhrgit"},{text = '-  Take My Breath', callback_data=IdUser.."/rmuisy"},
},
{
{text = 'Silk Sonic -', callback_data=IdUser.."/hjuyn"},{text = '- Leave The Door Open', callback_data=IdUser.."/afruh"},
},
{
{text = 'Lil Nas X -', callback_data=IdUser.."/hjuyn"},{text = '- Call Me By Your Name', callback_data=IdUser.."/afruh"},
},
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/229",caption = '*• اختار اغنيه من اغاني عصام صاصا\n√*',parse_mode = "Markdown"}     
local UserInfo = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'حلبه فيها مصارعين -', callback_data=IdUser.."/naked"},{text = '- وسط دموع وجراح ', callback_data=IdUser.."/Center"},
},
{
{text = 'عالم اشرار -', callback_data=IdUser.."/folded"},
},
{
{text = 'انا ابن ابويا وامي -', callback_data=IdUser.."/Iamson"},{text = '- معرفش اخاف من حد', callback_data=IdUser.."/Inow"},
},
{
{text = '- كوبايه لاتيه', callback_data=IdUser.."/Angry"},{text = 'بتاع التوكتوك -', callback_data=IdUser.."/latte"},
},
{
...
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/785",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..Mostafa.."&media="..JSON.encode(ELBOB).."&reply_markup="..JSON.encode(keyboard))
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/791",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/788",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/793",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/789",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/792",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/787",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ ??𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/DEV_ELBOB/258",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/786",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/Essam"},
...
-- بدايه سامر المدني --
if Text and Text:match('(%d+)/samer') then
local UserId = Text:match('(%d+)/samer')
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/229",caption = '*• اختار من اغاني سامر المدني\n√*',parse_mode = "Markdown"}     
local UserInfo = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مش تمام غدارين -', callback_data=IdUser.."/samer1"},{text = '- خوخه ', callback_data=IdUser.."/samer2"},
},
{
{text = 'ياريته كان جبهم  -', callback_data=IdUser.."/samer3"},
},
{
{text = 'مرحب اخصامي هلا -', callback_data=IdUser.."/samer4"},{text = '- الو ثانيه هدخلو', callback_data=IdUser.."/samer5"},
},
{
{text = 'رجوع -', callback_data=IdUser.."/Egypt"},
},
...
if Text and Text:match('(%d+)/samer1') then
local UserId = Text:match('(%d+)/samer1')
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/796",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/samer"},
},
{
{text = 'القائمه الرئيسيه -', callback_data=IdUser.."/back"},
},
...
if Text and Text:match('(%d+)/samer2') then
local UserId = Text:match('(%d+)/samer2')
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/796",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
...
if Text and Text:match('(%d+)/samer4') then
local UserId = Text:match('(%d+)/samer4')
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/797",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/samer"},
...
if Text and Text:match('(%d+)/samer5') then
local UserId = Text:match('(%d+)/samer5')
if tonumber(IdUser) == tonumber(UserId) then
local Jabwa = bot.getUser(IdUser)
ELBOB ={type = "audio",media = "https://t.me/hhhbobxv/798",caption = '≭ بواسطة ⇿ '..Jabwa.first_name..'\n≭ 𝙱𝙾𝚃 ➻ @'..UserBot..'\n≭ 𝙲𝙷 ➻ @UU_SNAK\nتم تحميل الاغنيه بنجاح ✅\n',parse_mode = "html"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رجوع -', callback_data=IdUser.."/samer"},
...
local Text =' ≭ قم باستعمال الازرار لرفع العضو ⇞⇟\n ≭ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'UU_SNAK')..')'
if tonumber(IdUser) == tonumber(1918968211) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id},{text="رفع مطور",data=IdUser..":SetSudoBot:"..UserInfo.id}},{{text="رفع مطور ثانوي",data=IdUser..":SetSecondSudo:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif tonumber(IdUser) == tonumber(1918968211) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id},{text="رفع مطور",data=IdUser..":SetSudoBot:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Dev:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text="رفع مالك",data=IdUser..":SetOwner:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text="رفع منشئ اساسي",data=IdUser..":SetBasicConstructor:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."SuperCreator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id},{text="رفع مدير",data=IdUser..":SetManager:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Creator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text="رفع منشئ",data=IdUser..":SetConstructor:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Manger:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id},{text="رفع ادمن",data=IdUser..":SetAdmin:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Admin:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="رفع مميز",data=IdUser..":SetMem:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
...
txxt = ' ≭ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'UU_SNAK')..')\n ≭ تم رفعه في قائمة المميزين'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
elseif Redis:sismember(Fast.."Devss:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text="تنزيل مالك",data=IdUser..":RemOwner:"..UserInfo.id},{text="تنزيل مطور",data=IdUser..":RemSudoBot:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Dev:Groups"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text="تنزيل مالك",data=IdUser..":RemOwner:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif StatusMember == "chatMemberStatusCreator" then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
elseif Redis:sismember(Fast.."Ownerss:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text="تنزيل منشئ اساسي",data=IdUser..":RemBasicConstructor:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."SuperCreator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id},{text="تنزيل مدير",data=IdUser..":RemManager:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Creator:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text="تنزيل منشئ",data=IdUser..":RemConstructor:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Manger:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id},{text="تنزيل ادمن",data=IdUser..":RemAdmin:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Admin:Group"..ChatId,IdUser) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text="تنزيل مميز",data=IdUser..":RemMem:"..UserInfo.id}},{{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''}},
}}
return edit(ChatId,Msg_id,Text, 'md', true, false, reply_markup)
elseif Redis:sismember(Fast.."Special:Group"..ChatId,IdUser) then
return bot.editMessageText(ChatId, msg_id, "* ≭ هذا الامر للادمنيه في البوت فما فوق *", 'md', true)
...
local Mostafa = (Redis:get(Fast.."Name:Bot") or "سناك")
local txxt =[[
...
if tonumber(IdUser) == tonumber(UserId) then
local txxt = [[*
 • مرحبا بك في الالعاب الالكترونيه بسورس سناك
...
data = {
{
{text = ' 𝙎𝙉𝘼𝙆 ', url = 'https://t.me/UU_SNAK'}, 
},
}
}
Redis:del(Fast.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
...
-------------------------------------------------
if Text and Text:match('(%d+)/bobo') then
local UserId = Text:match('(%d+)/bobo')
if tonumber(UserId) == tonumber(IdUser) then
local ban = bot.getUser(IdUser)
local Name = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local reply_markup = bot.replyMarkup{
...
data = {
{
{text = '- رموز 1 ', data = IdUser..'/woqoi'},{text = '- رموز 2 ', data = IdUser..'/yqy7'},
},
{
...
local Jabwa = [[*
======  𝙎𝙉𝘼𝙆  ======
ᾋ ᾌ ᾍ ᾎ ᾏ ᾐ ᾑ ᾒ ᾓ ᾔ ᾕ ᾖ ᾗ ᾘ ᾙ ᾚ ᾛ ᾜ ᾝ ᾞ ᾟ ᾠ ᾡ ᾢ ᾣ ᾤ ᾥ ᾦ ᾧ ᾨ ᾩ ᾪ ᾫ ᾬ ᾭ ᾮ ᾯ ᾰ ᾱ ᾲ ᾳ ᾴ ᾶ ᾷ Ᾰ Ᾱ Ὰ Ά ᾼ ᾽ ι ᾿ ῀ ῁ ῂ ῃ ῄ ῆ ῇ Ὲ Έ Ὴ Ή ῌ ῍ ῎ ῏ ῐ ῑ ῒ ΐ ῖ ῗ Ῐ Ῑ Ὶ Ί ῝ ῞ ῟ ῠ ῡ ῢ ΰ ῤ ῥ ῦ ῧ Ῠ Ῡ Ὺ Ύ Ῥ ῭ ΅ ` ῲ ῳ ῴ ῶ ῷ Ὸ Ό Ὼ Ώ ῼ ´ ῾ ῿                         ‌ ‍ ‎ ‏ ‐ ‑ ‒ – — ― ‖ ‗ ‘ ’ ‚ ‛ “ ” „ ‟ † ‡ • ‣ ․ ‥ … ‧       ‰ ‱ ′ ″ ‴ ‵ ‶ ‷ ‸ ‹ › ※ ‼️ ‽ ‾ ‿ ⁀ ⁁ ⁂ ⁃ ⁄ ⁅ ⁆ ⁇ ⁈ ⁉️ ⁊ ⁋ ⁌ ⁍ ⁎ ⁏ ⁐ ⁑ ⁒ ⁓ ⁔ ⁕ ⁖ ⁗ ⁘ ⁙ ⁚ ⁛ ⁜ ⁝ ⁞   ⁠ ⁡ ⁢ ⁣ ⁤ ⁥ ⁦ ⁧ ⁨ ⁩ ⁪ ⁫ ⁬ ⁭ ⁮ ⁯ ⁰ ⁱ ⁴ ⁵ ⁶ ⁷ ⁸ ⁹ ⁿ ₀ ₁ ₂ ₃ ₄ ₅ ₆ ₇ ₈ ₉ ₐ ₑ ₒ ₓ ₕ ₖ ₗ ₘ ₙ ₚ ₛ ₜ ₝ ₞ ₟ ₠ ₡ ₢ ₣ ₤ ₥ ₦ ₧ ₨ ₩ ₪ ₫ € ₭ ₮ ₯ ₰ ₱ ₲ ₳ ₴ ₵ ℀ ℁ ℂ ℃ ℄ ℅ ℆ ℇ ℈ ℉ ℊ ℋ ℌ ℍ ℎ ℏ ℐ ℑ ℒ ℓ ℔ ℕ № ℗ ℘ ℙ ℚ ℛ ℜ ℝ ℞ ℟ ℠ ℡ ™ ℣ ℤ ℥ Ω ℧ ℨ ℩ K Å ℬ ℭ ℮ ℯ ℰ ℱ Ⅎ ℳ ℴ ℵ ℶ ℷ ℸ ℹ️ ℺ ℻ ℼ ℽ ℾ ℿ ⅀ ⅁ ⅂ ⅃ ⅄ ⅅ ⅆ ⅇ ⅈ ⅉ ⅊ ⅋ ⅌ ⅍ ⅎ ⅏ ⅐ ⅑ ⅒ ⅓ ⅔ ⅕ ⅖ ⅗ ⅘ ⅙ ⅚ ⅛ ⅜ ⅝ ⅞ ↀ ↁ ↂ Ↄ ↉ ↊ ↋ ← ↑ → ↓ ↔️ ↕️ ↖️ ↗️ ↘️ ↙️ ↚ ↛ ↜ ↝ ↞ ↟ ↠ ↡ ↢ ↣ ↤ ↥ ↦ ↧ ↨ ↩️ - ↫ ↬ ↭ ↮ ↯ ↰ ↱ ↲ ↳ ↴ ↵ ↶ ↷ ↸ ↹ ↺ ↻ ↼ ↽ ↾ ↿ ⇀ ⇁ ⇂ ⇃ ⇄ ⇅ ⇆ ⇇ ⇈ ⇉ ⇊ ⇋ ⇌ ⇍ ⇎ ⇏ ⇐ ⇑ ⇒ ⇓ ⇔ ⇕ ⇖ ⇗ ⇘ ⇙ ⇚ ⇛ ⇜ ⇝ ⇞ ⇟ ⇠ ⇡ ⇢ ⇣ ⇤ ⇥ ⇦ ⇧ ⇨ ⇩ ⇪ ⇫ ⇬ ⇭ ⇮ ⇯ ⇰ ⇱ ⇲ ⇳ ⇴ ⇵ ⇶ ⇷ ⇸ ⇹ ⇺ ⇻ ⇼ ⇽ ⇾ ⇿ ∀ ∁ ∂ ∃ ∄ ∅ ∆ ∇ ∈ ∉ ∊ ∋ ∌ ∍ ∎ ∏ ∐ ∑ − ∓ ∔ ∕ ∖ ∗ ∘ ∙ √ ∛ ∜ ∝ ∞ ∟ ∠ ∡ ∢ ∣ ∤ ∥ ∦ ∧ ∨ ∩ ∪ ∫ ∬ ∭ ∮ ∯ ∰ ∱ ∲ ∳ ∴ ∵ ∶ ∷ ∸ ∹ ∺ ∻ ∼ ∽ ∾ ∿ ≀ ≁ ≂ ≃ ≄ ≅ ≆ ≇ ≈ ≉ ≊ ≋ ≌ ≍ ≎ ≏ ≐ ≑ ≒ ≓ ≔ ≕ ≖ ≗ ≘ ≙ ≚ ≛ ≜ ≝ ≞ ≟ ≠ ≡ ≢ ≣ ≤ ≥ ≦ ≧ ≨ ≩ ≪ ≫ ≬ ≭ ≮ ≯ ≰ ≱ ≲ ≳ ≴ ≵ ≶ ≷ ≸ ≹ ≺ ≻ ≼ ≽ ≾ ≿ ⊀ ⊁ ⊂ ⊃ ⊄ ⊅ ⊆ ⊇ ⊈ ⊉ ⊊ ⊋ ⊌ ⊍ ⊎ ⊏ ⊐ ⊑ ⊒ ⊓ ⊔ ⊕ ⊖ ⊗ ⊘ ⊙ ⊚ ⊛ ⊜ ⊝ ⊞ ⊟ ⊠ ⊡ ⊢ ⊣ ⊤ ⊥ ⊦ ⊧ ⊨ ⊩ ⊪ ⊫ ⊬ ⊭ ⊮ ⊯ ⊰ ⊱ ⊲ ⊳ ⊴ ⊵ ⊶ ⊷ ⊸ ⊹ ⊺ ⊻ ⊼ ⊽ ⊾ ⊿ ⋀ ⋁ ⋂ ⋃ ⋄ ⋅ ⋆ ⋇ ⋈ ⋉ ⋊ ⋋ ⋌ ⋍ ⋎ ⋏ ⋐ ⋑ ⋒ ⋓ ⋔ ⋕ ⋖ ⋗ ⋘ ⋙ ⋚ ⋛ ⋜ ⋝ ⋞ ⋟ ⋠ ⋡ ⋢ ⋣ ⋤ ⋥ ⋦ ⋧ ⋨ ⋩ ⋪ ⋫ ⋬ ⋭ ⋮ ⋯ ⋰ ⋱ ⋲ ⋳ ⋴ ⋵ ⋶ ⋷ ⋸ ⋹ ⋺ ⋻ ⋼ ⋽ ⋾ ⋿ ⌀ ⌁ ⌂ ⌃ ⌄ ⌅ ⌆ ⌇ ⌈ ⌉ ⌊ ⌋ ⌌ ⌍ ⌎ ⌏ ⌐ ⌑ ⌒ ⌓ ⌔ ⌕ ⌖ ⌗ ⌘ ⌙ ⌚️ ⌛️ ⌜ ⌝ ⌞ ⌟ ⌠ ⌡ ⌢ ⌣ ⌤ ⌥ ⌦ ⌧ ⌨️ 〈 〉 ⌫ ⌬ ⌭ ⌮ ⌯ ⌰ ⌱ ⌲ ⌳ ⌴ ⌵ ⌶ ⌷ ⌸ ⌹ ⌺ ⌻ ⌼ ⌽ ⌾ ⌿ ⍀ ⍁ ⍂ ⍃ ⍄ ⍅ ⍆ ⍇ ⍈ ⍉ ⍊ ⍋ ⍌ ⍍ ⍎ ⍏ ⍐ ⍑ ⍒ ⍓ ⍔ ⍕ ⍖ ⍗ ⍘ ⍙ ⍚ ⍛ ⍜ ⍝ ⍞ ⍟ ⍠ ⍡ ⍢ ⍣ ⍤ ⍥ ⍦ ⍧ ⍨ ⍩ ⍪ ⍫ ⍬ ⍭ ⍮ ⍯ ⍰ ⍱ ⍲ ⍳ ⍴ ⍵ ⍶ ⍷ ⍸ ⍹ ⍺ ⍻ ⍼ ⍽ ⍾ ⍿ ⎀ ⎁ ⎂ ⎃ ⎄ ⎅ ⎆ ⎇ ⎈ ⎉ ⎊ ⎋ ⎌ ⎍ ⎎ ⎏ ⎐ ⎑ ⎒ ⎓ ⎔ ⎕ ⎖ ⎗ ⎘ ⎙ ⎚ ⎛ ⎜ ⎝ ⎞ ⎟ ⎠ ⎡ ⎢ ⎣ ⎤ ⎥ ⎦ ⎧ ⎨ ⎩ ⎪ ⎫ ⎬ ⎭ ⎮ ⎯ ⎰ ⎱ ⎲ ⎳ ⎴ ⎵ ⎶ ⎷ ⎸ ⎹ ⎺ ⎻ ⎼ ⎽ ⎾ ⎿ ⏀ ⏁ ⏂ ⏃ ⏄ ⏅ ⏆ ⏇ ⏈ ⏉ ⏋ ⏌ ⏍ ⏎ ⏏️ ⏐ ⏑ ⏒ ⏓ ⏔ ⏕ ⏖ ⏗ ⏘ ⏙ ⏚ ⏛ ⏜ ⏝ ⏞ ⏟ ⏠ ⏡ ⏢ ⏣ ⏤ ⏥ ⏦ ␋ ␢ ␣ ① ② ③ ④ ⑤ ⑥ ⑦ ⑧ ⑨ ⑩ ⑪ ⑫ ⑬ ⑭ ⑮ ⑯ ⑰ ⑱ ⑲ ⑳ ⑴ ⑵ ⑶ ⑷ ⑸ ⑹ ⑺ ⑻ ⑼ ⑽ ⑾ ⑿ ⒀ ⒁ ⒂ ⒃ ⒄ ⒅ ⒆ ⒇ ⒈ ⒉ ⒊ ⒋ ⒌ ⒍ ⒎ ⒏ ⒐ ⒑ ⒒ ⒓ ⒔ ⒕ ⒖ ⒗ ⒘ ⒙ ⒚ ⒛ ⒜ ⒝ ⒞ ⒟ ⒠ ⒡ ⒢ ⒣ ⒤ ⒥ ⒦ ⒧ ⒨ ⒩ ⒪ ⒫ ⒬ ⒭ ⒮ ⒯ ⒰ ⒱ ⒲ ⒳ ⒴ ⒵ Ⓐ Ⓑ Ⓒ Ⓓ Ⓔ Ⓕ Ⓖ Ⓗ Ⓘ Ⓙ Ⓚ Ⓛ Ⓜ️ Ⓝ Ⓞ Ⓟ Ⓠ Ⓡ Ⓢ Ⓣ Ⓤ Ⓥ Ⓦ Ⓧ Ⓨ Ⓩ ⓐ ⓑ ⓒ ⓓ ⓔ ⓕ ⓖ ⓗ ⓘ ⓙ ⓚ ⓛ ⓜ ⓝ ⓞ ⓟ ⓠ ⓡ ⓢ ⓣ ⓤ ⓥ ⓦ ⓧ ⓨ ⓩ ⓪ ⓫ ⓬ ⓭ ⓮ ⓯ ⓰ ⓱ ⓲ ⓳ ⓴ ⓵ ⓶ ⓷ ⓸ ⓹ ⓺ ⓻ ⓼ ⓽ ⓾ ⓿ ─ ━ │ ┃ ┄ ┅ ┆ ┇ ┈ ┉ ┊ ┋ ┌ ┍ ┎ ┏ ┐ ┑ ┒ ┓ └ ┕ ┖ ┗ ┘ ┙ ┚ ┛ ├ ┝ ┞ ┟ ┠ ┡ ┢ ┣ ┤ ┥ ┦ ┧ ┨ ┩ ┪ ┫ ┬ ┭ ┮ ┯ ┰ ┱ ┲ ┳ ┴ ┵ ┶ ┷ ┸ ┹ ┺ ┻ ┼ ┽ ┾ ┿ ╀ ╁ ╂ ╃ ╄ ╅ ╆ ╇ ╈ ╉ ╊ ╋ ╌ ╍ ╎ ╏ ═ ║ ╒ ╓ ╔ ╕ ╖ ╗ ╘ ╙ ╚ ╛ ╜ ╝ ╞ ╟ ╠ ╡ ╢ ╣ ╤ ╥ ╦ ╧ ╨ ╩ ╪ ╫ ╬ ╬﹌ ╭ ╮ ╯ ╰ ╰☆╮ ╱ ╲ ╳ ╴ ╵ ╶ ╷ ╸ ╹ ╺ ╻ ╼ ╽ ╾ ╿ ▀ ▁ ▂ ▃ ▄ ▅ ▆ ▇ █ ▉ ▊ ▋ ▌ ▍ ▎ ▏ ▐ ░ ▒ ▓ ▔ ▕ ▖ ▗ ▘ ▙ ▚ ▛ ▜ ▝ ▞ ▟ ■ □ ▢ ▣ ▤ ▥ ▦ ▧ ▨ ▩ ▪️ ▫️ ▬ ▭ ▮ ▯ ▰ ▱ ▲ △ ▴ ▵ ▷ ▸ ▹ ► ▻ ▼ ▽ ▾ ▿  ◁ ◂ ◃ ◄ ◅ ◆ ◇ ◈ ◉ ◊ ○ ◌ ≭ ◎ ● ◐ ◑ ◒ ◓ ◔ ◔ʊ ◕ ◖ ◗ ◘ ◙ ◚ ◛ ◜ ◝ ◞ ◟ ◠ ◡ ◢ ◣ ◤ ◥ ◦ ◧ ◨ ◩ ◪ ◫ ◬ ◭ ◮ ◯ ◰ ◱ ◲ ◳ ◴ ◵ ◶ ◷ ◸ ◹ ◺  ☓- ☡☰ ☱ ☲ ☳ ☴ ☵ ☶ ☷ ♔ ♕ ♖ ♗ ♘ ♙ ♚ ♛ ♜ ♝ ♞ ♟ ♠️ ♡ ♢  ♩ ♪ ♫ ♬ ♭ ♮ ♯ ♰ ♱ ♻️ ♼ ♽ ⚆ ⚇ ⚈ ⚉ ⚊ ⚋ ⚌ ⚍ ⚎ ⚏ ⚐ ⚑ ✐ ✑ ✒️ ✓ ✔️ ✕ ✖️ ✗ ✘ ✙ ✚ ✛ ✜  ✞ ✟ ✠ ✢ ✣ ✤ ✥ ✦ ≭ ≭♱ ✩ ✪ ✫ ✬ ✭ ✮ ✯ ✰ ✱ ✲  ✵ ✶ ✷ ✸ ✹ ✺ ✻ ✼ ✽ ✾ ✿ ❀ ❁ ❂ ❃ ❄️ ❅ ❆ ❈ ❉ ❊ ❋ ❍ ❏ ❐ ❑ ❒ ❖ ❗️ ❘ ❙ ❚ ❛ ❜ ❝ ❞ ❡ ❢ ❣️ ❤️ ❥ ❦ ❧ ❨ ❩ ❪ ❫ ❬ ❭ ❮ ❯ ❰ ❱ ❲ ❳ ❴ ❵ ❶ ❷ ❸ ❹ ❺ ❻ ❼ ❽ ❾ ❿ ➀ ➁ ➂ ➃ ➄ ➅ ➆ ➇ ➈ ➉ ➊ ➋ ➌ ➍ ➎ ➏ ➐➑ ➒ ➓ ➔ ➘ ➙ ➚ ➛ ➜ ➝ ➞ ➟ ➠  ➢ ➣ ➤ ➥ ➦ ➧ ➨ ➩ ➪ ➫ ➬ ➭ ➮ ➯ ➱ ➲ ➳ ➴ ➵ ➶ ➷ ➸ ➹ ➺ ➻ ➼ ➽ ➾ ⟀ ⟁ ⟂ ⟃ ⟄ ⟇ ⟈ ⟉ ⟊ ⟐ ⟑ ⟒ ⟓ ⟔ ⟕ ⟖ ⟗ ⟘ ⟙ ⟚ ⟛ ⟜ ⟝ ⟞ ⟟ ⟠ ⟡ ⟢ ⟣ ⟤ ⟥ ⟦ ⟧ ⟨ ⟩ ⟪ ⟫ ⟰ ⟱ ⟲ ⟳ ⟴ ⟵ ⟶ ⟷ ⟸ ⟹ ⟺ ⟻ ⟼ ⟽ ⟾ ⟿ ⤀ ⤁ ⤂ ⤃ ⤄ ⤅ ⤆ ⤇ ⤈ ⤉ ⤊ ⤋ ⤌ ⤍ ⤎ ⤏ ⤐ ⤑ ⤒ ⤓ ⤔ ⤕ ⤖ ⤗ ⤘ ⤙ ⤚ ⤛ ⤜ ⤝ ⤞ ⤟ ⤠ ⤡ ⤢ ⤣ ⤤ ⤥ ⤦ ⤧ ⤨ ⤩ ⤪ ⤫ ⤬ ⤭ ⤮ ⤯ ⤰ ⤱ ⤲ ⤳ ⤶ ⤷ ⤸ ⤹ ⤺ ⤻ ⤼ ⤽ ⤾ ⤿ ⥀ ⥁ ⥂ ⥃ ⥄ ⥅ ⥆ ⥇ ⥈ ⥉ ⥊ ⥋ ⥌ ⥍ ⥎ ⥏ ⥐ ⥑ ⥒ ⥓ ⥔ ⥕ ⥖ ⥗ ⥘ ⥙ ⥚ ⥛ ⥜ ⥝ ⥞ ⥟ ⥠ ⥡ ⥢ ⥣ ⥤ ⥥ ⥦ ⥧ ⥨ ⥩ ⥪ ⥫ ⥬ ⥭ ⥮ ⥯ ⥰ ⥱ ⥲ ⥳ ⥴ ⥵ ⥶ ⥷ ⥸ ⥹ ⥺ ⥻ ⥼ ⥽ ⥾ ⥿ ⦀ ⦁ ⦂ ⦃ ⦄ ⦅ ⦆ ⦇ ⦈ ⦉ ⦊ ⦋ ⦌ ⦍ ⦎ ⦏ ⦐ ⦑ ⦒ ⦓ ⦔ ⦕ ⦖ ⦗ ⦘ ⦙ ⦚ ⦛ ⦜ ⦝ ⦞ ⦟ ⦠ ⦡ ⦢ ⦣ ⦤ ⦥ ⦦ ⦧ ⦨ ⦩ ⦪ ⦫ ⦬ ⦭ ⦮ ⦯ ⦰ ⦱ ⦲ ⦳ ⦴ ⦵ ⦶ ⦷ ⦸ ⦹ ⦺ ⦻ ⦼ ⦽ ⦾ ⦿ ⧀ ⧁ ⧂ ⧃ ⧄ ⧅ ⧆ ⧇ ⧈ ⧉ ⧊ ⧋ ⧌ ⧍ ⧎ ⧏ ⧐ ⧑ ⧒ ⧓ ⧔ ⧕ ⧖ ⧗ ⧘ ⧙ ⧚ ⧛ ⧜ ⧝ ⧞ ⧟ ⧡ ⧢ ⧣ ⧤ ⧥ ⧦ ⧧ ⧨ ⧩ ⧪ ⧫ ⧬ ⧭ ⧮ ⧯ ⧰ ⧱ ⧲ ⧳ ⧴ ⧵ ⧶ ⧷ ⧸ ⧹ ⧺ɷ
======  𝙎𝙉𝘼𝙆  ======
*]]
local reply_markup = bot.replyMarkup{
type = 'inline',
...
ELBOB = Mostafa[math.random(#Mostafa)]
au ={type = "photo",media = "https://t.me/DEV_ELBOB/227",caption = '*'..ELBOB..'*\n'..Name..'',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' 𝙎𝙉𝘼𝙆 ', url = 't.me/UU_SNAK'}, 
...
local Text = "* ≭ حسنا ارسل لي سنك الان -*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:del(Fast..'Setfilejabwa'..IdUser)
Redis:set(Fast..'ELBOB:file'..IdUser,text)
...
Redis:del(Fast..'ELBOB:file'..IdUser)
...
local ELBOB = {Text:match('(.*)/yes_zw/(.*)')}
local zwga_id = ELBOB[1]
local zwg_id = ELBOB[2]
...
local ELBOB = {Text:match('(.*)/wife_last/(.*)')}
local chat_Members = ELBOB[1]
local rand_members = ELBOB[2]
...
data = {
{
{text = 'اوامر القفل للادمن -', data = IdUser..'/appon'},
},
{
...
data = {
{
{text = '- الادمنيه .', data = IdUser..'/help1'}, {text = '- المطورين .', data = IdUser..'/help2'}, 
},
{
{text = '- المطور الاساسي .', data = IdUser..'/Basic'},
},
{
{text = '- الثانوين .', data = IdUser..'/help3'}, {text = '- مالك الجروب .', data = IdUser..'/helpp6'}, 
},
{
{text = '- التسليه .', data = IdUser..'/comfort'},{text = '- الاضافه والمسح .', data = IdUser..'/swipe'}, 
},
{
{text = '- القفل والفتح .', data = IdUser..'/NoNextSeting'}, {text = '- التعطيل والتفعيل .', data = IdUser..'/listallAddorrem'}, 
},
{
{text = ' 𝙎𝙉𝘼𝙆 ', url = 't.me/UU_SNAK '}, 
},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/124",caption = '*• اختار رقم لتعبير عن الشكل •*\n',parse_mode = "Markdown"}     
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/1018",caption = '*الاجابه صحيحه استمر باللعب ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/125",caption = '*• ماهو الشكل المناسب للصوره •*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/126",caption = '*• ماهو الشكل المناسب الذي يكمل المجموعة •*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/126",caption = '*1 إذا علمت أن جد ميدو توفي سنة 1872 م\n2 : وأن ميدو توفي بعد ميلاد جده بمقدار 131 سنة\n3 وإن مجموع عمري ميدو وجده 105 سنوات\nففي أي سنة ولد ميدو؟*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/127",caption = '*• ما هو الشكل الذي يناسب مكان اشارة الاستفهام ليناسب المجموعة •*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/127",caption = '*لك الثلثان من قلبي وثلثا ثلثه الباقي وثلثا ثلث ما يبقى وثلث الثلث للساقي وتبقى أسهم سته تقسم بين عشاقي\nفكم قسم قسّم هذا الشاعر قلبه ؟؟*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/127",caption = '*زوج من الأرانب ، يستطيع أن ينجب بعد شهر كامل زوجاً آخراً ، فإذا كان الزوج الجديد له القدرة نفسها على إنجاب زوجا من الأرانب ، مع استمرار الزوج الأول في الإنجاب كل شهر ، كم\nيكون عدد الازواج بعد سنة ؟ *\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_ELBOB/127",caption = '*شخص يسكن في مبنى مكون من عدة أدوار ، إذا نزل 3 أدوار أصبح مافوقه من أدوار ضعف ماتحته ، وإذا صعد دورين أصبح ماتحته ضعف مافوقه من أدوار ،\nيفكم دورا بالمبنى؟*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/1018",caption = '*مبروك عاش عليك تم إنهاء العبه بنجاح ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
local UserInfo = bot.getUser(IdUser)
local txxt = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..') \n*≭ للاسف اجابتك خاطئه !!*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'البدا مره آخري -', callback_data=IdUser.."/Start"},
},
{
{text=' 𝙎𝙉𝘼𝙆 ',url='t.me/'..chsource..''},
},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• يلا بنا نبحث عن المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• في صوت هل صدر من الامام ام الخلف •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• هيا بنا نذهب الي الامام لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• هيا بنا نذهب الي الخلف لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• هيا •𓄹', callback_data=IdUser.."/have"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• لقد وصلنا الى المنزل شكراَ جزيلَ انتطرني ثواني وسوف اعود •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• لقد عودت إليك ظهر شيئ •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• هيا نذهب داخل المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*•  نحنو نتوه في هذه المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• لا يوجد ضواء في هذا المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• تعالى نذهب الي الباب الرئيسي •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• انها النهاية هتكمل ولا لا •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• سارسل اليك  سوال مع اختيارت لو حليت صح ستنجو من العقاب لو خطأ سيقوم عليك العقاب •\nالسوال هوا - شيء لا يتأثر بالماء حتى عندما يمر من خلالها فمن يكون؟*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• مبروك لقد فوزت ونجيت من العقاب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• غلط القاب هوا خلاص سامحتك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• غلط القاب هوا سكر خشمك و قول كلمة من اختيار  الاعبين الي معك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• غلط القاب هوا اذهب الى واحد ماتعرفه وقل له انا كيوت وابي بوسه •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• غلط القاب هوا روح المطبخ و اكسر صحن او كوب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• غلط القاب هوا تتصل على الوالده و تقول لها تزوجت با سر •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/UU_SNAK/602",caption = '*• انت ستندم سأقتلك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
au ={type = "photo",media = "https://t.me/ELBOBI/"..Rrr.."",caption = '*≭ مرحبا اليك هل تعلم بالصوره*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
au ={type = "photo",media = "https://t.me/ELBOB4/"..Rrr.."",caption = '*≭ تـم اخـتيار هـذه الـصوره لـك 🌼❤️*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
au ={type = "audio",media = "https://t.me/DEVELBOB/"..Rrr.."",caption = '*مرحبا اليك استوري 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
au ={type = "audio",media = "https://t.me/ELBOB8/"..Rrr.."",caption = '*مرحبا اليك استوري حب 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
Rrr = math.random(4,74)
au ={type = "audio",media = "https://t.me/ELBOB7/"..Rrr.."",caption = '*مرحبا اليك استوري قرأن 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
Rrr = math.random(4,74)
au ={type = "audio",media = "https://t.me/ELBOB6/"..Rrr.."",caption = '*مرحبا اليك استوري مضحك 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
...
{
{text = ' 𝙎𝙉𝘼𝙆 ', url = "http://t.me/UU_SNAK"}
},
{
