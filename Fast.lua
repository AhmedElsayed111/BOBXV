...
----
if text == 'مطورين السورس ' or text == '‹ المبرمج ›' or text == 'المطورين' then  
local UserId_Info = LuaTele.searchPublicChat("JJXXH")
...
local TestText = "  ❲ Abaza TeAm 𝖲𝗈𝗎𝗋𝖼𝖾 ❳\n— — — — — — — — —\n↯︙*Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n↯︙️*Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '(Source Dev)', url = "https://t.me/JJXXH/699"}
},
}
...
{
{text = '(Source Ch)', url = "https://t.me/JJXXH"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = '(Ch Source )', url = "https://t.me/JJXXH"}
}, 
}
...
keyboard.inline_keyboard = {
{
{text = '( Dev )', url = "https://t.me/JJXXH/699"}
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local T =[[
↯︙Welcome To Source
↯︙[ TeAm. Abaza ](t.me/JJXXH)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '( Source channel )', url = "https://t.me/JJXXH"}
},
{
{text = '(Source Dev)', url = "https://t.me/JJXXH/699"}
},
{
{text = '(Tws Source )', url = "https://t.me/Abazaxbot"}
}, 
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
