...
bot = Fx.Fastbots.set_config{api_id=4911262,api_hash='ca0c325a23f1e45f2862ca6fc6bd6dec',session_name=Fast,token=Token}
chsource = Redis:get(Fast..'chsource') or "SORALPHA"
devsource = Redis:get(Fast..'devsource') or "XB0BB"
devsource2 = Redis:get(Fast..'devsource') or "MC_X1"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5595392404,5595174869}
...
if UserId == 5595392404 then
Status = true
elseif UserId == 5595174869 then
Status = true 
...
xname =  (Redis:get(Fast.."Name:Bot") or "الـڤـا") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5595392404) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5595392404) then
...
if tonumber(senderr) == 5595392404 then
msg.Name_Controller = 'مطـور السـورس '
msg.The_Controller = 1
elseif tonumber(senderr) == 5595174869 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "الـڤـا")
...
elseif tonumber(msg.sender_id.user_id) == tonumber(5595392404)  then 
Redis:set(Fast.."AddSudosNew"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"⌯ ارسل معرف المطور الاساسي مع @........","md",true)
else
...
download('https://raw.githubusercontent.com/millaann/AAA/main/Fast.lua','Fast.lua')
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5595392404) then
...
if text == 'معتز' or text == 'زوز' or text == 'وزه'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '- ᴅᴇᴠ ᴍᴏᴀᴛᴀᴀᴢ .', url = 't.me/XB0BB'}, 
},
}
}
return send(msg_chat_id,msg_id,"[- ᴍᴏᴀᴛᴀᴀᴢ .](tg://user?id=5595392404)","md",true, false, false, true, reply_markup)
end

if text == 'مروان' or text == 'مارو'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '- ᴅᴇᴠ ᴍᴀʀᴡᴀɴ .', url = 't.me/MC_X1'}, 
},
}
}
return send(msg_chat_id,msg_id,"[- ᴍᴀʀᴡᴀɴ .](tg://user?id=5595174869)","md",true, false, false, true, reply_markup)
end
...
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = '- ᴀʟᴘʜᴀ ғᴀᴄᴛᴏʀʏ .', url = 'https://t.me/SOR_44Bot'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[- ᴀʟᴘʜᴀ ғᴀᴄᴛᴏʀʏ .](https://t.me/SOR_44Bot)","md",true, false, false, true, reply_markup)
  end
...
{
{text = 'تعطيل الابراح', data = senderr..'/'.. 'unmute_abrag'},{text = 'تفعيل الابراج', data = senderr..'/'.. 'mute_abrag'},
},
{
...
local msg_text = "NAME : ["..FlterBio(UserInfo.first_name).."](tg://user?id="..Sudo_Id..")\nBIO : "..Bio
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس الـڤـا\nاكتب اسمك الان :',"md",true)  
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5595392404) then
local txx = "\n"
...
UrlMean = io.popen('curl -s "https://anubis.fun/api/name_mean.php?name='..URL.escape(TextMean)..'"'):read('*a')
Mean = JSON.decode(UrlMean) 
send(msg_chat_id,msg_id, Mean.abs)
end
end
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@SORALPHA")
sleep(1)
...
{
{text = 'ѕᴏᴜʀᴄᴇ - ᴍᴏᴀᴛᴀᴀᴢ .', url = 'http://t.me/'..chsource..''}, 
},
{
{text = '𝙰𝙱𝙰𝚉𝙰 𝙼𝚄𝚂𝙸𝙲 🎧.',url='https://t.me/xmusicbbot'},
},
{
{text = '- لـصـنـع بـوت مـجـانـي 🤖.',url='https://t.me/SOR_44Bot'},
},
{
...
[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏᴜʀᴄᴇ - ᴍᴏᴀᴛᴀᴀᴢ .](t.me/SORALPHA) 
...
if text == (Redis:get(Fast.."Name:Bot") or "الـڤـا") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "الـڤـا")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني 🥺🌚💋",
...
if text and text:match("^مسح كل (.*)$") then
  ...
  if #sdev_list == 0 then 
    ...
    return send(msg_chat_id,msg_id,"⌯ مسح كل "..rtba.." بنجاح","md",true)  
  end
  end
...
return send(msg_chat_id,msg_id,"⌯ مسح الرتبه من الرتب المضافه ","md")
end  
...
if Redis:sismember(Fast.."rtba:"..rtba..":", Message_Reply.sender_id.user_id) then 
  return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"⌯ ترقيته "..rtba.." مسبقا").Reply,"md",true) 
else
  ...
  return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"⌯ ترقيته "..rtba.." بنجاح").Reply,"md",true)  
end
end
...
if Redis:sismember(Fast.."rtba:"..rtba..":", Message_Reply.sender_id.user_id) then 
  ...
  return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"⌯ تنزيله "..rtba.." بنجاح").Reply,"md",true) 
else
...
local CmdStart = '*\n⌯ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "الـڤـا")..
