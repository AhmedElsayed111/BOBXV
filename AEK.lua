...
Redis:del(AEK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(AEK.."ChekBotAdd") 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AEK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر•' then   
Redis:del(AEK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
--download('https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/master/AEK.lua','AEK.lua')
